...
TYPE_BOOLEAN = ...  # FIXME: Constant is missing typing annotation
TYPE_BOXED = ...  # FIXME: Constant is missing typing annotation
TYPE_CHAR = ...  # FIXME: Constant is missing typing annotation
TYPE_DOUBLE = ...  # FIXME: Constant is missing typing annotation
TYPE_ENUM = ...  # FIXME: Constant is missing typing annotation
TYPE_FLAGS = ...  # FIXME: Constant is missing typing annotation
TYPE_FLAG_RESERVED_ID_BIT: int = 1
TYPE_FLOAT = ...  # FIXME: Constant is missing typing annotation
TYPE_FUNDAMENTAL_MAX: int = 1020
TYPE_FUNDAMENTAL_SHIFT: int = 2
TYPE_GSTRING = ...  # FIXME: Constant is missing typing annotation
TYPE_GTYPE = ...  # FIXME: Constant is missing typing annotation
TYPE_INT = ...  # FIXME: Constant is missing typing annotation
TYPE_INT64 = ...  # FIXME: Constant is missing typing annotation
TYPE_INTERFACE = ...  # FIXME: Constant is missing typing annotation
TYPE_INVALID = ...  # FIXME: Constant is missing typing annotation
TYPE_LONG = ...  # FIXME: Constant is missing typing annotation
TYPE_NONE = ...  # FIXME: Constant is missing typing annotation
TYPE_OBJECT = ...  # FIXME: Constant is missing typing annotation
TYPE_PARAM = ...  # FIXME: Constant is missing typing annotation
TYPE_POINTER = ...  # FIXME: Constant is missing typing annotation
TYPE_PYOBJECT = ...  # FIXME: Constant is missing typing annotation
...
TYPE_STRING = ...  # FIXME: Constant is missing typing annotation
TYPE_STRV = ...  # FIXME: Constant is missing typing annotation
TYPE_UCHAR = ...  # FIXME: Constant is missing typing annotation
TYPE_UINT = ...  # FIXME: Constant is missing typing annotation
TYPE_UINT64 = ...  # FIXME: Constant is missing typing annotation
TYPE_ULONG = ...  # FIXME: Constant is missing typing annotation
TYPE_UNICHAR = ...  # FIXME: Constant is missing typing annotation
TYPE_VALUE = ...  # FIXME: Constant is missing typing annotation
TYPE_VARIANT = ...  # FIXME: Constant is missing typing annotation
VALUE_COLLECT_FORMAT_MAX_LENGTH: int = 8
VALUE_INTERNED_STRING: int = 268435456
VALUE_NOCOPY_CONTENTS: int = 134217728
features = ...  # FIXME: Constant is missing typing annotation
glib_version = ...  # FIXME: Constant is missing typing annotation
pygobject_version = ...  # FIXME: Constant is missing typing annotation
...
class GInterface(typing.Protocol):
    ...
    def handler_block(self, handler_id: int) -> typing.ContextManager[None]: ...
...
class OptionContext(GPointer):
    ...
    def add_main_entries(
        self,
        entries: typing.Sequence[GLib.OptionEntry],
        translation_domain: typing.Optional[str] = None,
    ) -> None: ...
    def free(self) -> None: ...
    def get_description(self) -> str: ...
    def get_help(
        self, main_help: bool, group: typing.Optional[GLib.OptionGroup] = None
    ) -> str: ...
    ...
    def parse(self) -> typing.Tuple[bool, list[str]]: ...
    def parse_strv(self) -> typing.Tuple[bool, list[str]]: ...
    ...
    def set_translate_func(
        self, func: typing.Optional[typing.Callable[..., str]] = None, *data: typing.Any
    ) -> None: ...
...
class OptionGroup(GBoxed):
    ...
    def add_entries(self, entries: typing.Sequence[GLib.OptionEntry]) -> None: ...
    def free(self) -> None: ...
    @classmethod
    def new(
        cls,
...
class TypeModule(TypePlugin):
    ...
    def register_enum(
        self, name: str, const_static_values: typing.Sequence[EnumValue]
    ) -> typing.Type[typing.Any]: ...
    def register_flags(
        self, name: str, const_static_values: typing.Sequence[FlagsValue]
    ) -> typing.Type[typing.Any]: ...
    def register_type(
        self,
        parent_type: typing.Type[typing.Any],
...
class Value(GBoxed):
    ...
    def init(self, g_type: typing.Type[typing.Any]) -> typing.Any: ...
