...
from gi.repository import _JavaScriptCore6
...
class ColorChooserRequest(GObject.Object):
    ...
    def set_rgba(self, rgba: _Gdk4.RGBA) -> None: ...
...
class CookieManager(GObject.Object):
    ...
    def get_cookies_finish(self, result: Gio.AsyncResult) -> list[_Soup3.Cookie]: ...
    def replace_cookies(
        self,
        cookies: list[_Soup3.Cookie],
        cancellable: Gio.Cancellable | None = None,
        callback: Callable[..., None] | None = None,
        *user_data: Any,
    ) -> None: ...
...
class FaviconDatabase(GObject.Object):
    ...
    def get_favicon_finish(self, result: Gio.AsyncResult) -> _Gdk4.Texture: ...
...
class InputMethodContext(GObject.Object):
    ...
    def filter_key_event(self, key_event: _Gdk4.Event) -> bool: ...
...
class InputMethodUnderline(GObject.GBoxed):
    ...
    def set_color(self, rgba: _Gdk4.RGBA | None = None) -> None: ...
...
class PermissionRequestInterface(GObject.GPointer):
    ...
    @property
    def allow(self) -> Callable[[PermissionRequest], None]: ...
    @property
    def deny(self) -> Callable[[PermissionRequest], None]: ...
...
class PrintOperation(GObject.Object):
    ...
    def run_dialog(
        self, parent: _Gtk4.Window | None = None
    ) -> PrintOperationResponse: ...
    def set_page_setup(self, page_setup: _Gtk4.PageSetup) -> None: ...
    def set_print_settings(self, print_settings: _Gtk4.PrintSettings) -> None: ...
...
class ScriptMessageReply(GObject.GBoxed):
    ...
    def return_value(self, reply_value: _JavaScriptCore6.Value) -> None: ...
    def unref(self) -> None: ...
...
class URISchemeResponse(GObject.Object):
    ...
    def set_http_headers(self, headers: _Soup3.MessageHeaders) -> None: ...
    def set_status(
...
class WebView(WebViewBase, _Gtk4.Accessible, _Gtk4.Buildable, _Gtk4.ConstraintTarget):
    ...
    def do_show_option_menu(
        self, menu: OptionMenu, rectangle: _Gdk4.Rectangle
    ) -> bool: ...
    ...
    def get_background_color(self) -> _Gdk4.RGBA: ...
    ...
    def get_favicon(self) -> _Gdk4.Texture: ...
    ...
    def set_background_color(self, rgba: _Gdk4.RGBA) -> None: ...
