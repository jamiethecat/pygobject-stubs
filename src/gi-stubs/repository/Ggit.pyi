...
class AnnotatedCommit(GObject.GBoxed):
    ...
    """
    def get_id(self) -> typing.Optional[OId]: ...
    @classmethod
    def new_from_ref(cls, repository: Repository, ref: Ref) -> AnnotatedCommit: ...
    def ref(self) -> typing.Optional[AnnotatedCommit]: ...
    def unref(self) -> None: ...
...
class Blame(Native):
    ...
    def from_buffer(self, buffer: typing.Sequence[int]) -> typing.Optional[Blame]: ...
    @staticmethod
...
class BlameHunk(GObject.GBoxed):
    def get_final_commit_id(self) -> typing.Optional[OId]: ...
    def get_final_signature(self) -> typing.Optional[Signature]: ...
    def get_final_start_line_number(self) -> int: ...
    def get_lines_in_hunk(self) -> int: ...
    def get_orig_commit_id(self) -> typing.Optional[OId]: ...
    def get_orig_path(self) -> typing.Optional[str]: ...
    def get_orig_signature(self) -> typing.Optional[Signature]: ...
    def get_orig_start_line_number(self) -> int: ...
    def is_boundary(self) -> bool: ...
    def ref(self) -> typing.Optional[BlameHunk]: ...
    def unref(self) -> None: ...
...
class BlameOptions(GObject.GBoxed):
    ...
    """
    def copy(self) -> typing.Optional[BlameOptions]: ...
    def free(self) -> None: ...
    def get_maximum_line(self) -> int: ...
    def get_minimum_line(self) -> int: ...
    def get_minimum_match_characters(self) -> int: ...
    def get_newest_commit(self) -> typing.Optional[OId]: ...
    def get_oldest_commit(self) -> typing.Optional[OId]: ...
    @classmethod
    ...
    def set_newest_commit(self, oid: typing.Optional[OId] = None) -> None: ...
    def set_oldest_commit(self, oid: typing.Optional[OId] = None) -> None: ...
...
class Blob(Object):
    ...
    props: Props = ...
    def __init__(self, native: None = ...) -> None: ...
    def get_raw_content(self) -> typing.Optional[bytes]: ...
...
class Branch(Ref):
    ...
    def get_upstream(self) -> typing.Optional[Ref]: ...
    def is_head(self) -> bool: ...
    def move(
        self, new_branch_name: str, flags: CreateFlags
    ) -> typing.Optional[Branch]: ...
...
class BranchEnumerator(GObject.GBoxed):
    def get(self) -> typing.Optional[Ref]: ...
    def iterator(self) -> typing.Optional[BranchEnumerator]: ...
    def next(self) -> bool: ...
    def ref(self) -> typing.Optional[BranchEnumerator]: ...
    def unref(self) -> None: ...
...
class CheckoutOptions(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ancestor_label: typing.Optional[str]
        baseline: typing.Optional[Tree]
        dir_mode: int
        disable_filters: bool
        file_mode: int
        file_open_flags: int
        notify_flags: CheckoutNotifyFlags
        our_label: typing.Optional[str]
        strategy: CheckoutStrategy
        target_directory: typing.Optional[str]
        their_label: typing.Optional[str]
    ...
    def get_ancestor_label(self) -> typing.Optional[str]: ...
    def get_baseline(self) -> typing.Optional[Tree]: ...
    ...
    def get_our_label(self) -> typing.Optional[str]: ...
    def get_paths(self) -> typing.Optional[list[str]]: ...
    def get_strategy(self) -> CheckoutStrategy: ...
    def get_target_directory(self) -> typing.Optional[str]: ...
    def get_their_label(self) -> typing.Optional[str]: ...
    @classmethod
    def new(cls) -> typing.Optional[CheckoutOptions]: ...
    def set_ancestor_label(self, label: typing.Optional[str] = None) -> None: ...
    def set_baseline(self, tree: typing.Optional[Tree] = None) -> None: ...
    ...
    def set_our_label(self, label: typing.Optional[str] = None) -> None: ...
    def set_paths(
        self, paths: typing.Optional[typing.Sequence[str]] = None
    ) -> None: ...
    def set_strategy(self, strategy: CheckoutStrategy) -> None: ...
    def set_target_directory(self, directory: typing.Optional[str] = None) -> None: ...
    def set_their_label(self, label: typing.Optional[str] = None) -> None: ...
...
class CheckoutOptionsClass(GObject.GPointer):
    ...
    progress: typing.Callable[[CheckoutOptions, str, int, int], None] = ...
...
class CherryPickOptions(GObject.Object):
    ...
    def __init__(
        self,
        checkout_options: typing.Optional[CheckoutOptions] = ...,
        mainline: int = ...,
        merge_options: typing.Optional[MergeOptions] = ...,
    ) -> None: ...
    ...
    def set_checkout_options(
        self, checkout_options: typing.Optional[CheckoutOptions] = None
    ) -> None: ...
    def set_mainline(self, mainline: int) -> None: ...
    def set_merge_options(
        self, merge_options: typing.Optional[MergeOptions] = None
    ) -> None: ...
...
class CloneOptions(GObject.Object):
    ...
    def set_checkout_branch(
        self, checkout_branch: typing.Optional[str] = None
    ) -> None: ...
    def set_fetch_options(
        self, fetch_options: typing.Optional[FetchOptions] = None
    ) -> None: ...
...
class CloneOptionsClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    create_repository: typing.Callable[
        [CloneOptions, str, bool], typing.Optional[Repository]
    ] = ...
    create_remote: typing.Callable[
        [CloneOptions, Repository, str, str], typing.Optional[Remote]
    ] = ...
...
class Commit(Object):
    ...
    def amend(
        self,
        update_ref: typing.Optional[str],
        author: Signature,
        committer: Signature,
        message_encoding: typing.Optional[str],
        message: str,
        tree: Tree,
    ) -> typing.Optional[OId]: ...
    def get_author(self) -> typing.Optional[Signature]: ...
    def get_committer(self) -> typing.Optional[Signature]: ...
    def get_message(self) -> typing.Optional[str]: ...
    def get_message_encoding(self) -> typing.Optional[str]: ...
    def get_nth_ancestor(self, n: int) -> typing.Optional[Commit]: ...
    def get_parents(self) -> typing.Optional[CommitParents]: ...
    def get_subject(self) -> typing.Optional[str]: ...
    def get_tree(self) -> typing.Optional[Tree]: ...
    def get_tree_id(self) -> typing.Optional[OId]: ...
...
class CommitParents(GObject.Object):
    ...
    def get(self, idx: int) -> typing.Optional[Commit]: ...
    def get_id(self, idx: int) -> typing.Optional[OId]: ...
...
class Config(Native):
    ...
    def foreach(
        self, callback: typing.Callable[..., int], *user_data: typing.Any
    ) -> bool: ...
    def get_bool(self, name: str) -> bool: ...
    def get_entry(self, name: str) -> ConfigEntry: ...
    def get_int32(self, name: str) -> int: ...
    def get_int64(self, name: str) -> int: ...
    def get_string(self, name: str) -> typing.Optional[str]: ...
    def match(
        self, regex: GLib.Regex
    ) -> typing.Tuple[typing.Optional[str], GLib.MatchInfo]: ...
    def match_foreach(
        self,
        regex: GLib.Regex,
...
class ConfigEntry(GObject.GBoxed):
    ...
    def ref(self) -> typing.Optional[ConfigEntry]: ...
    def unref(self) -> None: ...
...
class CredSshInteractive(Cred, Gio.Initable):
    ...
    def do_prompt(self, prompts: typing.Sequence[CredSshInteractivePrompt]) -> None: ...
    def get_username(self) -> str: ...
    @classmethod
...
class CredSshInteractiveClass(GObject.GPointer):
    ...
    prompt: typing.Callable[
        [CredSshInteractive, typing.Sequence[CredSshInteractivePrompt]], None
    ] = ...
...
class CredSshKeyFromAgent(Cred, Gio.Initable):
    ...
    @classmethod
    def new(cls, username: str) -> typing.Optional[CredSshKeyFromAgent]: ...
...
class Diff(Native):
    ...
    @staticmethod
    def blob_to_buffer(
        old_blob: typing.Optional[Blob] = None,
        old_as_path: typing.Optional[str] = None,
        buffer: typing.Optional[typing.Sequence[int]] = None,
        buffer_as_path: typing.Optional[str] = None,
        diff_options: typing.Optional[DiffOptions] = None,
        file_cb: typing.Optional[typing.Callable[..., int]] = None,
        binary_cb: typing.Optional[typing.Callable[..., int]] = None,
        hunk_cb: typing.Optional[typing.Callable[..., int]] = None,
        line_cb: typing.Optional[typing.Callable[..., int]] = None,
        *user_data: typing.Any,
    ) -> None: ...
    @staticmethod
    def blobs(
        old_blob: typing.Optional[Blob] = None,
        old_as_path: typing.Optional[str] = None,
        new_blob: typing.Optional[Blob] = None,
        new_as_path: typing.Optional[str] = None,
        diff_options: typing.Optional[DiffOptions] = None,
        file_cb: typing.Optional[typing.Callable[..., int]] = None,
        binary_cb: typing.Optional[typing.Callable[..., int]] = None,
        hunk_cb: typing.Optional[typing.Callable[..., int]] = None,
    ...
    def find_similar(
        self, options: typing.Optional[DiffFindOptions] = None
    ) -> bool: ...
    def foreach(
        self,
        file_cb: typing.Optional[typing.Callable[..., int]] = None,
    ...
    def format_email(self, options: DiffFormatEmailOptions) -> typing.Optional[str]: ...
    def get_delta(self, index: int) -> typing.Optional[DiffDelta]: ...
    def get_num_deltas(self) -> int: ...
    def merge(self, from_: Diff) -> None: ...
    @classmethod
    def new_buffers(
        cls,
        buffer1: typing.Optional[typing.Sequence[int]] = None,
        buffer1_as_path: typing.Optional[str] = None,
        buffer2: typing.Optional[typing.Sequence[int]] = None,
        buffer2_as_path: typing.Optional[str] = None,
        diff_options: typing.Optional[DiffOptions] = None,
    ...
    def new_tree_to_index(
        cls,
        repository: Repository,
        old_tree: typing.Optional[Tree] = None,
        index: typing.Optional[Index] = None,
        diff_options: typing.Optional[DiffOptions] = None,
    ) -> typing.Optional[Diff]: ...
    @classmethod
    def new_tree_to_tree(
        ...
        repository: Repository,
        old_tree: typing.Optional[Tree] = None,
        new_tree: typing.Optional[Tree] = None,
        diff_options: typing.Optional[DiffOptions] = None,
    ) -> typing.Optional[Diff]: ...
    @classmethod
    ...
    def print_(
        self,
        type: DiffFormatType,
        print_cb: typing.Callable[..., int],
        *user_data: typing.Any,
    ) -> None: ...

class DiffBinary(GObject.GBoxed):
    def get_new_file(self) -> typing.Optional[DiffBinaryFile]: ...
    def get_old_file(self) -> typing.Optional[DiffBinaryFile]: ...
    def ref(self) -> typing.Optional[DiffBinary]: ...
    def unref(self) -> None: ...

class DiffBinaryFile(GObject.GBoxed):
    def get_binary_type(self) -> DiffBinaryType: ...
    def get_data(self, size: typing.Optional[int] = None) -> int: ...
...
class DiffDelta(GObject.GBoxed):
    ...
    def get_new_file(self) -> typing.Optional[DiffFile]: ...
    def get_old_file(self) -> typing.Optional[DiffFile]: ...
    def get_similarity(self) -> int: ...
    def get_status(self) -> DeltaType: ...
    def ref(self) -> typing.Optional[DiffDelta]: ...
    def unref(self) -> None: ...

class DiffFile(GObject.GBoxed):
    def get_flags(self) -> DiffFlag: ...
    def get_mode(self) -> int: ...
    def get_oid(self) -> typing.Optional[OId]: ...
    def get_path(self) -> typing.Optional[str]: ...
    def get_size(self) -> int: ...
    def ref(self) -> typing.Optional[DiffFile]: ...
    def unref(self) -> None: ...
...
class DiffFindOptions(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        copy_threshold: int
        flags: DiffFindFlags
        metric: typing.Optional[DiffSimilarityMetric]
...
class DiffFormatEmailOptions(GObject.Object):
    ...
    """
    class Props(GObject.Object.Props):
        author: typing.Optional[Signature]
        body: typing.Optional[str]
        flags: DiffFormatEmailFlags
        id: typing.Optional[OId]
        patch_number: int
    ...
    @classmethod
    def new(cls) -> typing.Optional[DiffFormatEmailOptions]: ...
    def set_author(self, author: typing.Optional[Signature] = None) -> None: ...
    def set_body(self, body: typing.Optional[str] = None) -> None: ...
    def set_flags(self, flags: DiffFormatEmailFlags) -> None: ...
    def set_id(self, id: typing.Optional[OId] = None) -> None: ...
    def set_patch_number(self, number: int) -> None: ...
    def set_summary(self, summary: typing.Optional[str] = None) -> None: ...
...
class DiffHunk(GObject.GBoxed):
    ...
    def ref(self) -> typing.Optional[DiffHunk]: ...
    def unref(self) -> None: ...
...
class DiffLine(GObject.GBoxed):
    ...
    def ref(self) -> typing.Optional[DiffLine]: ...
    def unref(self) -> None: ...
...
class DiffOptions(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ...
        old_prefix: typing.Optional[str]
        pathspec: typing.Optional[list[str]]
    ...
    def __init__(
        ...
        new_prefix: str = ...,
        old_prefix: str = ...,
        pathspec: typing.Optional[typing.Sequence[str]] = ...,
    ) -> None: ...
    def get_flags(self) -> DiffOption: ...
    def get_n_context_lines(self) -> int: ...
    def get_n_interhunk_lines(self) -> int: ...
    def get_new_prefix(self) -> typing.Optional[str]: ...
    def get_old_prefix(self) -> typing.Optional[str]: ...
    def get_pathspec(self) -> typing.Optional[list[str]]: ...
    @classmethod
    def new(cls) -> typing.Optional[DiffOptions]: ...
    ...
    def set_pathspec(
        self, pathspec: typing.Optional[typing.Sequence[str]] = None
    ) -> None: ...
...
class DiffSimilarityMetric(GObject.GBoxed):
    ...
    """
    def copy(self) -> typing.Optional[DiffSimilarityMetric]: ...
    def free(self) -> None: ...
    @classmethod
    def new(
        cls,
        file_signature: typing.Callable[..., int],
        buffer_signature: typing.Callable[..., int],
        free_signature: typing.Callable[..., None],
        similarity: typing.Callable[..., int],
        *user_data: typing.Any,
...
class Index(Native, Gio.Initable):
    ...
    def get_entries(self) -> typing.Optional[IndexEntries]: ...
    def get_entries_resolve_undo(self) -> typing.Optional[IndexEntriesResolveUndo]: ...
    def get_owner(self) -> typing.Optional[Repository]: ...
    def has_conflicts(self) -> bool: ...
    @staticmethod
    def open(file: Gio.File) -> typing.Optional[Index]: ...
    def read(self, force: bool) -> bool: ...
    def remove(self, file: Gio.File, stage: int) -> bool: ...
    def write(self) -> bool: ...
    def write_tree(self) -> typing.Optional[OId]: ...
    def write_tree_to(self, repository: Repository) -> typing.Optional[OId]: ...
...
class IndexEntries(GObject.GBoxed):
    def get_by_index(self, idx: int) -> typing.Optional[IndexEntry]: ...
    def get_by_path(
        self, file: Gio.File, stage: int
    ) -> typing.Optional[IndexEntry]: ...
    def ref(self) -> typing.Optional[IndexEntries]: ...
    def size(self) -> int: ...
    def unref(self) -> None: ...

class IndexEntriesResolveUndo(GObject.GBoxed):
    def get(self, idx: int) -> typing.Optional[IndexEntryResolveUndo]: ...
    def get_by_file(self, file: Gio.File) -> typing.Optional[IndexEntryResolveUndo]: ...
    def ref(self) -> typing.Optional[IndexEntriesResolveUndo]: ...
    def size(self) -> int: ...
    def unref(self) -> None: ...
...
class IndexEntry(GObject.GBoxed):
    ...
    def ref(self) -> typing.Optional[IndexEntry]: ...
    ...
    def set_path(self, path: typing.Optional[str] = None) -> None: ...
...
class IndexEntryResolveUndo(GObject.GBoxed):
    ...
    def get_id(self, stage: int) -> typing.Optional[OId]: ...
    def get_mode(self, stage: int) -> int: ...
    def ref(self) -> typing.Optional[IndexEntryResolveUndo]: ...
    def unref(self) -> None: ...
...
class Mailmap(Native):
    ...
    def add_entry(
        ...
        real_email: typing.Optional[str],
        replace_name: typing.Optional[str],
        replace_email: str,
    ) -> None: ...
    @classmethod
    def new(cls) -> typing.Optional[Mailmap]: ...
    @classmethod
    def new_from_repository(
        cls, repository: Repository
    ) -> typing.Optional[Mailmap]: ...
    def resolve(
        self, replace_name: str, replace_email: str
    ) -> typing.Tuple[str, str]: ...
    def resolve_signature(self, signature: Signature) -> typing.Optional[Signature]: ...
...
class MergeOptions(GObject.GBoxed):
    ...
    """
    def copy(self) -> typing.Optional[MergeOptions]: ...
    def free(self) -> None: ...
    def get_file_favor(self) -> MergeFileFavor: ...
    def get_file_flags(self) -> MergeFileFlags: ...
    def get_flags(self) -> MergeFlags: ...
    def get_rename_threshold(self) -> int: ...
    def get_similarity_metric(self) -> typing.Optional[DiffSimilarityMetric]: ...
...
class Note(GObject.GBoxed):
    def get_id(self) -> typing.Optional[OId]: ...
    def get_message(self) -> typing.Optional[str]: ...
    def ref(self) -> typing.Optional[Note]: ...
    def unref(self) -> None: ...
...
class OId(GObject.GBoxed):
    ...
    def copy(self) -> typing.Optional[OId]: ...
    ...
    @classmethod
    def new_from_raw(cls, raw: typing.Sequence[int]) -> typing.Optional[OId]: ...
    @classmethod
    def new_from_string(cls, str: str) -> typing.Optional[OId]: ...
...
class ObjectFactory(GObject.Object):
    ...
    def construct(
        self,
        parent_class: GObject.ObjectClass,
        basetype: typing.Type[typing.Any],
        construct_properties: typing.Sequence[GObject.ObjectConstructParam],
    ) -> typing.Optional[GObject.Object]: ...
    @staticmethod
    def get_default() -> ObjectFactory: ...
    def register(
        self, basetype: typing.Type[typing.Any], subtype: typing.Type[typing.Any]
    ) -> None: ...
    def unregister(
        self, basetype: typing.Type[typing.Any], subtype: typing.Type[typing.Any]
    ) -> None: ...
...
class Patch(GObject.GBoxed):
    ...
    """
    def get_delta(self) -> typing.Optional[DiffDelta]: ...
    def get_hunk(self, idx: int) -> typing.Optional[DiffHunk]: ...
    def get_line_stats(self) -> typing.Tuple[bool, int, int, int]: ...
    ...
    def new_from_blobs(
        ...
        new_as_path: typing.Optional[str] = None,
        diff_options: typing.Optional[DiffOptions] = None,
    ) -> typing.Optional[Patch]: ...
    @classmethod
    def new_from_diff(cls, diff: Diff, idx: int) -> typing.Optional[Patch]: ...
    def ref(self) -> typing.Optional[Patch]: ...
...
class ProxyOptions(GObject.Object):
    ...
    parent_instance: GObject.Object = ...
    @classmethod
    def new(cls) -> typing.Optional[ProxyOptions]: ...
...
class PushOptions(GObject.Object):
    ...
    def get_remote_callbacks(self) -> typing.Optional[RemoteCallbacks]: ...
    @classmethod
    def new(cls) -> typing.Optional[PushOptions]: ...
...
class Rebase(Native):
    ...
    def finish(self, signature: typing.Optional[Signature] = None) -> None: ...
    def get_operation_by_index(self, idx: int) -> typing.Optional[RebaseOperation]: ...
    def get_operation_entry_count(self) -> int: ...
    def get_operation_index(self) -> int: ...
    def next(self) -> typing.Optional[RebaseOperation]: ...
...
class RebaseOperation(GObject.GBoxed):
    def get_exec(self) -> typing.Optional[str]: ...
    def get_id(self) -> typing.Optional[OId]: ...
    def get_operation_type(self) -> RebaseOperationType: ...
    def ref(self) -> typing.Optional[RebaseOperation]: ...
    def unref(self) -> None: ...
...
class RebaseOptions(GObject.GBoxed):
    ...
    """
    def copy(self) -> typing.Optional[RebaseOptions]: ...
    def free(self) -> None: ...
    def get_checkout_options(self) -> typing.Optional[CheckoutOptions]: ...
    def get_quiet(self) -> bool: ...
    def get_rewrite_notes_ref(self) -> typing.Optional[str]: ...
    @classmethod
...
class Ref(Native):
    ...
    def get_log(self) -> typing.Optional[Reflog]: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_owner(self) -> typing.Optional[Repository]: ...
    def get_reference_type(self) -> RefType: ...
    def get_shorthand(self) -> typing.Optional[str]: ...
    def get_symbolic_target(self) -> typing.Optional[str]: ...
    def get_target(self) -> typing.Optional[OId]: ...
    ...
    def lookup(self) -> typing.Optional[Object]: ...
    def rename(
        self, new_name: str, force: bool, log_message: str
    ) -> typing.Optional[Ref]: ...
    def resolve(self) -> typing.Optional[Ref]: ...
    def set_symbolic_target(
        self, target: str, log_message: typing.Optional[str] = None
    ) -> typing.Optional[Ref]: ...
    def set_target(
        self, oid: OId, log_message: typing.Optional[str] = None
    ) -> typing.Optional[Ref]: ...
    def to_string(self) -> typing.Optional[str]: ...
...
class RefSpec(GObject.GBoxed):
    ...
    def get_source(self) -> typing.Optional[str]: ...
    def is_forced(self) -> bool: ...
    def ref(self) -> typing.Optional[RefSpec]: ...
    def unref(self) -> None: ...

class Reflog(GObject.GBoxed):
    def append(self, oid: OId, committer: Signature, message: str) -> bool: ...
    def get_entry_count(self) -> int: ...
    def get_entry_from_index(self, idx: int) -> typing.Optional[ReflogEntry]: ...
    def ref(self) -> typing.Optional[Reflog]: ...
...
class ReflogEntry(GObject.GBoxed):
    def get_committer(self) -> typing.Optional[Signature]: ...
    def get_message(self) -> typing.Optional[str]: ...
    def get_new_id(self) -> typing.Optional[OId]: ...
    def get_old_id(self) -> typing.Optional[OId]: ...
    def ref(self) -> typing.Optional[ReflogEntry]: ...
    def unref(self) -> None: ...
...
class Remote(Native):
    ...
    def connect(
        ...
        direction: Direction,
        callbacks: RemoteCallbacks,
        proxy_options: typing.Optional[ProxyOptions] = None,
        custom_headers: typing.Optional[str] = None,
    ) -> None: ...
    def disconnect(self) -> None: ...
    def download(
        self, specs: typing.Optional[typing.Sequence[str]], fetch_options: FetchOptions
    ) -> bool: ...
    def get_connected(self) -> bool: ...
    def get_fetch_specs(self) -> typing.Optional[list[str]]: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_owner(self) -> typing.Optional[Repository]: ...
    def get_push_specs(self) -> typing.Optional[list[str]]: ...
    def get_url(self) -> typing.Optional[str]: ...
    def list(self) -> typing.Optional[list[RemoteHead]]: ...
    @classmethod
    def new(
        cls, repository: Repository, name: str, url: str
    ) -> typing.Optional[Remote]: ...
    @classmethod
    def new_anonymous(
        cls, repository: Repository, url: str
    ) -> typing.Optional[Remote]: ...
    def prune(self, callbacks: RemoteCallbacks) -> None: ...
    def push(
        self, specs: typing.Optional[typing.Sequence[str]], push_options: PushOptions
    ) -> bool: ...
    def update_tips(
        self,
        callbacks: RemoteCallbacks,
...
class RemoteCallbacks(GObject.Object):
    ...
    def do_credentials(
        self, url: str, username_from_url: typing.Optional[str], allowed_types: Credtype
    ) -> typing.Optional[Cred]: ...
...
class RemoteCallbacksClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    progress: typing.Callable[[RemoteCallbacks, str], None] = ...
    transfer_progress: typing.Callable[[RemoteCallbacks, TransferProgress], None] = ...
    update_tips: typing.Callable[[RemoteCallbacks, str, OId, OId], None] = ...
    completion: typing.Callable[[RemoteCallbacks, RemoteCompletionType], None] = ...
    credentials: typing.Callable[
        [RemoteCallbacks, str, typing.Optional[str], Credtype], typing.Optional[Cred]
    ] = ...
...
class RemoteHead(GObject.GBoxed):
    def get_local_oid(self) -> typing.Optional[OId]: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_oid(self) -> typing.Optional[OId]: ...
...
class Repository(Native, Gio.Initable):
    ...
    class Props(Native.Props):
        ...
        head: typing.Optional[Ref]
        init: bool
        is_bare: bool
        location: typing.Optional[Gio.File]
        url: str
        workdir: typing.Optional[Gio.File]
        native: None
    ...
    def blame_file(
        self, file: Gio.File, blame_options: typing.Optional[BlameOptions] = None
    ) -> typing.Optional[Blame]: ...
    def checkout_head(
        self, options: typing.Optional[CheckoutOptions] = None
    ) -> bool: ...
    def checkout_index(
        self,
        index: typing.Optional[Index] = None,
        options: typing.Optional[CheckoutOptions] = None,
    ) -> bool: ...
    def checkout_tree(
        self,
        tree: typing.Optional[Object] = None,
        options: typing.Optional[CheckoutOptions] = None,
    ) -> bool: ...
    ...
    def cherry_pick_commit(
        ...
        our_commit: Commit,
        mainline: int,
        merge_options: typing.Optional[MergeOptions] = None,
    ) -> typing.Optional[Index]: ...
    @staticmethod
    def clone(
        url: str, location: Gio.File, options: typing.Optional[CloneOptions] = None
    ) -> typing.Optional[Repository]: ...
    def create_blob(self) -> typing.Optional[BlobOutputStream]: ...
    def create_blob_from_buffer(
        self, buffer: typing.Sequence[int]
    ) -> typing.Optional[OId]: ...
    def create_blob_from_file(self, file: Gio.File) -> OId: ...
    def create_blob_from_path(self, path: str) -> typing.Optional[OId]: ...
    def create_branch(
    ...
    def create_commit(
        ...
        message: str,
        tree: Tree,
        parents: typing.Sequence[Commit],
    ) -> typing.Optional[OId]: ...
    ...
    def create_commit_from_ids(
        ...
        message: str,
        tree: OId,
        parents: typing.Sequence[OId],
    ) -> typing.Optional[OId]: ...
    def create_commit_with_signature(
        self,
        commit_content: str,
        signature: typing.Optional[str] = None,
        signature_field: typing.Optional[str] = None,
    ) -> typing.Optional[OId]: ...
    def create_index_entry_for_file(
        self, file: typing.Optional[Gio.File] = None, id: typing.Optional[OId] = None
    ) -> typing.Optional[IndexEntry]: ...
    def create_index_entry_for_path(
        self, path: typing.Optional[str] = None, id: typing.Optional[OId] = None
    ) -> typing.Optional[IndexEntry]: ...
    def create_note(
        self,
        notes_ref: typing.Optional[str],
        author: Signature,
        committer: Signature,
        id: OId,
        note: str,
    ...
    def create_remote(self, name: str, url: str) -> typing.Optional[Remote]: ...
    ...
    def create_tag_from_buffer(
        self, tag: str, flags: CreateFlags
    ) -> typing.Optional[OId]: ...
    def create_tag_lightweight(
        self, tag_name: str, target: Object, flags: CreateFlags
    ) -> typing.Optional[OId]: ...
    def create_tree_builder(self) -> typing.Optional[TreeBuilder]: ...
    def create_tree_builder_from_tree(
        self, tree: Tree
    ) -> typing.Optional[TreeBuilder]: ...
    def delete_tag(self, name: str) -> bool: ...
    @staticmethod
    def discover(location: Gio.File) -> typing.Optional[Gio.File]: ...
    @staticmethod
    def discover_full(
        location: Gio.File,
        across_fs: bool,
        ceiling_dirs: typing.Optional[typing.Sequence[str]] = None,
    ) -> typing.Optional[Gio.File]: ...
    def drop_stash(self, index: int) -> None: ...
    def enumerate_branches(
        self, list_type: BranchType
    ) -> typing.Optional[BranchEnumerator]: ...
    def file_status(self, location: Gio.File) -> StatusFlags: ...
    def file_status_foreach(
        self,
        options: typing.Optional[StatusOptions],
        callback: typing.Callable[..., int],
        *user_data: typing.Any,
    ) -> bool: ...
    def get_ahead_behind(self, local: OId, upstream: OId) -> typing.Tuple[int, int]: ...
    def get_attribute(
        self, path: str, name: str, flags: AttributeCheckFlags
    ) -> typing.Optional[str]: ...
    def get_config(self) -> typing.Optional[Config]: ...
    def get_default_notes_ref(self) -> typing.Optional[str]: ...
    def get_descendant_of(self, commit: OId, ancestor: OId) -> bool: ...
    def get_head(self) -> typing.Optional[Ref]: ...
    def get_index(self) -> typing.Optional[Index]: ...
    def get_location(self) -> typing.Optional[Gio.File]: ...
    def get_submodule_status(
        self, name: str, ignore: SubmoduleIgnore
    ) -> SubmoduleStatus: ...
    def get_workdir(self) -> typing.Optional[Gio.File]: ...
    @staticmethod
    def init_repository(
        location: Gio.File, is_bare: bool
    ) -> typing.Optional[Repository]: ...
    def is_bare(self) -> bool: ...
    def is_empty(self) -> bool: ...
    def is_head_detached(self) -> bool: ...
    def is_head_unborn(self) -> bool: ...
    def list_remotes(self) -> typing.Optional[list[str]]: ...
    def list_tags(self) -> typing.Optional[list[str]]: ...
    def list_tags_match(
        self, pattern: typing.Optional[str] = None
    ) -> typing.Optional[list[str]]: ...
    # override
    def lookup(self, oid: OId, gtype: Type[_O]) -> Optional[_O]: ...
    def lookup_blob(self, oid: OId) -> typing.Optional[Blob]: ...
    def lookup_branch(
        self, branch_name: str, branch_type: BranchType
    ) -> typing.Optional[Branch]: ...
    def lookup_commit(self, oid: OId) -> typing.Optional[Commit]: ...
    def lookup_reference(self, name: str) -> typing.Optional[Ref]: ...
    def lookup_reference_dwim(self, short_name: str) -> typing.Optional[Ref]: ...
    def lookup_remote(self, name: str) -> typing.Optional[Remote]: ...
    def lookup_submodule(self, name: str) -> typing.Optional[Submodule]: ...
    def lookup_tag(self, oid: OId) -> typing.Optional[Tag]: ...
    def lookup_tree(self, oid: OId) -> typing.Optional[Tree]: ...
    def merge(
        self,
        their_heads: typing.Sequence[AnnotatedCommit],
        merge_opts: MergeOptions,
        checkout_opts: CheckoutOptions,
    ) -> None: ...
    def merge_base(self, oid_one: OId, oid_two: OId) -> typing.Optional[OId]: ...
    def merge_commits(
    ...
    @staticmethod
    def open(location: Gio.File) -> typing.Optional[Repository]: ...
    def path_is_ignored(self, path: str) -> bool: ...
    def read_note(
        self, notes_ref: typing.Optional[str], id: OId
    ) -> typing.Optional[Note]: ...
    def rebase_init(
        self,
        branch: typing.Optional[AnnotatedCommit],
        upstream: typing.Optional[AnnotatedCommit],
        onto: typing.Optional[AnnotatedCommit],
        options: RebaseOptions,
    ) -> typing.Optional[Rebase]: ...
    def rebase_open(self, options: RebaseOptions) -> typing.Optional[Rebase]: ...
    ...
    def rename_remote(self, name: str, new_name: str) -> typing.Optional[list[str]]: ...
    def reset(
        self, target: Object, reset_type: ResetType, checkout_options: CheckoutOptions
    ) -> None: ...
    def reset_default(
        self, target: typing.Optional[Object], pathspecs: typing.Sequence[str]
    ) -> None: ...
    def revert(self, commit: Commit, options: RevertOptions) -> bool: ...
    def revparse(self, spec: str) -> typing.Optional[Object]: ...
    def save_stash(
...
class RevertOptions(GObject.GBoxed):
    ...
    """
    def copy(self) -> typing.Optional[RevertOptions]: ...
    def free(self) -> None: ...
    @classmethod
    def new(
        cls,
        mainline: int,
        merge_options: typing.Optional[MergeOptions] = None,
        checkout_options: typing.Optional[CheckoutOptions] = None,
    ) -> typing.Optional[RevertOptions]: ...
...
class RevisionWalker(Native, Gio.Initable):
    ...
    """
    class Props(Native.Props):
        repository: typing.Optional[Repository]
        native: None

    props: Props = ...
    parent_instance: Native = ...
    def __init__(self, repository: Repository = ..., native: None = ...) -> None: ...
    def get_repository(self) -> typing.Optional[Repository]: ...
    def hide(self, oid: OId) -> None: ...
    def hide_glob(self, item: str) -> None: ...
    def hide_head(self) -> None: ...
    def hide_ref(self, item: str) -> None: ...
    @classmethod
    def new(cls, repository: Repository) -> typing.Optional[RevisionWalker]: ...
    def next(self) -> typing.Optional[OId]: ...
...
class Signature(Native):
    ...
    def copy(self) -> typing.Optional[Signature]: ...
    def get_email(self) -> typing.Optional[str]: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_time(self) -> typing.Optional[GLib.DateTime]: ...
    def get_time_zone(self) -> typing.Optional[GLib.TimeZone]: ...
    @classmethod
    def new(
        cls, name: str, email: str, signature_time: GLib.DateTime
    ) -> typing.Optional[Signature]: ...
    @classmethod
    def new_now(cls, name: str, email: str) -> typing.Optional[Signature]: ...
...
class StatusOptions(GObject.GBoxed):
    ...
    """
    def copy(self) -> typing.Optional[StatusOptions]: ...
    def free(self) -> None: ...
    @classmethod
    def new(
        cls,
        ...
        show: StatusShow,
        pathspec: typing.Optional[typing.Sequence[str]] = None,
    ) -> StatusOptions: ...
...
class Submodule(GObject.GBoxed):
    ...
    def get_index_id(self) -> typing.Optional[OId]: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_owner(self) -> typing.Optional[Repository]: ...
    def get_path(self) -> typing.Optional[str]: ...
    def get_update(self) -> SubmoduleUpdate: ...
    def get_url(self) -> typing.Optional[str]: ...
    def get_workdir_id(self) -> typing.Optional[OId]: ...
    def init(self, overwrite: bool) -> None: ...
    def open(self) -> typing.Optional[Repository]: ...
    def ref(self) -> typing.Optional[Submodule]: ...
...
class SubmoduleUpdateOptions(GObject.Object):
    ...
    def __init__(
        self,
        checkout_options: typing.Optional[CheckoutOptions] = ...,
        fetch_options: typing.Optional[FetchOptions] = ...,
    ) -> None: ...
    def get_checkout_options(self) -> typing.Optional[CheckoutOptions]: ...
    def get_fetch_options(self) -> FetchOptions: ...
    @classmethod
    def new(cls) -> typing.Optional[SubmoduleUpdateOptions]: ...
    def set_checkout_options(
        self, checkout_options: typing.Optional[CheckoutOptions] = None
    ) -> None: ...
    def set_fetch_options(
...
class Tag(Object):
    ...
    def get_message(self) -> typing.Optional[str]: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_tagger(self) -> typing.Optional[Signature]: ...
    def get_target(self) -> typing.Optional[Object]: ...
    def get_target_id(self) -> typing.Optional[OId]: ...
    def get_target_type(self) -> typing.Type[typing.Any]: ...
    def peel(self) -> typing.Optional[Object]: ...
...
class TransferProgress(GObject.GBoxed):
    def copy(self) -> typing.Optional[TransferProgress]: ...
    def free(self) -> None: ...
...
class Tree(Object):
    ...
    parent_instance: Object = ...
    def __init__(self, native: None = ...) -> None: ...
    def get(self, i: int) -> typing.Optional[TreeEntry]: ...
    def get_by_name(self, name: str) -> typing.Optional[TreeEntry]: ...
    def get_by_path(self, path: str) -> typing.Optional[TreeEntry]: ...
    def get_id(self) -> typing.Optional[OId]: ...
    def size(self) -> int: ...
    def walk(
        self,
...
class TreeBuilder(Native):
    ...
    def __init__(self, native: None = ...) -> None: ...
    def clear(self) -> None: ...
    def get_entry(self, path: str) -> typing.Optional[TreeEntry]: ...
    def insert(
        self, filename: str, oid: OId, file_mode: FileMode
    ) -> typing.Optional[TreeEntry]: ...
    def remove(self, path: str) -> None: ...
    def write(self) -> typing.Optional[OId]: ...
...
class TreeEntry(GObject.GBoxed):
    ...
    def get_id(self) -> typing.Optional[OId]: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_object_type(self) -> typing.Type[typing.Any]: ...
    def ref(self) -> typing.Optional[TreeEntry]: ...
    def unref(self) -> None: ...
