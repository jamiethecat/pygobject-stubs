...
def attr_list_from_string(text: str) -> typing.Optional[AttrList]: ...
...
def attr_shape_new_with_data(
    ...
    data: None,
    copy_func: typing.Optional[typing.Callable[..., None]] = None,
    destroy_func: typing.Optional[typing.Callable[[None], None]] = None,
) -> Attribute: ...
...
def attr_type_get_name(type: AttrType) -> typing.Optional[str]: ...
...
def default_break(
    text: str, length: int, analysis: typing.Optional[Analysis] = None
) -> list[LogAttr]: ...
def extents_to_pixels() -> typing.Tuple[Rectangle, Rectangle]: ...
def find_base_dir(text: str, length: int) -> Direction: ...
def find_paragraph_boundary(text: str, length: int) -> typing.Tuple[int, int]: ...
def font_description_from_string(str: str) -> FontDescription: ...
def get_log_attrs(
    text: str, length: int, level: int, language: Language
) -> list[LogAttr]: ...
def get_mirror_char(ch: str) -> typing.Tuple[bool, str]: ...
def gravity_get_for_matrix(matrix: typing.Optional[Matrix] = None) -> Gravity: ...
...
def itemize(
    ...
    length: int,
    attrs: AttrList,
    cached_iter: typing.Optional[AttrIterator] = None,
) -> list[Item]: ...
...
def language_get_preferred() -> typing.Optional[list[Language]]: ...
def layout_deserialize_error_quark() -> int: ...
def log2vis_get_embedding_levels(
    text: str, length: int
) -> typing.Tuple[bytes, Direction]: ...
def markup_parser_finish(
    context: GLib.MarkupParseContext,
) -> typing.Tuple[bool, AttrList, str, str]: ...
def markup_parser_new(accel_marker: str) -> GLib.MarkupParseContext: ...
def parse_enum(
    type: typing.Type[typing.Any], str: typing.Optional[str], warn: bool
) -> typing.Tuple[bool, int, str]: ...
def parse_markup(
    markup_text: str, length: int, accel_marker: str
) -> typing.Tuple[bool, AttrList, str, str]: ...
def parse_stretch(str: str, warn: bool) -> typing.Tuple[bool, Stretch]: ...
def parse_style(str: str, warn: bool) -> typing.Tuple[bool, Style]: ...
def parse_variant(str: str, warn: bool) -> typing.Tuple[bool, Variant]: ...
def parse_weight(str: str, warn: bool) -> typing.Tuple[bool, Weight]: ...
def quantize_line_geometry() -> typing.Tuple[int, int]: ...
def read_line(stream: None, str: GLib.String) -> int: ...
def reorder_items(items: list[Item]) -> list[Item]: ...
def scan_int() -> typing.Tuple[bool, str, int]: ...
def scan_string(out: GLib.String) -> typing.Tuple[bool, str]: ...
def scan_word(out: GLib.String) -> typing.Tuple[bool, str]: ...
...
def shape_full(
    item_text: str,
    item_length: int,
    paragraph_text: typing.Optional[str],
...
def shape_item(
    ...
    paragraph_text: typing.Optional[str],
    paragraph_length: int,
    log_attrs: typing.Optional[LogAttr],
    flags: ShapeFlags,
) -> GlyphString: ...
...
def skip_space() -> typing.Tuple[bool, str]: ...
def split_file_list(str: str) -> list[str]: ...
def tab_array_from_string(text: str) -> typing.Optional[TabArray]: ...
def tailor_break(
...
class AttrClass(GObject.GPointer):
    ...
    type: AttrType = ...
    copy: typing.Callable[[Attribute], Attribute] = ...
    destroy: typing.Callable[[Attribute], None] = ...
    equal: typing.Callable[[Attribute, Attribute], bool] = ...
...
class AttrIterator(GObject.GBoxed):
    ...
    def get_font(
        self, desc: FontDescription
    ) -> typing.Tuple[Language, list[Attribute]]: ...
    def next(self) -> bool: ...
...
class AttrList(GObject.GBoxed):
    ...
    def filter(
        self, func: typing.Callable[..., bool], *data: typing.Any
    ) -> typing.Optional[AttrList]: ...
    @staticmethod
    def from_string(text: str) -> typing.Optional[AttrList]: ...
...
class AttrShape(GObject.GPointer):
    ...
    logical_rect: Rectangle = ...
    data: None = ...
    copy_func: typing.Callable[..., None] = ...
    destroy_func: typing.Callable[[None], None] = ...
    @staticmethod
...
class Attribute(GObject.GBoxed):
    ...
    start_index: int = ...
    end_index: int = ...
    def as_color(self) -> typing.Optional[AttrColor]: ...
    def as_float(self) -> typing.Optional[AttrFloat]: ...
    def as_font_desc(self) -> typing.Optional[AttrFontDesc]: ...
    def as_font_features(self) -> typing.Optional[AttrFontFeatures]: ...
    def as_int(self) -> typing.Optional[AttrInt]: ...
    def as_language(self) -> typing.Optional[AttrLanguage]: ...
    def as_shape(self) -> typing.Optional[AttrShape]: ...
    def as_size(self) -> typing.Optional[AttrSize]: ...
    def as_string(self) -> typing.Optional[AttrString]: ...
...
class Color(GObject.GBoxed):
    ...
    def parse_with_alpha(self, spec: str) -> typing.Tuple[bool, int]: ...
    def to_string(self) -> str: ...
...
class Context(GObject.Object):
    ...
    def get_metrics(
        self,
        desc: typing.Optional[FontDescription] = None,
...
class Font(GObject.Object):
    ...
    def descriptions_free(
        descs: typing.Optional[typing.Sequence[FontDescription]] = None,
    ) -> None: ...
    @staticmethod
    def deserialize(context: Context, bytes: GLib.Bytes) -> typing.Optional[Font]: ...
    ...
    def do_get_features(self) -> typing.Tuple[list[HarfBuzz.feature_t], int]: ...
    def do_get_font_map(self) -> typing.Optional[FontMap]: ...
    def do_get_glyph_extents(
        self, glyph: int
    ) -> typing.Tuple[Rectangle, Rectangle]: ...
    def do_get_metrics(
        self, language: typing.Optional[Language] = None
    ) -> FontMetrics: ...
    def get_coverage(self, language: Language) -> Coverage: ...
    def get_face(self) -> typing.Optional[FontFace]: ...
    def get_features(self) -> typing.Tuple[list[HarfBuzz.feature_t], int]: ...
    def get_font_map(self) -> typing.Optional[FontMap]: ...
    def get_glyph_extents(self, glyph: int) -> typing.Tuple[Rectangle, Rectangle]: ...
    def get_languages(self) -> typing.Optional[list[Language]]: ...
    def get_metrics(
        self, language: typing.Optional[Language] = None
    ) -> FontMetrics: ...
...
class FontClass(GObject.GPointer):
    ...
    describe: typing.Callable[[Font], FontDescription] = ...
    get_coverage: typing.Callable[[Font, Language], Coverage] = ...
    get_glyph_extents: typing.Callable[
        [typing.Optional[Font], int], typing.Tuple[Rectangle, Rectangle]
    ] = ...
    get_metrics: typing.Callable[
        [typing.Optional[Font], typing.Optional[Language]], FontMetrics
    ] = ...
    get_font_map: typing.Callable[
        [typing.Optional[Font]], typing.Optional[FontMap]
    ] = ...
    describe_absolute: typing.Callable[[Font], FontDescription] = ...
    get_features: typing.Callable[
        [Font], typing.Tuple[list[HarfBuzz.feature_t], int]
    ] = ...
    create_hb_font: typing.Callable[[Font], HarfBuzz.font_t] = ...
...
class FontDescription(GObject.GBoxed):
    ...
    def get_variations(self) -> typing.Optional[str]: ...
    def get_weight(self) -> Weight: ...
    def hash(self) -> int: ...
    def merge(
        self, desc_to_merge: typing.Optional[FontDescription], replace_existing: bool
    ) -> None: ...
    def merge_static(
    ...
    def set_variations(self, variations: typing.Optional[str] = None) -> None: ...
    def set_variations_static(self, variations: str) -> None: ...
    def set_weight(self, weight: Weight) -> None: ...
    def to_filename(self) -> typing.Optional[str]: ...
    def to_string(self) -> str: ...
...
class FontFaceClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    get_face_name: typing.Callable[[FontFace], str] = ...
    describe: typing.Callable[[FontFace], FontDescription] = ...
...
class FontFamilyClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    list_faces: typing.Callable[[FontFamily], list[FontFace]] = ...
    get_name: typing.Callable[[FontFamily], str] = ...
    is_monospace: typing.Callable[[FontFamily], bool] = ...
    is_variable: typing.Callable[[FontFamily], bool] = ...
...
class FontMap(GObject.Object, Gio.ListModel):
    ...
    def reload_font(
        ...
        variations: typing.Optional[str] = None,
    ) -> Font: ...
...
class FontMapClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    load_font: typing.Callable[
        [FontMap, Context, FontDescription], typing.Optional[Font]
    ] = ...
    list_families: typing.Callable[[FontMap], list[FontFamily]] = ...
    load_fontset: typing.Callable[
        [FontMap, Context, FontDescription, Language], typing.Optional[Fontset]
    ] = ...
    shape_engine_type: str = ...
    get_serial: typing.Callable[[FontMap], int] = ...
    changed: typing.Callable[[FontMap], None] = ...
    get_family: typing.Callable[[FontMap, str], FontFamily] = ...
    get_face: None = ...
...
class Fontset(GObject.Object):
    ...
    def foreach(self, func: typing.Callable[..., bool], *data: typing.Any) -> None: ...
...
class FontsetClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    get_font: typing.Callable[[Fontset, int], Font] = ...
...
class GlyphItem(GObject.GBoxed):
    ...
    def letter_space(
        self, text: str, log_attrs: typing.Sequence[LogAttr], letter_spacing: int
    ) -> None: ...
    def split(self, text: str, split_index: int) -> typing.Optional[GlyphItem]: ...
...
class Language(GObject.GBoxed):
    ...
    @staticmethod
    def get_preferred() -> typing.Optional[list[Language]]: ...
    def get_sample_string(self) -> str: ...
    def get_scripts(self) -> typing.Optional[list[Script]]: ...
...
class Layout(GObject.Object):
    ...
    ) -> typing.Optional[Layout]: ...
    def get_alignment(self) -> Alignment: ...
    def get_attributes(self) -> typing.Optional[AttrList]: ...
    def get_auto_dir(self) -> bool: ...
    def get_baseline(self) -> int: ...
    def get_caret_pos(self, index_: int) -> typing.Tuple[Rectangle, Rectangle]: ...
    def get_character_count(self) -> int: ...
    def get_context(self) -> Context: ...
    def get_cursor_pos(self, index_: int) -> typing.Tuple[Rectangle, Rectangle]: ...
    ...
    def get_line(self, line: int) -> typing.Optional[LayoutLine]: ...
    def get_line_count(self) -> int: ...
    def get_line_readonly(self, line: int) -> typing.Optional[LayoutLine]: ...
    ...
    def get_pixel_size(self) -> typing.Tuple[int, int]: ...
    def get_serial(self) -> int: ...
    ...
    def set_attributes(self, attrs: typing.Optional[AttrList] = None) -> None: ...
    ...
    def set_tabs(self, tabs: typing.Optional[TabArray] = None) -> None: ...
    # override
    ...
    def xy_to_index(self, x: int, y: int) -> typing.Tuple[bool, int, int]: ...
...
class LayoutIter(GObject.GBoxed):
    ...
    def get_line(self) -> typing.Optional[LayoutLine]: ...
    def get_line_extents(self) -> typing.Tuple[Rectangle, Rectangle]: ...
    def get_line_readonly(self) -> typing.Optional[LayoutLine]: ...
    def get_line_yrange(self) -> typing.Tuple[int, int]: ...
...
class LayoutLine(GObject.GBoxed):
    ...
    def ref(self) -> typing.Optional[LayoutLine]: ...
    def unref(self) -> None: ...
    def x_to_index(self, x_pos: int) -> typing.Tuple[bool, int, int]: ...
...
class Matrix(GObject.GBoxed):
    ...
    def get_font_scale_factors(self) -> typing.Tuple[float, float]: ...
    def get_slant_ratio(self) -> float: ...
    def rotate(self, degrees: float) -> None: ...
    def scale(self, scale_x: float, scale_y: float) -> None: ...
    def transform_distance(self) -> typing.Tuple[float, float]: ...
    def transform_pixel_rectangle(self) -> Rectangle: ...
    def transform_point(self) -> typing.Tuple[float, float]: ...
...
class Renderer(GObject.Object):
    ...
    def do_draw_glyph_item(
        self, text: typing.Optional[str], glyph_item: GlyphItem, x: int, y: int
    ) -> None: ...
    def do_draw_glyphs(
    ...
    def set_color(
        self, part: RenderPart, color: typing.Optional[Color] = None
    ) -> None: ...
    def set_matrix(self, matrix: typing.Optional[Matrix] = None) -> None: ...
...
class RendererClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    draw_glyphs: typing.Callable[[Renderer, Font, GlyphString, int, int], None] = ...
    draw_rectangle: typing.Callable[
        [Renderer, RenderPart, int, int, int, int], None
    ] = ...
    draw_error_underline: typing.Callable[[Renderer, int, int, int, int], None] = ...
    draw_shape: typing.Callable[[Renderer, AttrShape, int, int], None] = ...
    draw_trapezoid: typing.Callable[
        [Renderer, RenderPart, float, float, float, float, float, float], None
    ] = ...
    draw_glyph: typing.Callable[[Renderer, Font, int, float, float], None] = ...
    part_changed: typing.Callable[[Renderer, RenderPart], None] = ...
    begin: typing.Callable[[Renderer], None] = ...
    end: typing.Callable[[Renderer], None] = ...
    prepare_run: typing.Callable[[Renderer, GlyphItem], None] = ...
...
class TabArray(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    @staticmethod
    def from_string(text: str) -> typing.Optional[TabArray]: ...
    def get_decimal_point(self, tab_index: int) -> str: ...
    def get_positions_in_pixels(self) -> bool: ...
    def get_size(self) -> int: ...
    def get_tab(self, tab_index: int) -> typing.Tuple[TabAlign, int]: ...
    def get_tabs(self) -> typing.Tuple[TabAlign, list[int]]: ...
    @classmethod
...
class AttrType(GObject.GEnum):
    ...
    WORD = 34
    @staticmethod
    def get_name(type: AttrType) -> typing.Optional[str]: ...
    @staticmethod
...
class Gravity(GObject.GEnum):
    ...
    WEST = 3
    @staticmethod
    def get_for_matrix(matrix: typing.Optional[Matrix] = None) -> Gravity: ...
    @staticmethod
    def get_for_script(
        script: Script, base_gravity: Gravity, hint: GravityHint
    ) -> Gravity: ...
