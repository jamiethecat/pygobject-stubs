...
def named_dest_to_bytestring(name: str) -> bytes | None: ...
...
class Attachment(GObject.Object):
    ...
    def ctime(self) -> int: ...
    @property
    def checksum(self) -> GLib.String: ...
    def get_checksum(self) -> GLib.String: ...
    def get_ctime(self) -> GLib.DateTime | None: ...
    def get_description(self) -> str: ...
    def get_mtime(self) -> GLib.DateTime | None: ...
    def get_name(self) -> str: ...
...
class Document(GObject.Object):
    ...
    def get_pdf_subtype_string(self) -> str | None: ...
    ...
    @classmethod
    def new_from_bytes(
        cls, bytes: GLib.Bytes, password: str | None = None
    ) -> Document: ...
    @classmethod
    def new_from_data(
    ...
    @classmethod
    def new_from_fd(cls, fd: int, password: str | None = None) -> Document: ...
    @classmethod
    def new_from_file(cls, uri: str, password: str | None = None) -> Document: ...
    @classmethod
    def new_from_gfile(
        cls,
        file: Gio.File,
    ...
    def reset_form(self, fields: list[str] | None, exclude_fields: bool) -> None: ...
    ...
    def set_creation_date_time(
        self, creation_datetime: GLib.DateTime | None = None
    ) -> None: ...
    ...
    def set_modification_date_time(
        self, modification_datetime: GLib.DateTime | None = None
    ) -> None: ...
