...
def attr_shape_new_with_data(
    ...
    data: None,
    copy_func: Callable[..., None] | None = None,
...
class AttrList(GObject.GBoxed):
    ...
    def filter(self, func: Callable[..., bool], *data: Any) -> AttrList | None: ...
    @staticmethod
...
class Font(GObject.Object):
    ...
    def do_get_metrics(self, language: Language | None = None) -> FontMetrics: ...
...
class FontClass(GObject.GPointer):
    ...
    def get_features(
        self,
    ) -> Callable[[Font], tuple[list[HarfBuzz.feature_t], int]]: ...
    @property
...
class FontFaceClass(GObject.GPointer):
    ...
    @property
    def list_sizes(self) -> Callable[[FontFace], list[int]]: ...
    @property
...
class FontFamily(GObject.Object, Gio.ListModel):
    ...
    @property
    def parent_instance(self) -> GObject.Object: ...
    def do_get_face(self, name: str | None = None) -> FontFace | None: ...
...
class FontFamilyClass(GObject.GPointer):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def list_faces(self) -> Callable[[FontFamily], list[FontFace]]: ...
    @property
...
class FontMapClass(GObject.GPointer):
    ...
    @property
    def list_families(self) -> Callable[[FontMap], list[FontFamily]]: ...
    @property
    def load_fontset(
        self,
...
class FontsetClass(GObject.GPointer):
    ...
    @property
    def foreach(self) -> Callable[..., None]: ...
...
class Language(GObject.GBoxed):
    ...
    @staticmethod
    def get_preferred() -> list[Language] | None: ...
    def get_sample_string(self) -> str: ...
    def get_scripts(self) -> list[Script] | None: ...
...
class RendererClass(GObject.GPointer):
    ...
    def draw_rectangle(
        self,
    ) -> Callable[[Renderer, RenderPart, int, int, int, int], None]: ...
    @property
    ...
    @property
    def part_changed(self) -> Callable[[Renderer, RenderPart], None]: ...
    @property
...
class AttrType(GObject.GEnum):
    ...
    WORD = 34
    @staticmethod
    def get_name(type: AttrType) -> str | None: ...
    @staticmethod
...
class Script(GObject.GEnum):
    ...
    @staticmethod
    def get_sample_language(script: Script) -> Language | None: ...
