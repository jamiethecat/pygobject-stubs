...
class Box(GObject.GBoxed):
    ...
    def init_from_vec3(
        self, min: Vec3 | None = None, max: Vec3 | None = None
    ) -> Box: ...
...
class Euler(GObject.GBoxed):
    ...
    def init_from_quaternion(
        self, q: Quaternion | None, order: EulerOrder
    ) -> Euler: ...
...
class Plane(GObject.GBoxed):
    ...
    def transform(
        self, matrix: Matrix, normal_matrix: Matrix | None = None
    ) -> Plane: ...
...
class Sphere(GObject.GBoxed):
    ...
    def init_from_points(
        self, points: Sequence[Point3D], center: Point3D | None = None
    ) -> Sphere: ...
    def init_from_vectors(
        self, vectors: Sequence[Vec3], center: Point3D | None = None
    ) -> Sphere: ...
...
class Triangle(GObject.GBoxed):
    ...
    def get_uv(
        self, p: Point3D | None, uv_a: Vec2, uv_b: Vec2, uv_c: Vec2
    ) -> tuple[bool, Vec2]: ...
