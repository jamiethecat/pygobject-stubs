...
def content_formats_parse(string: str) -> typing.Optional[ContentFormats]: ...
def content_register_deserializer(
    mime_type: str,
    type: typing.Type[typing.Any],
    deserialize: typing.Callable[..., None],
    *data: typing.Any,
) -> None: ...
...
def events_get_angle(event1: Event, event2: Event) -> typing.Tuple[bool, float]: ...
def events_get_center(
    event1: Event, event2: Event
) -> typing.Tuple[bool, float, float]: ...
def events_get_distance(event1: Event, event2: Event) -> typing.Tuple[bool, float]: ...
def gl_error_quark() -> int: ...
def intern_mime_type(string: str) -> typing.Optional[str]: ...
...
def keyval_name(keyval: int) -> typing.Optional[str]: ...
...
def pixbuf_get_from_texture(texture: Texture) -> typing.Optional[GdkPixbuf.Pixbuf]: ...
...
class CairoContext(DrawContext):
    ...
    def cairo_create(self) -> typing.Optional[cairo.Context]: ...
...
class Clipboard(GObject.Object):
    ...
    props: Props = ...
    def __init__(self, *, display: Display = ...) -> None: ...
    def get_content(self) -> typing.Optional[ContentProvider]: ...
    def get_display(self) -> Display: ...
    ...
    ) -> typing.Tuple[Gio.InputStream, str]: ...
    def read_text_async(
        self,
        cancellable: typing.Optional[Gio.Cancellable] = None,
        callback: typing.Optional[typing.Callable[..., None]] = None,
    ...
    def set_content(
        self, provider: typing.Optional[ContentProvider] = None
    ) -> bool: ...
    def store_async(
        self,
        io_priority: int,
...
class ContentDeserializer(GObject.Object, Gio.AsyncResult):
    ...
    def set_task_data(
        self, data: None, notify: typing.Callable[[None], None]
    ) -> None: ...
...
class ContentFormats(GObject.GBoxed):
    ...
    @staticmethod
    def __new__(
        cls: type[Self], mime_types: typing.Optional[typing.Sequence[str]] = None
    ) -> Self: ...
    # override
    ...
    def match_gtype(self, second: ContentFormats) -> typing.Type[typing.Any]: ...
    def match_mime_type(self, second: ContentFormats) -> typing.Optional[str]: ...
    @classmethod
    def new(
        cls, mime_types: typing.Optional[typing.Sequence[str]] = None
    ) -> ContentFormats: ...
    # override
    @classmethod
    def new_for_gtype(cls, type: typing.Any) -> ContentFormats: ...
    @staticmethod
    def parse(string: str) -> typing.Optional[ContentFormats]: ...
...
class ContentProvider(GObject.Object):
    ...
    def do_get_value(self) -> typing.Tuple[bool, typing.Any]: ...
    ...
    def get_value(self) -> typing.Tuple[bool, typing.Any]: ...
    @classmethod
    def new_for_bytes(cls, mime_type: str, bytes: GLib.Bytes) -> ContentProvider: ...
    @classmethod
    def new_for_value(cls, value: typing.Any) -> ContentProvider: ...
    @classmethod
    def new_union(
        cls, providers: typing.Optional[typing.Sequence[ContentProvider]] = None
    ) -> ContentProvider: ...
...
class ContentProviderClass(GObject.GPointer):
    ...
    content_changed: typing.Callable[[ContentProvider], None] = ...
    attach_clipboard: typing.Callable[[ContentProvider, Clipboard], None] = ...
    detach_clipboard: typing.Callable[[ContentProvider, Clipboard], None] = ...
    ref_formats: typing.Callable[[ContentProvider], ContentFormats] = ...
    ref_storable_formats: typing.Callable[[ContentProvider], ContentFormats] = ...
    write_mime_type_async: typing.Callable[..., None] = ...
    write_mime_type_finish: typing.Callable[
        [ContentProvider, Gio.AsyncResult], bool
    ] = ...
    get_value: typing.Callable[[ContentProvider], typing.Tuple[bool, typing.Any]] = ...
    padding: list[None] = ...
...
class Cursor(GObject.Object):
    ...
    def get_fallback(self) -> typing.Optional[Cursor]: ...
    def get_hotspot_x(self) -> int: ...
    def get_hotspot_y(self) -> int: ...
    def get_name(self) -> typing.Optional[str]: ...
    def get_texture(self) -> typing.Optional[Texture]: ...
    @classmethod
    def new_from_callback(
        cls,
        callback: typing.Callable[
            ..., typing.Tuple[typing.Optional[Texture], int, int, int, int]
        ],
        fallback: typing.Optional[Cursor] = None,
        *data: typing.Any,
    ) -> typing.Optional[Cursor]: ...
    @classmethod
    def new_from_name(
        cls, name: str, fallback: typing.Optional[Cursor] = None
    ) -> typing.Optional[Cursor]: ...
    @classmethod
...
class Device(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ...
        seat: Seat
        source: InputSource
        tool: typing.Optional[DeviceTool]
...
class Display(GObject.Object):
    ...
    def get_default_seat(self) -> typing.Optional[Seat]: ...
    def get_dmabuf_formats(self) -> DmabufFormats: ...
    def get_monitor_at_surface(self, surface: Surface) -> typing.Optional[Monitor]: ...
    def get_monitors(self) -> Gio.ListModel: ...
    def get_name(self) -> str: ...
    def get_primary_clipboard(self) -> Clipboard: ...
    def get_setting(self, name: str, value: typing.Any) -> bool: ...
    ...
    def map_keycode(
        self, keycode: int
    ) -> typing.Tuple[bool, list[KeymapKey], list[int]]: ...
    def map_keyval(self, keyval: int) -> typing.Tuple[bool, list[KeymapKey]]: ...
    def notify_startup_complete(self, startup_id: str) -> None: ...
    @staticmethod
    def open(display_name: typing.Optional[str] = None) -> typing.Optional[Display]: ...
    ...
    ) -> typing.Tuple[bool, int, int, int, ModifierType]: ...
...
class DmabufFormats(GObject.GBoxed):
    ...
    def equal(self, formats2: typing.Optional[DmabufFormats] = None) -> bool: ...
    def get_format(self, idx: int) -> typing.Tuple[int, int]: ...
...
class DmabufTextureBuilder(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ...
        n_planes: int
        premultiplied: bool
        update_region: typing.Optional[cairo.Region]
        update_texture: typing.Optional[Texture]
        width: int
    ...
    def build(
        self, destroy: typing.Optional[typing.Callable[[None], None]], data: None
    ) -> typing.Optional[Texture]: ...
    def get_color_state(self) -> typing.Optional[ColorState]: ...
    def get_display(self) -> Display: ...
    ...
    def set_color_state(
        self, color_state: typing.Optional[ColorState] = None
    ) -> None: ...
    ...
    def set_update_texture(self, texture: typing.Optional[Texture] = None) -> None: ...
...
class DrawContext(GObject.Object):
    ...
    def get_frame_region(self) -> typing.Optional[cairo.Region]: ...
    def get_surface(self) -> typing.Optional[Surface]: ...
...
class Drop(GObject.Object):
    ...
    def get_device(self) -> Device: ...
    def get_display(self) -> Display: ...
    def get_drag(self) -> typing.Optional[Drag]: ...
    def get_formats(self) -> ContentFormats: ...
    def get_surface(self) -> Surface: ...
    def read_async(
        self,
...
class Event:
    ...
    def get_history(self) -> typing.Optional[list[TimeCoord]]: ...
    def get_modifier_state(self) -> ModifierType: ...
    def get_pointer_emulated(self) -> bool: ...
    def get_position(self) -> typing.Tuple[bool, float, float]: ...
    def get_seat(self) -> typing.Optional[Seat]: ...
    def get_surface(self) -> typing.Optional[Surface]: ...
...
class FrameClock(GObject.Object):
    ...
    def get_refresh_info(self, base_time: int) -> typing.Tuple[int, int]: ...
    def get_timings(self, frame_counter: int) -> typing.Optional[FrameTimings]: ...
...
class GLContext(DrawContext):
    ...
    def get_version(self) -> typing.Tuple[int, int]: ...
...
class GLTextureBuilder(GObject.Object):
    ...
    def get_context(self) -> typing.Optional[GLContext]: ...
    ...
    def set_context(self, context: typing.Optional[GLContext] = None) -> None: ...
...
class KeyEvent(Event):
    ...
    def get_match(self) -> typing.Tuple[bool, int, ModifierType]: ...
...
class MemoryTextureBuilder(GObject.Object):
    ...
    def set_bytes(self, bytes: typing.Optional[GLib.Bytes] = None) -> None: ...
    def set_color_state(self, color_state: ColorState) -> None: ...
    def set_format(self, format: MemoryFormat) -> None: ...
    def set_height(self, height: int) -> None: ...
    def set_offset(self, plane: int, offset: int) -> None: ...
...
class PaintableInterface(GObject.GPointer):
    ...
    snapshot: typing.Callable[[Paintable, Snapshot, float, float], None] = ...
    get_current_image: typing.Callable[[Paintable], Paintable] = ...
    get_flags: typing.Callable[[Paintable], PaintableFlags] = ...
    get_intrinsic_width: typing.Callable[[Paintable], int] = ...
    get_intrinsic_height: typing.Callable[[Paintable], int] = ...
    get_intrinsic_aspect_ratio: typing.Callable[[Paintable], float] = ...
...
class PopupLayout(GObject.GBoxed):
    ...
    def get_rect_anchor(self) -> Gravity: ...
    def get_shadow_width(self) -> typing.Tuple[int, int, int, int]: ...
    def get_surface_anchor(self) -> Gravity: ...
    @classmethod
    def new(
...
class Rectangle(GObject.GBoxed):
    ...
    def intersect(self, src2: Rectangle) -> typing.Tuple[bool, Rectangle]: ...
...
class Surface(GObject.Object):
    ...
    def get_device_position(
        self, device: Device
    ) -> typing.Tuple[bool, float, float, ModifierType]: ...
    def get_display(self) -> Display: ...
...
class Texture(GObject.Object, Paintable, Gio.Icon, Gio.LoadableIcon):
    ...
    def download(self, data: typing.Sequence[int], stride: int) -> None: ...
    def get_color_state(self) -> ColorState: ...
    def get_format(self) -> MemoryFormat: ...
    def get_height(self) -> int: ...
    def get_width(self) -> int: ...
...
class ToplevelLayout(GObject.GBoxed):
    ...
    def get_fullscreen_monitor(self) -> typing.Optional[Monitor]: ...
    def get_maximized(self) -> typing.Tuple[bool, bool]: ...
    def get_resizable(self) -> bool: ...
    @classmethod
    def new(cls) -> ToplevelLayout: ...
    def ref(self) -> ToplevelLayout: ...
    def set_fullscreen(
        self, fullscreen: bool, monitor: typing.Optional[Monitor] = None
    ) -> None: ...
...
class ToplevelSize(GObject.GPointer):
    def get_bounds(self) -> typing.Tuple[int, int]: ...
