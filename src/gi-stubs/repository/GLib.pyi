...
def async_queue_new_full(
    item_free_func: typing.Optional[typing.Callable[[None], None]] = None,
) -> AsyncQueue: ...
...
def byte_array_append(
    array: typing.Sequence[int], data: typing.Sequence[int]
) -> bytes: ...
def byte_array_free(
    array: typing.Sequence[int], free_segment: bool
...
def log_set_writer_func(
    func: typing.Callable[..., LogWriterOutput], *user_data: typing.Any
) -> None: ...
...
def strrstr_len(
    haystack: str, haystack_len: int, needle: str
) -> typing.Optional[str]: ...
def strsignal(signum: int) -> str: ...
def strsplit(string: str, delimiter: str, max_tokens: int) -> list[str]: ...
def strsplit_set(
    string: str, delimiters: typing.Sequence[int], max_tokens: int
) -> list[str]: ...
def strstr_len(
    haystack: str, haystack_len: int, needle: str
) -> typing.Optional[str]: ...
...
class MainContext(GObject.GBoxed):
    ...
    # override
    def query(self, max_priority: int) -> typing.Tuple[int, list[PollFD]]: ...
...
class OptionContext(GObject.GPointer):
    ...
    def add_main_entries(
        self,
        entries: typing.Sequence[OptionEntry],
        translation_domain: typing.Optional[str] = None,
    ) -> None: ...
    def free(self) -> None: ...
    def get_description(self) -> str: ...
    def get_help(
        self, main_help: bool, group: typing.Optional[OptionGroup] = None
    ) -> str: ...
