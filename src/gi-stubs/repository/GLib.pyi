...
class Bytes(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], data: _Sequence[int] | None = None) -> Self: ...
...
class Hmac(GObject.GBoxed):
    ...
    @staticmethod
    def __new__(
        cls: type[Self], digest_type: ChecksumType, key: _Sequence[int]
    ) -> Self: ...
    def copy(self) -> Hmac: ...
    def get_digest(self, buffer: _Sequence[int]) -> None: ...
    def get_string(self) -> str: ...
    @classmethod
    def new(cls, digest_type: ChecksumType, key: _Sequence[int]) -> Hmac | None: ...
    def ref(self) -> Hmac: ...
    def unref(self) -> None: ...
    def update(self, data: _Sequence[int]) -> None: ...
...
class TimeZone(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], identifier: str | None = None) -> Self: ...
...
class Variant(GObject.GPointer):
    ...
    @staticmethod
    def __new__(cls: type[Self], format_string: str, value: Any) -> Self:
        """
...
class VariantDict(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], from_asv: Variant | None = None) -> Self: ...
    def clear(self) -> None: ...
