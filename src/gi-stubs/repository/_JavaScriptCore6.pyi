...
def options_foreach(
    function: typing.Callable[..., bool], *user_data: typing.Any
) -> None: ...
def options_get_boolean(option: str) -> typing.Tuple[bool, bool]: ...
def options_get_double(option: str) -> typing.Tuple[bool, float]: ...
def options_get_int(option: str) -> typing.Tuple[bool, int]: ...
def options_get_option_group() -> GLib.OptionGroup: ...
def options_get_range_string(option: str) -> typing.Tuple[bool, str]: ...
def options_get_size(option: str) -> typing.Tuple[bool, int]: ...
def options_get_string(option: str) -> typing.Tuple[bool, str]: ...
def options_get_uint(option: str) -> typing.Tuple[bool, int]: ...
...
class Class(GObject.Object):
    ...
    def add_constructor(
        ...
        parameter_types: typing.Optional[
    ...
    def add_property(
        self,
        name: str,
        property_type: typing.Type[typing.Any],
        getter: typing.Optional[typing.Callable[[], None]] = None,
        setter: typing.Optional[typing.Callable[..., None]] = None,
        *user_data: typing.Any,
    ) -> None: ...
...
class ClassVTable(GObject.GPointer):
    ...
    get_property: typing.Callable[
        [Class, Context, None, str], typing.Optional[Value]
    ] = ...
    set_property: typing.Callable[[Class, Context, None, str, Value], bool] = ...
    has_property: typing.Callable[[Class, Context, None, str], bool] = ...
    delete_property: typing.Callable[[Class, Context, None, str], bool] = ...
    enumerate_properties: typing.Callable[
        [Class, Context, None], typing.Optional[list[str]]
    ] = ...
...
class Context(GObject.Object):
    ...
    ) -> typing.Tuple[CheckSyntaxResult, Exception]: ...
    ...
    def evaluate_in_object(
        ...
        object_class: typing.Optional[Class],
        uri: str,
        line_number: int,
    ) -> typing.Tuple[Value, Value]: ...
    def evaluate_with_source_uri(
        self, code: str, length: int, uri: str, line_number: int
    ) -> Value: ...
    @staticmethod
    def get_current() -> typing.Optional[Context]: ...
    def get_exception(self) -> typing.Optional[Exception]: ...
    ...
    def push_exception_handler(
        self, handler: typing.Callable[..., None], *user_data: typing.Any
    ) -> None: ...
    def register_class(
        self,
        name: str,
        parent_class: typing.Optional[Class] = None,
        vtable: typing.Optional[ClassVTable] = None,
        destroy_notify: typing.Optional[typing.Callable[[None], None]] = None,
    ) -> Class: ...
...
class Exception(GObject.Object):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_backtrace_string(self) -> typing.Optional[str]: ...
    def get_column_number(self) -> int: ...
    def get_line_number(self) -> int: ...
    def get_message(self) -> str: ...
    def get_name(self) -> str: ...
    def get_source_uri(self) -> typing.Optional[str]: ...
    @classmethod
...
class Value(GObject.Object):
    ...
    def constructor_call(
        self, parameters: typing.Optional[typing.Sequence[Value]] = None
    ) -> Value: ...
    def function_call(
        self, parameters: typing.Optional[typing.Sequence[Value]] = None
    ) -> Value: ...
    ...
    def new_array_buffer(
        ...
        data: None,
        size: int,
        destroy_notify: typing.Optional[typing.Callable[..., None]] = None,
        *user_data: typing.Any,
    ) -> typing.Optional[Value]: ...
    @classmethod
    def new_array_from_garray(
        cls, context: Context, array: typing.Optional[typing.Sequence[Value]] = None
    ) -> Value: ...
    @classmethod
    def new_array_from_strv(
        cls, context: Context, strv: typing.Sequence[str]
    ) -> Value: ...
    @classmethod
    ...
    @classmethod
    def new_object(
        cls, context: Context, instance: None, jsc_class: typing.Optional[Class] = None
    ) -> Value: ...
    @classmethod
    def new_promise(
        cls,
        context: Context,
        executor: typing.Callable[..., None],
        *user_data: typing.Any,
    ) -> Value: ...
    @classmethod
    def new_string(
        cls, context: Context, string: typing.Optional[str] = None
    ) -> Value: ...
    @classmethod
    def new_string_from_bytes(
        cls, context: Context, bytes: typing.Optional[GLib.Bytes] = None
    ) -> Value: ...
    @classmethod
    def new_typed_array(
    ...
    def object_define_property_data(
        ...
        property_name: str,
        flags: ValuePropertyFlags,
        property_value: typing.Optional[Value] = None,
    ) -> None: ...
    def object_delete_property(self, name: str) -> bool: ...
    def object_enumerate_properties(self) -> typing.Optional[list[str]]: ...
    ...
    def object_invoke_method(
        self, name: str, parameters: typing.Optional[typing.Sequence[Value]] = None
    ) -> Value: ...
