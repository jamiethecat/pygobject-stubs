...
def content_rating_system_to_string(system: ContentRatingSystem) -> str | None: ...
...
def get_license_name(license: str) -> str | None: ...
def get_license_url(license: str) -> str | None: ...
def gstring_replace(
...
def spdx_license_detokenize(license_tokens: str) -> str | None: ...
def spdx_license_tokenize(license: str) -> list[str] | None: ...
...
def utils_locale_is_compatible(
    locale1: str | None = None, locale2: str | None = None
) -> bool: ...
...
class Agreement(GObject.Object):
    ...
    def get_section_default(self) -> AgreementSection | None: ...
...
class AgreementSection(GObject.Object):
    ...
    def set_description(self, desc: str, locale: str | None = None) -> None: ...
    def set_kind(self, kind: str) -> None: ...
    def set_name(self, name: str, locale: str | None = None) -> None: ...
...
class Artifact(GObject.Object):
    ...
    def get_checksum(self, kind: ChecksumKind) -> Checksum | None: ...
...
class Component(GObject.Object):
    ...
    def add_keyword(self, keyword: str, locale: str | None = None) -> None: ...
    def add_language(self, locale: str | None, percentage: int) -> None: ...
    ...
    def check_relations(
        self, sysinfo: SystemInfo | None, pool: Pool | None, rel_kind: RelationKind
    ) -> list[RelationCheckResult]: ...
    def clear_keywords(self, locale: str | None = None) -> None: ...
    def clear_languages(self) -> None: ...
    def clear_tags(self) -> None: ...
    def get_addons(self) -> list[Component]: ...
    def get_agreement_by_kind(self, kind: AgreementKind) -> Agreement | None: ...
    def get_agreements(self) -> list[Agreement]: ...
    def get_branch(self) -> str: ...
    def get_branding(self) -> Branding | None: ...
    def get_bundle(self, bundle_kind: BundleKind) -> Bundle | None: ...
    def get_bundles(self) -> list[Bundle]: ...
    def get_categories(self) -> list[str]: ...
    def get_compulsory_for_desktops(self) -> list[str]: ...
    def get_content_rating(self, kind: str) -> ContentRating | None: ...
    ...
    def get_extends(self) -> list[str] | None: ...
    def get_icon_by_size(self, width: int, height: int) -> Icon | None: ...
    def get_icon_stock(self) -> Icon | None: ...
    def get_icons(self) -> list[Icon]: ...
    def get_id(self) -> str: ...
    def get_keywords(self) -> list[str]: ...
    def get_keywords_table(self) -> dict[None, None]: ...
    def get_kind(self) -> ComponentKind: ...
    def get_language(self, locale: str | None = None) -> int: ...
    def get_languages(self) -> list[str]: ...
    def get_launchable(self, kind: LaunchableKind) -> Launchable | None: ...
    ...
    def get_provided_for_kind(self, kind: ProvidedKind) -> Provided | None: ...
    ...
    ) -> tuple[int, list[RelationCheckResult]]: ...
    def get_timestamp_eol(self) -> int: ...
    def get_translations(self) -> list[Translation]: ...
    def get_url(self, url_kind: UrlKind) -> str | None: ...
    ...
    def load_releases(self, allow_net: bool) -> ReleaseList | None: ...
    @classmethod
    ...
    def set_description(self, value: str, locale: str | None = None) -> None: ...
    def set_developer(self, developer: Developer) -> None: ...
    def set_id(self, value: str) -> None: ...
    def set_keywords(
        self, new_keywords: Sequence[str], locale: str | None, deep_copy: bool
    ) -> None: ...
    ...
    def set_name(self, value: str, locale: str | None = None) -> None: ...
    def set_name_variant_suffix(
        self, value: str, locale: str | None = None
    ) -> None: ...
    ...
    def set_summary(self, value: str, locale: str | None = None) -> None: ...
    def sort_screenshots(
        self, environment: str | None, style: str | None, prioritize_style: bool
    ) -> None: ...
...
class Context(GObject.Object):
    ...
    def set_locale(self, locale: str | None = None) -> None: ...
...
class Metadata(GObject.Object):
    ...
    def get_release_list(self) -> ReleaseList | None: ...
...
class PoolClass(GObject.GPointer):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def changed(self) -> Callable[[Pool], None]: ...
...
class Relation(GObject.Object):
    ...
    def check_results_get_compatibility_score(
        rc_results: Sequence[RelationCheckResult],
    ) -> int: ...
    ...
    def is_satisfied(
        self, system_info: SystemInfo | None = None, pool: Pool | None = None
    ) -> RelationCheckResult | None: ...
    @classmethod
...
class Release(GObject.Object):
    ...
    def get_date_eol(self) -> str | None: ...
    ...
    def get_url(self, url_kind: ReleaseUrlKind) -> str | None: ...
    ...
    def set_date_eol(self, date: str) -> None: ...
    def set_description(self, description: str, locale: str | None = None) -> None: ...
...
class ReleaseList(GObject.Object):
    ...
    def is_empty(self) -> bool: ...
    def load_from_bytes(self, context: Context | None, bytes: GLib.Bytes) -> bool: ...
    @classmethod
...
class Screenshot(GObject.Object):
    ...
    def get_image(self, width: int, height: int, scale: int) -> Image | None: ...
    ...
    def set_context(self, context: Context) -> None: ...
    def set_environment(self, env_id: str | None = None) -> None: ...
...
class Translation(GObject.Object):
    ...
    def set_source_locale(self, locale: str | None = None) -> None: ...
...
class ContentRatingSystem(GObject.GEnum):
    ...
    USK = 7
    @staticmethod
    def format_age(system: ContentRatingSystem, age: int) -> str | None: ...
    @staticmethod
    ...
    @staticmethod
    def to_string(system: ContentRatingSystem) -> str | None: ...
