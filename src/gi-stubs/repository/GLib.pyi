...
MAJOR_VERSION: int = 2
MAXDOUBLE: float = 1.7976931348623157e+308
...
def ascii_string_to_signed(str: str, base: int, min: int, max: int) -> typing.Tuple[bool, int]: ...
def ascii_string_to_unsigned(str: str, base: int, min: int, max: int) -> typing.Tuple[bool, int]: ...
...
def assertion_message_error(domain: str, file: str, line: int, func: str, expr: str, error: Error, error_domain: int, error_code: int) -> None: ...
def async_queue_new() -> AsyncQueue: ...
def async_queue_new_full(item_free_func: typing.Optional[typing.Callable[[None], None]] = None) -> AsyncQueue: ...
...
def atomic_int_compare_and_exchange_full(atomic: None, oldval: int, newval: int) -> typing.Tuple[bool, int]: ...
...
def atomic_pointer_compare_and_exchange(atomic: None, oldval: None, newval: None) -> bool: ...
def atomic_pointer_compare_and_exchange_full(atomic: None, oldval: None, newval: None) -> typing.Tuple[bool, None]: ...
...
def atomic_rc_box_release_full(mem_block: None, clear_func: typing.Callable[[None], None]) -> None: ...
...
def base64_encode_step(in_: typing.Sequence[int], break_lines: bool) -> typing.Tuple[int, bytes, int, int]: ...
...
def bit_unlock_and_set(address: None, lock_bit: int, new_val: int, preserve_mask: int) -> None: ...
...
def byte_array_append(array: typing.Sequence[int], data: typing.Sequence[int]) -> bytes: ...
def byte_array_free(array: typing.Sequence[int], free_segment: bool) -> typing.Optional[bytes]: ...
...
def byte_array_prepend(array: typing.Sequence[int], data: typing.Sequence[int]) -> bytes: ...
...
def byte_array_remove_range(array: typing.Sequence[int], index_: int, length: int) -> bytes: ...
def byte_array_set_size(array: typing.Sequence[int], length: int) -> bytes: ...
def byte_array_sized_new(reserved_size: int) -> bytes: ...
def byte_array_sort(array: typing.Sequence[int], compare_func: typing.Callable[[None, None], int]) -> None: ...
def byte_array_sort_with_data(array: typing.Sequence[int], compare_func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
def byte_array_steal(array: typing.Sequence[int]) -> bytes: ...
def byte_array_unref(array: typing.Sequence[int]) -> None: ...
def canonicalize_filename(filename: str, relative_to: typing.Optional[str] = None) -> str: ...
def chdir(path: str) -> int: ...
def check_version(required_major: int, required_minor: int, required_micro: int) -> typing.Optional[str]: ...
...
def compute_checksum_for_bytes(checksum_type: ChecksumType, data: Bytes) -> typing.Optional[str]: ...
def compute_checksum_for_data(checksum_type: ChecksumType, data: typing.Sequence[int]) -> typing.Optional[str]: ...
def compute_checksum_for_string(checksum_type: ChecksumType, str: str, length: int) -> typing.Optional[str]: ...
def compute_hmac_for_bytes(digest_type: ChecksumType, key: Bytes, data: Bytes) -> str: ...
def compute_hmac_for_data(digest_type: ChecksumType, key: typing.Sequence[int], data: typing.Sequence[int]) -> str: ...
def compute_hmac_for_string(digest_type: ChecksumType, key: typing.Sequence[int], str: str, length: int) -> str: ...
def convert(str: typing.Sequence[int], to_codeset: str, from_codeset: str) -> typing.Tuple[bytes, int]: ...
def convert_error_quark() -> int: ...
def convert_with_fallback(str: typing.Sequence[int], to_codeset: str, from_codeset: str, fallback: str) -> typing.Tuple[bytes, int]: ...
def creat(filename: str, mode: int) -> int: ...
def datalist_foreach(datalist: Data, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
...
def dataset_foreach(dataset_location: None, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
...
def dngettext(domain: typing.Optional[str], msgid: str, msgid_plural: str, n: int) -> str: ...
def double_equal(v1: None, v2: None) -> bool: ...
def double_hash(v: None) -> int: ...
def dpgettext(domain: typing.Optional[str], msgctxtid: str, msgidoffset: int) -> str: ...
def dpgettext2(domain: typing.Optional[str], context: str, msgid: str) -> str: ...
def environ_getenv(envp: typing.Optional[typing.Sequence[str]], variable: str) -> typing.Optional[str]: ...
def environ_setenv(envp: typing.Optional[typing.Sequence[str]], variable: str, value: str, overwrite: bool) -> list[str]: ...
def environ_unsetenv(envp: typing.Optional[typing.Sequence[str]], variable: str) -> list[str]: ...
def error_domain_register(error_type_name: str, error_type_private_size: int, error_type_init: typing.Callable[[Error], None], error_type_copy: typing.Callable[[Error, Error], None], error_type_clear: typing.Callable[[Error], None]) -> int: ...
def error_domain_register_static(error_type_name: str, error_type_private_size: int, error_type_init: typing.Callable[[Error], None], error_type_copy: typing.Callable[[Error, Error], None], error_type_clear: typing.Callable[[Error], None]) -> int: ...
...
def file_set_contents_full(filename: str, contents: typing.Sequence[int], flags: FileSetContentsFlags, mode: int) -> bool: ...
...
def hash_table_find(hash_table: dict[None, None], predicate: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
def hash_table_foreach(hash_table: dict[None, None], func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
def hash_table_foreach_remove(hash_table: dict[None, None], func: typing.Callable[..., bool], *user_data: typing.Any) -> int: ...
def hash_table_foreach_steal(hash_table: dict[None, None], func: typing.Callable[..., bool], *user_data: typing.Any) -> int: ...
...
def hash_table_lookup_extended(hash_table: dict[None, None], lookup_key: None) -> typing.Tuple[bool, None, None]: ...
...
def hash_table_replace(hash_table: dict[None, None], key: None, value: None) -> bool: ...
...
def hash_table_steal_extended(hash_table: dict[None, None], lookup_key: None) -> typing.Tuple[bool, None, None]: ...
...
def hook_insert_sorted(hook_list: HookList, hook: Hook, func: typing.Callable[[Hook, Hook], int]) -> None: ...
...
def idle_add(function: typing.Callable[..., bool | None], *user_data: typing.Any, priority: int = 200) -> int: ...
...
def locale_to_utf8(opsysstring: typing.Sequence[int]) -> typing.Tuple[str, int, int]: ...
def log_default_handler(log_domain: typing.Optional[str], log_level: LogLevelFlags, message: typing.Optional[str], unused_data: None) -> None: ...
...
def log_set_handler(log_domain: typing.Optional[str], log_levels: LogLevelFlags, log_func: typing.Callable[..., None], *user_data: typing.Any) -> int: ...
def log_set_writer_func(func: typing.Callable[..., LogWriterOutput], *user_data: typing.Any) -> None: ...
def log_structured_array(log_level: LogLevelFlags, fields: typing.Sequence[LogField]) -> None: ...
def log_variant(log_domain: typing.Optional[str], log_level: LogLevelFlags, fields: Variant) -> None: ...
def log_writer_default(log_level: LogLevelFlags, fields: typing.Sequence[LogField], user_data: None) -> LogWriterOutput: ...
def log_writer_default_set_debug_domains(domains: typing.Optional[str] = None) -> None: ...
def log_writer_default_set_use_stderr(use_stderr: bool) -> None: ...
def log_writer_default_would_drop(log_level: LogLevelFlags, log_domain: typing.Optional[str] = None) -> bool: ...
def log_writer_format_fields(log_level: LogLevelFlags, fields: typing.Sequence[LogField], use_color: bool) -> str: ...
def log_writer_is_journald(output_fd: int) -> bool: ...
def log_writer_journald(log_level: LogLevelFlags, fields: typing.Sequence[LogField], user_data: None) -> LogWriterOutput: ...
def log_writer_standard_streams(log_level: LogLevelFlags, fields: typing.Sequence[LogField], user_data: None) -> LogWriterOutput: ...
def log_writer_supports_color(output_fd: int) -> bool: ...
def log_writer_syslog(log_level: LogLevelFlags, fields: typing.Sequence[LogField], user_data: None) -> LogWriterOutput: ...
...
def on_error_stack_trace(prg_name: typing.Optional[str] = None) -> None: ...
...
def parse_debug_string(string: typing.Optional[str], keys: typing.Sequence[DebugKey]) -> int: ...
...
def pointer_bit_lock_mask_ptr(ptr: None, lock_bit: int, set: bool, preserve_mask: int, preserve_ptr: None) -> None: ...
def pointer_bit_trylock(address: None, lock_bit: int) -> bool: ...
def pointer_bit_unlock(address: None, lock_bit: int) -> None: ...
def pointer_bit_unlock_and_set(address: None, lock_bit: int, ptr: None, preserve_mask: int) -> None: ...
def poll(fds: PollFD, nfds: int, timeout: int) -> int: ...
def prefix_error_literal(prefix: str) -> Error: ...
def propagate_error(src: Error) -> Error: ...
def qsort_with_data(pbase: None, total_elems: int, size: int, compare_func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
...
def rc_box_release_full(mem_block: None, clear_func: typing.Callable[[None], None]) -> None: ...
...
def ref_count_dec() -> typing.Tuple[bool, int]: ...
...
def sequence_foreach_range(begin: SequenceIter, end: SequenceIter, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
...
def sequence_sort_changed(iter: SequenceIter, cmp_func: typing.Callable[..., int], *cmp_data: typing.Any) -> None: ...
def sequence_sort_changed_iter(iter: SequenceIter, iter_cmp: typing.Callable[..., int], *cmp_data: typing.Any) -> None: ...
...
def slice_free_chain_with_offset(block_size: int, mem_chain: None, next_offset: int) -> None: ...
...
def spawn_async(argv, envp=None, working_directory=None, flags=0, child_setup=None, user_data=None, standard_input=False, standard_output=False, standard_error=False):
    """
    ...
    """  # FIXME: Override is missing typing annotation
def spawn_async_with_fds(working_directory: typing.Optional[str], argv: typing.Sequence[str], envp: typing.Optional[typing.Sequence[str]], flags: SpawnFlags, child_setup: typing.Optional[typing.Callable[..., None]], stdin_fd: int, stdout_fd: int, stderr_fd: int, *user_data: typing.Any) -> typing.Tuple[bool, int]: ...
def spawn_async_with_pipes(working_directory: typing.Optional[str], argv: typing.Sequence[str], envp: typing.Optional[typing.Sequence[str]], flags: SpawnFlags, child_setup: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> typing.Tuple[bool, int, int, int, int]: ...
def spawn_async_with_pipes_and_fds(working_directory: typing.Optional[str], argv: typing.Sequence[str], envp: typing.Optional[typing.Sequence[str]], flags: SpawnFlags, child_setup: typing.Optional[typing.Callable[..., None]], stdin_fd: int, stdout_fd: int, stderr_fd: int, source_fds: typing.Optional[typing.Sequence[int]] = None, target_fds: typing.Optional[typing.Sequence[int]] = None, *user_data: typing.Any) -> typing.Tuple[bool, int, int, int, int]: ...
...
def spawn_command_line_sync(command_line: str) -> typing.Tuple[bool, bytes, bytes, int]: ...
def spawn_error_quark() -> int: ...
def spawn_exit_error_quark() -> int: ...
def spawn_sync(working_directory: typing.Optional[str], argv: typing.Sequence[str], envp: typing.Optional[typing.Sequence[str]], flags: SpawnFlags, child_setup: typing.Optional[typing.Callable[..., None]] = None, *user_data: typing.Any) -> typing.Tuple[bool, bytes, bytes, int]: ...
...
def str_tokenize_and_fold(string: str, translit_locale: typing.Optional[str] = None) -> typing.Tuple[list[str], list[str]]: ...
...
def strcmp0(str1: typing.Optional[str] = None, str2: typing.Optional[str] = None) -> int: ...
def strcompress(source: str) -> str: ...
def strdelimit(string: str, delimiters: typing.Optional[str], new_delimiter: int) -> str: ...
def strdown(string: str) -> str: ...
def strdup(str: typing.Optional[str] = None) -> str: ...
def strdupv(str_array: typing.Optional[typing.Sequence[str]] = None) -> typing.Optional[list[str]]: ...
...
def strjoinv(separator: typing.Optional[str], str_array: typing.Sequence[str]) -> str: ...
...
def strrstr(haystack: str, needle: str) -> typing.Optional[str]: ...
def strrstr_len(haystack: str, haystack_len: int, needle: str) -> typing.Optional[str]: ...
def strsignal(signum: int) -> str: ...
def strsplit(string: str, delimiter: str, max_tokens: int) -> list[str]: ...
def strsplit_set(string: str, delimiters: typing.Sequence[int], max_tokens: int) -> list[str]: ...
def strstr_len(haystack: str, haystack_len: int, needle: str) -> typing.Optional[str]: ...
...
def strv_get_type() -> typing.Type[typing.Any]: ...
def strv_length(str_array: typing.Sequence[str]) -> int: ...
def test_add_data_func(testpath: str, test_data: None, test_func: typing.Callable[..., None]) -> None: ...
def test_add_data_func_full(testpath: str, test_data: None, test_func: typing.Callable[..., None], data_free_func: typing.Callable[[None], None]) -> None: ...
...
def test_expect_message(log_domain: typing.Optional[str], log_level: LogLevelFlags, pattern: str) -> None: ...
def test_fail() -> None: ...
...
def test_queue_destroy(destroy_func: typing.Callable[[None], None], destroy_data: None) -> None: ...
...
def test_trap_subprocess(test_path: typing.Optional[str], usec_timeout: int, test_flags: TestSubprocessFlags) -> None: ...
def test_trap_subprocess_with_envp(test_path: typing.Optional[str], envp: typing.Optional[typing.Sequence[str]], usec_timeout: int, test_flags: TestSubprocessFlags) -> None: ...
...
def timeout_add(interval: int, function: typing.Callable[..., bool | None], *user_data: typing.Any, priority: int = 0) -> int: ...
def timeout_add_seconds(interval: int, function: typing.Callable[..., bool | None], *user_data: typing.Any, priority: int = 0) -> int: ...
...
def unichar_fully_decompose(ch: str, compat: bool, result_len: int) -> typing.Tuple[int, str]: ...
...
def unix_fd_add_full(priority: int, fd: int, condition: IOCondition, function: typing.Callable[..., bool], *user_data: typing.Any) -> int: ...
...
def unix_signal_add(priority: int, signum: int, handler: typing.Callable[..., bool], *user_data: typing.Any) -> int: ...
def unix_signal_add_full(priority: int, signum: int, handler: typing.Callable[..., bool], *user_data: typing.Any) -> int: ...
def unix_signal_source_new(signum: int) -> Source: ...
def unlink(filename: str) -> int: ...
def unsetenv(variable: str) -> None: ...
def uri_build(flags: UriFlags, scheme: str, userinfo: typing.Optional[str], host: typing.Optional[str], port: int, path: str, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> Uri: ...
def uri_build_with_user(flags: UriFlags, scheme: str, user: typing.Optional[str], password: typing.Optional[str], auth_params: typing.Optional[str], host: typing.Optional[str], port: int, path: str, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> Uri: ...
def uri_error_quark() -> int: ...
def uri_escape_bytes(unescaped: typing.Sequence[int], reserved_chars_allowed: typing.Optional[str] = None) -> str: ...
def uri_escape_string(unescaped: str, reserved_chars_allowed: typing.Optional[str], allow_utf8: bool) -> str: ...
def uri_is_valid(uri_string: str, flags: UriFlags) -> bool: ...
def uri_join(flags: UriFlags, scheme: typing.Optional[str], userinfo: typing.Optional[str], host: typing.Optional[str], port: int, path: str, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> str: ...
def uri_join_with_user(flags: UriFlags, scheme: typing.Optional[str], user: typing.Optional[str], password: typing.Optional[str], auth_params: typing.Optional[str], host: typing.Optional[str], port: int, path: str, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> str: ...
def uri_list_extract_uris(uri_list: str) -> list[str]: ...
def uri_parse(uri_string: str, flags: UriFlags) -> Uri: ...
def uri_parse_params(params: str, length: int, separators: str, flags: UriParamsFlags) -> dict[str, str]: ...
def uri_parse_scheme(uri: str) -> typing.Optional[str]: ...
def uri_peek_scheme(uri: str) -> typing.Optional[str]: ...
def uri_resolve_relative(base_uri_string: typing.Optional[str], uri_ref: str, flags: UriFlags) -> str: ...
def uri_split(uri_ref: str, flags: UriFlags) -> typing.Tuple[bool, str, str, str, int, str, str, str]: ...
def uri_split_network(uri_string: str, flags: UriFlags) -> typing.Tuple[bool, str, str, int]: ...
def uri_split_with_user(uri_ref: str, flags: UriFlags) -> typing.Tuple[bool, str, str, str, str, str, int, str, str, str]: ...
def uri_unescape_bytes(escaped_string: str, length: int, illegal_characters: typing.Optional[str] = None) -> Bytes: ...
def uri_unescape_segment(escaped_string: typing.Optional[str] = None, escaped_string_end: typing.Optional[str] = None, illegal_characters: typing.Optional[str] = None) -> typing.Optional[str]: ...
def uri_unescape_string(escaped_string: str, illegal_characters: typing.Optional[str] = None) -> typing.Optional[str]: ...
...
def utf8_find_next_char(p: str, end: typing.Optional[str] = None) -> typing.Optional[str]: ...
...
def utf8_validate(str: typing.Sequence[int]) -> typing.Tuple[bool, bytes]: ...
def utf8_validate_len(str: typing.Sequence[int]) -> typing.Tuple[bool, bytes]: ...
...
def variant_parse(type: typing.Optional[VariantType], text: str, limit: typing.Optional[str] = None, endptr: typing.Optional[str] = None) -> Variant: ...
...
def variant_type_string_scan(string: str, limit: typing.Optional[str] = None) -> typing.Tuple[bool, str]: ...
...
class AsyncQueue(GObject.GPointer):
    ...
    def new() -> AsyncQueue: ...
    @staticmethod
    def new_full(item_free_func: typing.Optional[typing.Callable[[None], None]] = None) -> AsyncQueue: ...
    def pop(self) -> None: ...
    ...
    def push_sorted(self, data: None, func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
    def push_sorted_unlocked(self, data: None, func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
    ...
    def sort_unlocked(self, func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
...
class BookmarkFile(GObject.GBoxed):
    ...
    def add_application(self, uri: str, name: typing.Optional[str] = None, exec: typing.Optional[str] = None) -> None: ...
    ...
    def get_app_info(self, uri: str, name: str) -> typing.Tuple[bool, str, int, int]: ...
    def get_application_info(self, uri: str, name: str) -> typing.Tuple[bool, str, int, DateTime]: ...
    ...
    def set_application_info(self, uri: str, name: str, exec: str, count: int, stamp: typing.Optional[DateTime] = None) -> bool: ...
    def set_description(self, uri: typing.Optional[str], description: str) -> None: ...
    def set_groups(self, uri: str, groups: typing.Optional[typing.Sequence[str]] = None) -> None: ...
    def set_icon(self, uri: str, href: typing.Optional[str], mime_type: str) -> None: ...
...
class ByteArray(GObject.GBoxed):
    ...
    len: int = ...
    @staticmethod
    def append(array: typing.Sequence[int], data: typing.Sequence[int]) -> bytes: ...
    @staticmethod
    def free(array: typing.Sequence[int], free_segment: bool) -> typing.Optional[bytes]: ...
    @staticmethod
    ...
    @staticmethod
    def prepend(array: typing.Sequence[int], data: typing.Sequence[int]) -> bytes: ...
    @staticmethod
    ...
    @staticmethod
    def remove_range(array: typing.Sequence[int], index_: int, length: int) -> bytes: ...
    @staticmethod
    def set_size(array: typing.Sequence[int], length: int) -> bytes: ...
    @staticmethod
    def sized_new(reserved_size: int) -> bytes: ...
    @staticmethod
    def sort(array: typing.Sequence[int], compare_func: typing.Callable[[None, None], int]) -> None: ...
    @staticmethod
    def sort_with_data(array: typing.Sequence[int], compare_func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
    @staticmethod
    def steal(array: typing.Sequence[int]) -> bytes: ...
    @staticmethod
...
class Bytes(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], data: typing.Optional[typing.Sequence[int]] = None) -> Self: ...
...
class Cache(GObject.GPointer):
    ...
    def key_foreach(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def remove(self, value: None) -> None: ...
    def value_foreach(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
...
class Checksum(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], checksum_type: ChecksumType) -> Self: ...
...
class DateTime(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], tz: TimeZone, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> Self: ...
    def add(self, timespan: int) -> typing.Optional[DateTime]: ...
    def add_days(self, days: int) -> typing.Optional[DateTime]: ...
    def add_full(self, years: int, months: int, days: int, hours: int, minutes: int, seconds: float) -> typing.Optional[DateTime]: ...
    ...
    @classmethod
    def new(cls, tz: TimeZone, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> typing.Optional[DateTime]: ...
    @classmethod
    def new_from_iso8601(cls, text: str, default_tz: typing.Optional[TimeZone] = None) -> typing.Optional[DateTime]: ...
    @classmethod
    ...
    @classmethod
    def new_local(cls, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> typing.Optional[DateTime]: ...
    @classmethod
    ...
    @classmethod
    def new_utc(cls, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> typing.Optional[DateTime]: ...
...
class GError(RuntimeError):
    ...
    def __init__(self, message: str = unknown error, domain: str = pygi-error, code: int = 0) -> None: ...
    def copy(self) -> Self: ...
...
class HashTable(GObject.GBoxed):
    ...
    @staticmethod
    def find(hash_table: dict[None, None], predicate: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    @staticmethod
    def foreach(hash_table: dict[None, None], func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    @staticmethod
    def foreach_remove(hash_table: dict[None, None], func: typing.Callable[..., bool], *user_data: typing.Any) -> int: ...
    @staticmethod
    def foreach_steal(hash_table: dict[None, None], func: typing.Callable[..., bool], *user_data: typing.Any) -> int: ...
    @staticmethod
    def insert(hash_table: dict[None, None], key: None, value: None) -> bool: ...
    @staticmethod
    def lookup(hash_table: dict[None, None], key: None) -> None: ...
    @staticmethod
    def lookup_extended(hash_table: dict[None, None], lookup_key: None) -> typing.Tuple[bool, None, None]: ...
    @staticmethod
    ...
    @staticmethod
    def steal_extended(hash_table: dict[None, None], lookup_key: None) -> typing.Tuple[bool, None, None]: ...
    @staticmethod
...
class Hmac(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], digest_type: ChecksumType, key: typing.Sequence[int]) -> Self: ...
    def copy(self) -> Hmac: ...
    def get_digest(self, buffer: typing.Sequence[int]) -> None: ...
    def get_string(self) -> str: ...
    @classmethod
    def new(cls, digest_type: ChecksumType, key: typing.Sequence[int]) -> typing.Optional[Hmac]: ...
    def ref(self) -> Hmac: ...
    def unref(self) -> None: ...
    def update(self, data: typing.Sequence[int]) -> None: ...
...
class Hook(GObject.GPointer):
    ...
    @staticmethod
    def insert_sorted(hook_list: HookList, hook: Hook, func: typing.Callable[[Hook, Hook], int]) -> None: ...
    @staticmethod
...
class HookList(GObject.GPointer):
    ...
    def marshal(self, may_recurse: bool, marshaller: typing.Callable[..., None], *marshal_data: typing.Any) -> None: ...
    def marshal_check(self, may_recurse: bool, marshaller: typing.Callable[..., bool], *marshal_data: typing.Any) -> None: ...
...
class IOChannel(GObject.GBoxed):
    ...
    @staticmethod
    def __new__(cls: type[Self], filedes: int | None = None, filename: str | None = None, mode: str | None = None, hwnd: int | None = None) -> Self: ...
    def add_watch(self, condition: IOCondition, callback: typing.Callable[..., bool | None], *user_data: typing.Any, priority: int = 0) -> int: ...
    def close(self) -> None: ...
    @staticmethod
    ...
    def read_line_string(self, buffer: String, terminator_pos: typing.Optional[int] = None) -> IOStatus: ...
    ...
    def write_chars(self, buf: typing.Sequence[int], count: int) -> typing.Tuple[IOStatus, int]: ...
...
class KeyFile(GObject.GBoxed):
    ...
    def get_comment(self, group_name: typing.Optional[str] = None, key: typing.Optional[str] = None) -> str: ...
    ...
    def get_locale_for_key(self, group_name: str, key: str, locale: typing.Optional[str] = None) -> typing.Optional[str]: ...
    def get_locale_string(self, group_name: str, key: str, locale: typing.Optional[str] = None) -> str: ...
    def get_locale_string_list(self, group_name: str, key: str, locale: typing.Optional[str] = None) -> list[str]: ...
    ...
    def load_from_data_dirs(self, file: str, flags: KeyFileFlags) -> typing.Tuple[bool, str]: ...
    def load_from_dirs(self, file: str, search_dirs: typing.Sequence[str], flags: KeyFileFlags) -> typing.Tuple[bool, str]: ...
    def load_from_file(self, file: str, flags: KeyFileFlags) -> bool: ...
    @classmethod
    def new(cls) -> KeyFile: ...
    def remove_comment(self, group_name: typing.Optional[str] = None, key: typing.Optional[str] = None) -> bool: ...
    ...
    def set_boolean_list(self, group_name: str, key: str, list: typing.Sequence[bool]) -> None: ...
    def set_comment(self, group_name: typing.Optional[str], key: typing.Optional[str], comment: str) -> bool: ...
    def set_double(self, group_name: str, key: str, value: float) -> None: ...
    def set_double_list(self, group_name: str, key: str, list: typing.Sequence[float]) -> None: ...
    def set_int64(self, group_name: str, key: str, value: int) -> None: ...
    def set_integer(self, group_name: str, key: str, value: int) -> None: ...
    def set_integer_list(self, group_name: str, key: str, list: typing.Sequence[int]) -> None: ...
    ...
    def set_locale_string_list(self, group_name: str, key: str, locale: str, list: typing.Sequence[str]) -> None: ...
    def set_string(self, group_name: str, key: str, string: str) -> None: ...
    def set_string_list(self, group_name: str, key: str, list: typing.Sequence[str]) -> None: ...
...
class MainContext(GObject.GBoxed):
    ...
    def find_source_by_funcs_user_data(self, funcs: SourceFuncs, user_data: None) -> typing.Optional[Source]: ...
    def find_source_by_id(self, source_id: int) -> Source: ...
    def find_source_by_user_data(self, user_data: None) -> typing.Optional[Source]: ...
    @staticmethod
    def get_thread_default() -> typing.Optional[MainContext]: ...
    def invoke_full(self, priority: int, function: typing.Callable[..., bool], *data: typing.Any) -> None: ...
...
class MappedFile(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], filename: str, writable: bool) -> Self: ...
    def free(self) -> None: ...
...
class MarkupParseContext(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], parser: MarkupParser, flags: MarkupParseFlags, user_data: None, user_data_dnotify: typing.Callable[[None], None]) -> Self: ...
    ...
    def get_tag_start(self) -> typing.Tuple[int, int, int]: ...
    def get_user_data(self) -> None: ...
    @classmethod
    def new(cls, parser: MarkupParser, flags: MarkupParseFlags, user_data: None, user_data_dnotify: typing.Callable[[None], None]) -> MarkupParseContext: ...
...
class Node(GObject.GPointer):
    ...
    def children_foreach(self, flags: TraverseFlags, func: typing.Callable[..., None], *data: typing.Any) -> None: ...
    def depth(self) -> int: ...
    def destroy(self) -> None: ...
    ...
    def traverse(self, order: TraverseType, flags: TraverseFlags, max_depth: int, func: typing.Callable[..., bool], *data: typing.Any) -> None: ...
...
class OptionContext(GObject.GPointer):
    ...
    def add_main_entries(self, entries: typing.Sequence[OptionEntry], translation_domain: typing.Optional[str] = None) -> None: ...
    def free(self) -> None: ...
    def get_description(self) -> str: ...
    def get_help(self, main_help: bool, group: typing.Optional[OptionGroup] = None) -> str: ...
    ...
    def set_translate_func(self, func: typing.Optional[typing.Callable[..., str]] = None, *data: typing.Any) -> None: ...
...
class OptionGroup(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], name: str, description: str, help_description: str, user_data: None, destroy: typing.Optional[typing.Callable[[None], None]] = None) -> Self: ...
    def add_entries(self, entries: typing.Sequence[OptionEntry]) -> None: ...
    def free(self) -> None: ...
    @classmethod
    def new(cls, name: str, description: str, help_description: str, user_data: None, destroy: typing.Optional[typing.Callable[[None], None]] = None) -> OptionGroup: ...
...
class PatternSpec(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], pattern: str) -> Self: ...
    def copy(self) -> PatternSpec: ...
    def equal(self, pspec2: PatternSpec) -> bool: ...
    def free(self) -> None: ...
    def match(self, string_length: int, string: str, string_reversed: typing.Optional[str] = None) -> bool: ...
...
class Queue(GObject.GPointer):
    ...
    length: int = ...
    def clear(self) -> None: ...
    def clear_full(self, free_func: typing.Optional[typing.Callable[[None], None]] = None) -> None: ...
    def foreach(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def free(self) -> None: ...
    def free_full(self, free_func: typing.Callable[[None], None]) -> None: ...
    def get_length(self) -> int: ...
    def index(self, data: None) -> int: ...
    def init(self) -> None: ...
    def insert_sorted(self, data: None, func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
    ...
    def sort(self, compare_func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
...
class Regex(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], pattern: str, compile_options: RegexCompileFlags, match_options: RegexMatchFlags) -> Self: ...
    @staticmethod
    ...
    def match(self, string: str, match_options: RegexMatchFlags) -> typing.Tuple[bool, MatchInfo]: ...
    def match_all(self, string: str, match_options: RegexMatchFlags) -> typing.Tuple[bool, MatchInfo]: ...
    def match_all_full(self, string: typing.Sequence[str], start_position: int, match_options: RegexMatchFlags) -> typing.Tuple[bool, MatchInfo]: ...
    def match_full(self, string: typing.Sequence[str], start_position: int, match_options: RegexMatchFlags) -> typing.Tuple[bool, MatchInfo]: ...
    @staticmethod
    def match_simple(pattern: str, string: str, compile_options: RegexCompileFlags, match_options: RegexMatchFlags) -> bool: ...
    @classmethod
    def new(cls, pattern: str, compile_options: RegexCompileFlags, match_options: RegexMatchFlags) -> typing.Optional[Regex]: ...
    def ref(self) -> Regex: ...
    def replace(self, string: typing.Sequence[str], start_position: int, replacement: str, match_options: RegexMatchFlags) -> str: ...
    def replace_eval(self, string: typing.Sequence[str], start_position: int, match_options: RegexMatchFlags, eval: typing.Callable[..., bool], *user_data: typing.Any) -> str: ...
    def replace_literal(self, string: typing.Sequence[str], start_position: int, replacement: str, match_options: RegexMatchFlags) -> str: ...
    def split(self, string: str, match_options: RegexMatchFlags) -> list[str]: ...
    def split_full(self, string: typing.Sequence[str], start_position: int, match_options: RegexMatchFlags, max_tokens: int) -> list[str]: ...
    @staticmethod
    def split_simple(pattern: str, string: str, compile_options: RegexCompileFlags, match_options: RegexMatchFlags) -> list[str]: ...
    def unref(self) -> None: ...
...
class Scanner(GObject.GPointer):
    ...
    def scope_foreach_symbol(self, scope_id: int, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    ...
    def unexp_token(self, expected_token: TokenType, identifier_spec: str, symbol_spec: str, symbol_name: str, message: str, is_error: int) -> None: ...
...
class Sequence(GObject.GPointer):
    ...
    def foreach(self, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    @staticmethod
    def foreach_range(begin: SequenceIter, end: SequenceIter, func: typing.Callable[..., None], *user_data: typing.Any) -> None: ...
    def free(self) -> None: ...
    @staticmethod
    ...
    def insert_sorted(self, data: None, cmp_func: typing.Callable[..., int], *cmp_data: typing.Any) -> SequenceIter: ...
    def insert_sorted_iter(self, data: None, iter_cmp: typing.Callable[..., int], *cmp_data: typing.Any) -> SequenceIter: ...
    def is_empty(self) -> bool: ...
    def lookup(self, data: None, cmp_func: typing.Callable[..., int], *cmp_data: typing.Any) -> typing.Optional[SequenceIter]: ...
    def lookup_iter(self, data: None, iter_cmp: typing.Callable[..., int], *cmp_data: typing.Any) -> typing.Optional[SequenceIter]: ...
    @staticmethod
    ...
    def search(self, data: None, cmp_func: typing.Callable[..., int], *cmp_data: typing.Any) -> SequenceIter: ...
    def search_iter(self, data: None, iter_cmp: typing.Callable[..., int], *cmp_data: typing.Any) -> SequenceIter: ...
    @staticmethod
    def set(iter: SequenceIter, data: None) -> None: ...
    def sort(self, cmp_func: typing.Callable[..., int], *cmp_data: typing.Any) -> None: ...
    @staticmethod
    def sort_changed(iter: SequenceIter, cmp_func: typing.Callable[..., int], *cmp_data: typing.Any) -> None: ...
    @staticmethod
    def sort_changed_iter(iter: SequenceIter, iter_cmp: typing.Callable[..., int], *cmp_data: typing.Any) -> None: ...
    def sort_iter(self, cmp_func: typing.Callable[..., int], *cmp_data: typing.Any) -> None: ...
    @staticmethod
...
class Source(GObject.GBoxed):
    ...
    def destroy(self) -> None: ...
    def dup_context(self) -> typing.Optional[MainContext]: ...
    ...
    def set_callback(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def set_callback_indirect(self, callback_data: None, callback_funcs: SourceCallbackFuncs) -> None: ...
...
class SourceFuncs(GObject.GPointer):
    ...
    ::
        ...
        SourceFuncs()
    """
    prepare: typing.Callable[[Source], typing.Tuple[bool, int]] = ...
...
class Thread(GObject.GBoxed):
    ...
    def join(self) -> None: ...
    @classmethod
    def new(cls, name: typing.Optional[str], func: typing.Callable[..., None], *data: typing.Any) -> Thread: ...
    def ref(self) -> Thread: ...
    @staticmethod
    def self() -> Thread: ...
    @classmethod
    def try_new(cls, name: typing.Optional[str], func: typing.Callable[..., None], *data: typing.Any) -> Thread: ...
    def unref(self) -> None: ...
    @staticmethod
    def yield_() -> None: ...
...
class TimeZone(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], identifier: typing.Optional[str] = None) -> Self: ...
    ...
    @classmethod
    def new_identifier(cls, identifier: typing.Optional[str] = None) -> typing.Optional[TimeZone]: ...
    @classmethod
...
class Tree(GObject.GBoxed):
    ...
    """
    def destroy(self) -> None: ...
    def foreach(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def foreach_node(self, func: typing.Callable[..., bool], *user_data: typing.Any) -> None: ...
    def height(self) -> int: ...
    ...
    @classmethod
    def new_full(cls, key_compare_func: typing.Callable[..., int], key_destroy_func: typing.Callable[[None], None], *key_compare_data: typing.Any) -> Tree: ...
    def nnodes(self) -> int: ...
    ...
    def search(self, search_func: typing.Callable[..., int], *user_data: typing.Any) -> None: ...
    def search_node(self, search_func: typing.Callable[..., int], *user_data: typing.Any) -> typing.Optional[TreeNode]: ...
    def steal(self, key: None) -> bool: ...
    def traverse(self, traverse_func: typing.Callable[..., bool], traverse_type: TraverseType, *user_data: typing.Any) -> None: ...
    def unref(self) -> None: ...
...
class Uri(GObject.GBoxed):
    @staticmethod
    def build(flags: UriFlags, scheme: str, userinfo: typing.Optional[str], host: typing.Optional[str], port: int, path: str, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> Uri: ...
    @staticmethod
    def build_with_user(flags: UriFlags, scheme: str, user: typing.Optional[str], password: typing.Optional[str], auth_params: typing.Optional[str], host: typing.Optional[str], port: int, path: str, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> Uri: ...
    @staticmethod
    def error_quark() -> int: ...
    @staticmethod
    def escape_bytes(unescaped: typing.Sequence[int], reserved_chars_allowed: typing.Optional[str] = None) -> str: ...
    @staticmethod
    def escape_string(unescaped: str, reserved_chars_allowed: typing.Optional[str], allow_utf8: bool) -> str: ...
    ...
    @staticmethod
    def join(flags: UriFlags, scheme: typing.Optional[str], userinfo: typing.Optional[str], host: typing.Optional[str], port: int, path: str, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> str: ...
    @staticmethod
    def join_with_user(flags: UriFlags, scheme: typing.Optional[str], user: typing.Optional[str], password: typing.Optional[str], auth_params: typing.Optional[str], host: typing.Optional[str], port: int, path: str, query: typing.Optional[str] = None, fragment: typing.Optional[str] = None) -> str: ...
    @staticmethod
    def list_extract_uris(uri_list: str) -> list[str]: ...
    @staticmethod
    def parse(uri_string: str, flags: UriFlags) -> Uri: ...
    @staticmethod
    def parse_params(params: str, length: int, separators: str, flags: UriParamsFlags) -> dict[str, str]: ...
    ...
    @staticmethod
    def resolve_relative(base_uri_string: typing.Optional[str], uri_ref: str, flags: UriFlags) -> str: ...
    @staticmethod
    def split(uri_ref: str, flags: UriFlags) -> typing.Tuple[bool, str, str, str, int, str, str, str]: ...
    @staticmethod
    def split_network(uri_string: str, flags: UriFlags) -> typing.Tuple[bool, str, str, int]: ...
    @staticmethod
    def split_with_user(uri_ref: str, flags: UriFlags) -> typing.Tuple[bool, str, str, str, str, str, int, str, str, str]: ...
    def to_string(self) -> str: ...
    def to_string_partial(self, flags: UriHideFlags) -> str: ...
    @staticmethod
    def unescape_bytes(escaped_string: str, length: int, illegal_characters: typing.Optional[str] = None) -> Bytes: ...
    @staticmethod
    def unescape_segment(escaped_string: typing.Optional[str] = None, escaped_string_end: typing.Optional[str] = None, illegal_characters: typing.Optional[str] = None) -> typing.Optional[str]: ...
    @staticmethod
    def unescape_string(escaped_string: str, illegal_characters: typing.Optional[str] = None) -> typing.Optional[str]: ...
...
class Variant(GObject.GPointer):
    ...
    def lookup_value(self, key: str, expected_type: typing.Optional[VariantType] = None) -> Variant: ...
    def n_children(self) -> int: ...
    @classmethod
    def new_array(cls, child_type: typing.Optional[VariantType] = None, children: typing.Optional[typing.Sequence[Variant]] = None) -> Variant: ...
    @classmethod
    ...
    @classmethod
    def new_fixed_array(cls, element_type: VariantType, elements: None, n_elements: int, element_size: int) -> Variant: ...
    @classmethod
    def new_from_bytes(cls, type: VariantType, bytes: Bytes, trusted: bool) -> Variant: ...
    @classmethod
    def new_from_data(cls, type: VariantType, data: typing.Sequence[int], trusted: bool, notify: typing.Callable[[None], None], user_data: None) -> Variant: ...
    @classmethod
    ...
    @classmethod
    def new_maybe(cls, child_type: typing.Optional[VariantType] = None, child: typing.Optional[Variant] = None) -> Variant: ...
    @classmethod
    ...
    @staticmethod
    def parse(type: typing.Optional[VariantType], text: str, limit: typing.Optional[str] = None, endptr: typing.Optional[str] = None) -> Variant: ...
    @staticmethod
...
class VariantBuilder(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], type: VariantType) -> Self: ...
...
class VariantDict(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], from_asv: typing.Optional[Variant] = None) -> Self: ...
    def clear(self) -> None: ...
    def contains(self, key: str) -> bool: ...
    def end(self) -> Variant: ...
    def insert_value(self, key: str, value: Variant) -> None: ...
    def lookup_value(self, key: str, expected_type: typing.Optional[VariantType] = None) -> typing.Optional[Variant]: ...
    @classmethod
...
class VariantType(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], type_string: str) -> Self: ...
    @staticmethod
    ...
    def first(self) -> typing.Optional[VariantType]: ...
    def free(self) -> None: ...
    ...
    def next(self) -> typing.Optional[VariantType]: ...
    @staticmethod
    def string_get_depth_(type_string: str) -> int: ...
    @staticmethod
    def string_is_valid(type_string: str) -> bool: ...
    @staticmethod
    def string_scan(string: str, limit: typing.Optional[str] = None) -> typing.Tuple[bool, str]: ...
