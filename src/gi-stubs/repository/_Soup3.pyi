...
def date_time_new_from_http_string(date_string: str) -> GLib.DateTime | None: ...
...
def form_decode_multipart(
    multipart: Multipart, file_control_name: str | None = None
) -> tuple[dict[str, str] | None, str, str, GLib.Bytes]: ...
...
def header_contains_case_sensitive(header: str, token: str) -> bool: ...
def header_free_param_list(param_list: dict[str, str]) -> None: ...
def header_g_string_append_param(
    string: GLib.String, name: str, value: str | None = None
) -> None: ...
...
def header_parse_param_list_strict(header: str) -> dict[str, str] | None: ...
def header_parse_quality_list(header: str) -> tuple[list[str], list[str]]: ...
def header_parse_semi_param_list(header: str) -> dict[str, str]: ...
def header_parse_semi_param_list_strict(header: str) -> dict[str, str] | None: ...
...
# override
def uri_decode_data_uri(uri: str) -> tuple[GLib.Bytes | None, str | None]: ...
def uri_equal(uri1: GLib.Uri, uri2: GLib.Uri) -> bool: ...
def websocket_client_prepare_handshake(
    msg: Message,
    origin: str | None = None,
    protocols: Sequence[str] | None = None,
    supported_extensions: Sequence[GObject.TypeClass] | None = None,
) -> None: ...
def websocket_client_verify_handshake(
    msg: Message, supported_extensions: Sequence[GObject.TypeClass] | None = None
...
class Auth(GObject.Object):
    ...
    @classmethod
    def new(cls, type: type[Any], msg: Message, auth_header: str) -> Auth | None: ...
...
class AuthClass(GObject.GPointer):
    ...
    @property
    def update(self) -> Callable[[Auth, Message, dict[None, None]], bool]: ...
    @property
    def get_protection_space(self) -> Callable[[Auth, GLib.Uri], list[str]]: ...
    @property
    def authenticate(self) -> Callable[[Auth, str, str], None]: ...
    @property
    def is_authenticated(self) -> Callable[[Auth], bool]: ...
    @property
    def get_authorization(self) -> Callable[[Auth, Message], str]: ...
    @property
    def is_ready(self) -> Callable[[Auth, Message], bool]: ...
    @property
    def can_authenticate(self) -> Callable[[Auth], bool]: ...
    @property
...
class AuthDomain(GObject.Object):
    ...
    def accepts(self, msg: ServerMessage) -> str | None: ...
...
class AuthDomainClass(GObject.GPointer):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def accepts(self) -> Callable[[AuthDomain, ServerMessage, str], str]: ...
    @property
    def challenge(self) -> Callable[[AuthDomain, ServerMessage], str]: ...
    @property
    def check_password(
        self,
    ) -> Callable[[AuthDomain, ServerMessage, str, str], bool]: ...
    @property
    def padding(self) -> list[None]: ...
...
class AuthDomainDigest(AuthDomain):
    ...
    def set_auth_callback(
        self, callback: Callable[..., str | None], *user_data: Any
    ) -> None: ...
...
class Cache(GObject.Object, SessionFeature):
    ...
    def parent_instance(self) -> GObject.Object: ...
    def __init__(
        self, *, cache_dir: str = ..., cache_type: CacheType = ...
    ) -> None: ...
    def clear(self) -> None: ...
    ...
    def load(self) -> None: ...
    @classmethod
    def new(cls, cache_dir: str | None, cache_type: CacheType) -> Cache: ...
...
class CacheClass(GObject.GPointer):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def get_cacheability(self) -> Callable[[Cache, Message], Cacheability]: ...
    @property
    def padding(self) -> list[None]: ...
...
class Cookie(GObject.GBoxed):
    ...
    @staticmethod
    def __new__(
        cls: type[Self], name: str, value: str, domain: str, path: str, max_age: int
    ) -> Self: ...
    ...
    def get_expires(self) -> GLib.DateTime | None: ...
    ...
    @staticmethod
    def parse(header: str, origin: GLib.Uri | None = None) -> Cookie | None: ...
...
class CookieJar(GObject.Object, SessionFeature):
    ...
    def add_cookie_full(
        self,
        cookie: Cookie,
        uri: GLib.Uri | None = None,
        first_party: GLib.Uri | None = None,
    ) -> None: ...
    ...
    def get_cookie_list_with_same_site_info(
        self,
        uri: GLib.Uri,
        top_level: GLib.Uri | None,
        site_for_cookies: GLib.Uri | None,
        for_http: bool,
        is_safe_method: bool,
        is_top_level_navigation: bool,
    ) -> list[Cookie]: ...
    def get_cookies(self, uri: GLib.Uri, for_http: bool) -> str | None: ...
...
class CookieJarClass(GObject.GPointer):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def save(self) -> Callable[[CookieJar], None]: ...
    @property
    def is_persistent(self) -> Callable[[CookieJar], bool]: ...
    @property
    def changed(self) -> Callable[[CookieJar, Cookie, Cookie], None]: ...
    @property
    def padding(self) -> list[None]: ...
...
class CookieJarDBClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> CookieJarClass: ...
...
class HSTSEnforcerClass(GObject.GPointer):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def is_persistent(self) -> Callable[[HSTSEnforcer], bool]: ...
    @property
    def has_valid_policy(self) -> Callable[[HSTSEnforcer, str], bool]: ...
    @property
    def changed(self) -> Callable[[HSTSEnforcer, HSTSPolicy, HSTSPolicy], None]: ...
    @property
    def padding(self) -> list[None]: ...
...
class HSTSPolicy(GObject.GBoxed):
    ...
    @staticmethod
    def __new__(
        cls: type[Self], domain: str, max_age: int, include_subdomains: bool
    ) -> Self: ...
    ...
    @classmethod
    def new_from_response(cls, msg: Message) -> HSTSPolicy | None: ...
    @classmethod
    def new_full(
...
class Message(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ...
        remote_address: Gio.SocketAddress | None
    ...
    def get_metrics(self) -> MessageMetrics | None: ...
    def get_priority(self) -> MessagePriority: ...
    def get_reason_phrase(self) -> str | None: ...
    def get_remote_address(self) -> Gio.SocketAddress | None: ...
    ...
    def get_tls_peer_certificate(self) -> Gio.TlsCertificate | None: ...
    ...
    @classmethod
    def new(cls, method: str, uri_string: str) -> Message | None: ...
    @classmethod
    ...
    def set_request_body_from_bytes(
        self, content_type: str | None = None, bytes: GLib.Bytes | None = None
    ) -> None: ...
    def set_site_for_cookies(
        self, site_for_cookies: GLib.Uri | None = None
    ) -> None: ...
    def set_tls_client_certificate(
        self, certificate: Gio.TlsCertificate | None = None
    ) -> None: ...
...
class MessageBody(GObject.GBoxed):
    ...
    def get_chunk(self, offset: int) -> GLib.Bytes | None: ...
...
class MessageHeaders(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], type: MessageHeadersType) -> Self: ...
    ...
    def get_content_type(self) -> tuple[str | None, dict[str, str]]: ...
    ...
    def get_one(self, name: str) -> str | None: ...
    ...
    def set_content_disposition(
        self, disposition: str, params: dict[str, str] | None = None
    ) -> None: ...
    ...
    def set_content_type(
        self, content_type: str, params: dict[str, str] | None = None
    ) -> None: ...
...
class Multipart(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], mime_type: str) -> Self: ...
...
class MultipartInputStream(Gio.FilterInputStream, Gio.PollableInputStream):
    ...
    def get_headers(self) -> MessageHeaders | None: ...
    @classmethod
    def new(
...
class MultipartInputStreamClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> Gio.FilterInputStreamClass: ...
...
class Server(GObject.Object):
    ...
    def accept_iostream(
        self,
        stream: Gio.IOStream,
        local_addr: Gio.SocketAddress | None = None,
        remote_addr: Gio.SocketAddress | None = None,
    ) -> bool: ...
    def add_auth_domain(self, auth_domain: AuthDomain) -> None: ...
    def add_early_handler(
        self, path: str | None, callback: Callable[..., None], *user_data: Any
    ) -> None: ...
    def add_handler(
        self, path: str | None, callback: Callable[..., None], *user_data: Any
    ) -> None: ...
...
class ServerClass(GObject.GPointer):
    ...
    def parent_class(self) -> GObject.ObjectClass: ...
    @property
    def request_started(self) -> Callable[[Server, ServerMessage], None]: ...
    @property
    def request_read(self) -> Callable[[Server, ServerMessage], None]: ...
    @property
    def request_finished(self) -> Callable[[Server, ServerMessage], None]: ...
    @property
    def request_aborted(self) -> Callable[[Server, ServerMessage], None]: ...
    @property
    def padding(self) -> list[None]: ...
...
class ServerMessage(GObject.Object):
    ...
    def set_response(
        ...
        content_type: str | None,
        resp_use: MemoryUse,
        resp_body: Sequence[int] | None = None,
    ) -> None: ...
    def set_status(
...
class Session(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ...
        idle_timeout: int
        local_address: Gio.InetSocketAddress | None
        max_conns: int
        max_conns_per_host: int
        proxy_resolver: Gio.ProxyResolver | None
        remote_connectable: Gio.SocketConnectable | None
        timeout: int
        tls_database: Gio.TlsDatabase | None
    ...
    def get_accept_language(self) -> str | None: ...
    def get_accept_language_auto(self) -> bool: ...
    def get_async_result_message(self, result: Gio.AsyncResult) -> Message: ...
    def get_feature(self, feature_type: type[Any]) -> SessionFeature | None: ...
    def get_feature_for_message(
        self, feature_type: type[Any], msg: Message
    ) -> SessionFeature | None: ...
    def get_idle_timeout(self) -> int: ...
    def get_local_address(self) -> Gio.InetSocketAddress | None: ...
    def get_max_conns(self) -> int: ...
    def get_max_conns_per_host(self) -> int: ...
    def get_proxy_resolver(self) -> Gio.ProxyResolver | None: ...
    def get_remote_connectable(self) -> Gio.SocketConnectable | None: ...
    ...
    def send(
        self, msg: Message, cancellable: Gio.Cancellable | None = None
    ) -> Gio.InputStream: ...
    def send_and_read(
        self, msg: Message, cancellable: Gio.Cancellable | None = None
    ) -> GLib.Bytes: ...
    ...
    def set_proxy_resolver(
        self, proxy_resolver: Gio.ProxyResolver | None = None
    ) -> None: ...
    def set_timeout(self, timeout: int) -> None: ...
    def set_tls_database(self, tls_database: Gio.TlsDatabase | None = None) -> None: ...
    def set_tls_interaction(
        self, tls_interaction: Gio.TlsInteraction | None = None
    ) -> None: ...
...
class WebsocketConnection(GObject.Object):
    ...
    Properties from SoupWebsocketConnection:
      ...
      max-total-message-size -> guint64: Max total message size
    ...
    def close(self, code: int, data: str | None = None) -> None: ...
    ...
    def get_max_total_message_size(self) -> int: ...
    ...
    def send_binary(self, data: Sequence[int] | None = None) -> None: ...
    ...
    def set_max_total_message_size(self, max_total_message_size: int) -> None: ...
...
class WebsocketExtension(GObject.Object):
    ...
    def configure(
        self,
        connection_type: WebsocketConnectionType,
        params: dict[None, None] | None = None,
    ) -> bool: ...
    def do_configure(
        self,
        connection_type: WebsocketConnectionType,
    ...
    def do_get_request_params(self) -> str | None: ...
    def do_get_response_params(self) -> str | None: ...
    ...
    def get_request_params(self) -> str | None: ...
    def get_response_params(self) -> str | None: ...
...
class WebsocketExtensionClass(GObject.GPointer):
    ...
    def configure(
        ...
        [WebsocketExtension, WebsocketConnectionType, dict[None, None] | None], bool
    ]: ...
    @property
    def get_request_params(self) -> Callable[[WebsocketExtension], str | None]: ...
    @property
    def get_response_params(self) -> Callable[[WebsocketExtension], str | None]: ...
    @property
    def process_outgoing_message(
        self,
    ) -> Callable[[WebsocketExtension, GLib.Bytes], tuple[GLib.Bytes, int]]: ...
    @property
    def process_incoming_message(
        self,
    ) -> Callable[[WebsocketExtension, GLib.Bytes], tuple[GLib.Bytes, int]]: ...
...
class WebsocketExtensionDeflateClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> WebsocketExtensionClass: ...
