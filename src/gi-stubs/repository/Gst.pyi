...
def buffer_list_replace(
    new_list: BufferList | None = None,
) -> tuple[bool, BufferList]: ...
def buffer_list_take(new_list: BufferList | None = None) -> tuple[bool, BufferList]: ...
def caps_features_from_string(features: str) -> CapsFeatures | None: ...
def caps_from_string(string: str) -> Caps | None: ...
def context_replace(new_context: Context | None = None) -> tuple[bool, Context]: ...
...
def debug_print_segment(segment: Segment | None = None) -> str: ...
def debug_print_stack_trace() -> None: ...
def debug_remove_log_function(func: Callable[..., None] | None = None) -> int: ...
...
def deinit() -> None: ...
def dynamic_type_register(plugin: Plugin, type: type[Any]) -> bool: ...
...
def message_take(new_message: Message | None = None) -> tuple[bool, Message]: ...
...
def meta_api_type_get_tags(api: type[Any]) -> list[str]: ...
def meta_api_type_has_tag(api: type[Any], tag: int) -> bool: ...
def meta_api_type_register(api: str, tags: Sequence[str]) -> type[Any]: ...
def meta_api_type_set_params_aggregator(
    api: type[Any], aggregator: Callable[[Structure, Structure, Structure], bool]
) -> None: ...
...
def meta_register_custom(
    name: str,
    tags: Sequence[str],
    transform_func: Callable[..., bool] | None = None,
    *user_data: Any,
) -> MetaInfo: ...
...
def parent_buffer_meta_api_get_type() -> type[Any]: ...
...
def protection_meta_api_get_type() -> type[Any]: ...
def protection_meta_get_info() -> MetaInfo: ...
def protection_select_system(system_identifiers: Sequence[str]) -> str | None: ...
def query_take(new_query: Query | None = None) -> tuple[bool, Query]: ...
...
def structure_take(newstr: Structure | None = None) -> tuple[bool, Structure]: ...
def tag_exists(tag: str) -> bool: ...
def tag_get_description(tag: str) -> str: ...
def tag_get_flag(tag: str) -> TagFlag: ...
def tag_get_nick(tag: str) -> str: ...
def tag_get_type(tag: str) -> type[Any]: ...
def tag_is_fixed(tag: str) -> bool: ...
def tag_list_copy_value(list: TagList, tag: str) -> tuple[bool, Any]: ...
def tag_list_replace(new_taglist: TagList | None = None) -> tuple[bool, TagList]: ...
def tag_list_take(new_taglist: TagList | None = None) -> tuple[bool, TagList]: ...
...
def value_deserialize_with_pspec(
    src: str, pspec: GObject.ParamSpec | None = None
) -> tuple[bool, Any]: ...
...
def value_get_fraction_range_max(value: Any) -> Any | None: ...
def value_get_fraction_range_min(value: Any) -> Any | None: ...
...
def value_serialize(value: Any) -> str | None: ...
...
class Allocator(Object):
    ...
    @property
    def mem_map(self) -> Callable[[Memory, int, MapFlags], None]: ...
    @property
    def mem_unmap(self) -> Callable[[Memory], None]: ...
    @property
    def mem_copy(self) -> Callable[[Memory, int, int], Memory]: ...
    @property
    def mem_share(self) -> Callable[[Memory, int, int], Memory]: ...
    @property
    def mem_is_span(self) -> Callable[[Memory, Memory, int], bool]: ...
    @property
    def mem_map_full(self) -> Callable[[Memory, MapInfo, int], None]: ...
    @property
    def mem_unmap_full(self) -> Callable[[Memory, MapInfo], None]: ...
    @property
    def priv(self) -> AllocatorPrivate: ...
    def __init__(self, *, name: str | None = ..., parent: Object = ...) -> None: ...
    def alloc(
        self, size: int, params: AllocationParams | None = None
    ) -> Memory | None: ...
    def do_alloc(
        self, size: int, params: AllocationParams | None = None
    ) -> Memory | None: ...
...
class AllocatorClass(GObject.GPointer):
    ...
    def alloc(
        self,
    ) -> Callable[[Allocator | None, int, AllocationParams | None], Memory | None]: ...
    @property
    def free(self) -> Callable[[Allocator, Memory], None]: ...
...
class Bin(Element, ChildProxy):
    ...
    @property
    def provided_clock(self) -> Clock: ...
    @property
    def clock_provider(self) -> Element: ...
    @property
    ...
    def iterate_all_by_interface(self, iface: type[Any]) -> Iterator | None: ...
...
class BinClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> ElementClass: ...
    @property
    def pool(self) -> GLib.ThreadPool: ...
    @property
    def element_added(self) -> Callable[[Bin, Element], None]: ...
    @property
    def element_removed(self) -> Callable[[Bin, Element], None]: ...
    @property
    def add_element(self) -> Callable[[Bin, Element], bool]: ...
    @property
    def remove_element(self) -> Callable[[Bin, Element], bool]: ...
    @property
    def handle_message(self) -> Callable[[Bin, Message], None]: ...
    @property
    def do_latency(self) -> Callable[[Bin], bool]: ...
    @property
    def deep_element_added(self) -> Callable[[Bin, Bin, Element], None]: ...
    @property
    def deep_element_removed(self) -> Callable[[Bin, Bin, Element], None]: ...

class BinPrivate(GObject.GPointer): ...
class Bitmask(_gi.Fundamental): ...
...
class Buffer(GObject.GBoxed):
    ...
    def add_meta(self, info: MetaInfo, params: None) -> Meta | None: ...
    ...
    def get_meta(self, api: type[Any]) -> Meta | None: ...
    def get_n_meta(self, api_type: type[Any]) -> int: ...
    def get_reference_timestamp_meta(
        self, reference: Caps | None = None
    ) -> ReferenceTimestampMeta | None: ...
...
class BufferList(GObject.GBoxed):
    ...
    @staticmethod
    def replace(new_list: BufferList | None = None) -> tuple[bool, BufferList]: ...
    @staticmethod
    def take(new_list: BufferList | None = None) -> tuple[bool, BufferList]: ...
...
class BufferPool(Object):
    ...
    def __init__(self, *, name: str | None = ..., parent: Object = ...) -> None: ...
    def acquire_buffer(
        self, params: BufferPoolAcquireParams | None = None
...
class BufferPoolClass(GObject.GPointer):
    ...
    def object_class(self) -> ObjectClass: ...
    @property
    def get_options(self) -> Callable[[BufferPool], list[str]]: ...
    @property
    def set_config(self) -> Callable[[BufferPool, Structure], bool]: ...
    @property
    def start(self) -> Callable[[BufferPool], bool]: ...
    @property
    def stop(self) -> Callable[[BufferPool], bool]: ...
    @property
    def acquire_buffer(
        self,
    ) -> Callable[
        [BufferPool, BufferPoolAcquireParams | None], tuple[FlowReturn, Buffer]
    ]: ...
    @property
    def alloc_buffer(
        self,
    ...
    @property
    def reset_buffer(self) -> Callable[[BufferPool, Buffer], None]: ...
    @property
    def release_buffer(self) -> Callable[[BufferPool, Buffer], None]: ...
    @property
    def free_buffer(self) -> Callable[[BufferPool, Buffer], None]: ...
    @property
    def flush_start(self) -> Callable[[BufferPool], None]: ...
    @property
    def flush_stop(self) -> Callable[[BufferPool], None]: ...
...
class Bus(Object):
    ...
    def __init__(
        self, *, enable_async: bool = ..., name: str | None = ..., parent: Object = ...
    ) -> None: ...
    ...
    def set_sync_handler(
        self, func: Callable[..., BusSyncReply] | None = None, *user_data: Any
    ) -> None: ...
...
class BusClass(GObject.GPointer):
    ...
    @property
    def message(self) -> Callable[[Bus, Message], None]: ...
    @property
    def sync_message(self) -> Callable[[Bus, Message], None]: ...
...
class Caps(GObject.GBoxed):
    ...
    def append_structure_full(
        self, structure: Structure, features: CapsFeatures | None = None
    ) -> None: ...
    ...
    def set_value_static_str(self, field: str, value: Any) -> None: ...
...
class ChildProxyInterface(GObject.GPointer):
    ...
    def get_child_by_name(
        self,
    ) -> Callable[[ChildProxy, str], GObject.Object | None]: ...
    @property
    def get_child_by_index(
        self,
    ) -> Callable[[ChildProxy, int], GObject.Object | None]: ...
    @property
    def get_children_count(self) -> Callable[[ChildProxy], int]: ...
    @property
    def child_added(self) -> Callable[[ChildProxy, GObject.Object, str], None]: ...
    @property
    def child_removed(self) -> Callable[[ChildProxy, GObject.Object, str], None]: ...
...
class Clock(Object):
    ...
    @staticmethod
    def id_get_clock(id: None) -> Clock | None: ...
    @staticmethod
...
class ClockClass(GObject.GPointer):
    ...
    def parent_class(self) -> ObjectClass: ...
    @property
    def change_resolution(self) -> Callable[[Clock, int, int], int]: ...
    @property
    def get_resolution(self) -> Callable[[Clock], int]: ...
    @property
    def get_internal_time(self) -> Callable[[Clock], int]: ...
    @property
    def wait(self) -> Callable[[Clock, ClockEntry], tuple[ClockReturn, int]]: ...
    @property
    def wait_async(self) -> Callable[[Clock, ClockEntry], ClockReturn]: ...
    @property
    def unschedule(self) -> Callable[[Clock, ClockEntry], None]: ...
...
class ClockEntry(GObject.GPointer):
    ...
    @property
    def destroy_data(self) -> Callable[[None], None]: ...
    @property
...
class Context(GObject.GBoxed):
    ...
    @staticmethod
    def replace(new_context: Context | None = None) -> tuple[bool, Context]: ...
    def unref(self) -> None: ...
...
class ControlBinding(Object):
    ...
    def do_get_value(self, timestamp: int) -> Any | None: ...
    def do_sync_values(
    ...
    def get_value(self, timestamp: int) -> Any | None: ...
...
class ControlBindingClass(GObject.GPointer):
    ...
    def parent_class(self) -> ObjectClass: ...
    @property
    def sync_values(self) -> Callable[[ControlBinding, Object, int, int], bool]: ...
    @property
    def get_value(self) -> Callable[[ControlBinding, int], Any | None]: ...
    @property
    def get_value_array(self) -> None: ...
    @property
    def get_g_value_array(
        self,
    ) -> Callable[[ControlBinding, int, int, Sequence[Any]], bool]: ...
...
class ControlSource(Object):
    ...
    def parent(self) -> Object: ...
    @property
    def get_value(self) -> Callable[[ControlSource, int, float], bool]: ...
    @property
    def get_value_array(
        self,
    ) -> Callable[[ControlSource, int, int, int, float], bool]: ...
    def __init__(self, *, name: str | None = ..., parent: Object = ...) -> None: ...
...
class DateTime(GObject.GBoxed):
    ...
    def new_from_g_date_time(
        cls, dt: GLib.DateTime | None = None
    ) -> DateTime | None: ...
    @classmethod
...
class Device(Object):
    ...
    def do_create_element(self, name: str | None = None) -> Element | None: ...
...
class DeviceClass(GObject.GPointer):
    ...
    def parent_class(self) -> ObjectClass: ...
    @property
    def create_element(self) -> Callable[[Device, str | None], Element | None]: ...
    @property
    def reconfigure_element(self) -> Callable[[Device, Element], bool]: ...
...
class DeviceMonitor(Object):
    ...
    def __init__(
        self, *, show_all: bool = ..., name: str | None = ..., parent: Object = ...
    ) -> None: ...
    def add_filter(
        self, classes: str | None = None, caps: Caps | None = None
    ) -> int: ...
...
class DeviceProviderClass(GObject.GPointer):
    ...
    def parent_class(self) -> ObjectClass: ...
    @property
    def factory(self) -> DeviceProviderFactory: ...
    @property
    def probe(self) -> None: ...
    @property
    def start(self) -> Callable[[DeviceProvider], bool]: ...
    @property
    def stop(self) -> Callable[[DeviceProvider], None]: ...
    @property
...
class DeviceProviderFactory(PluginFeature):
    ...
    def get_device_provider_type(self) -> type[Any]: ...
    def get_metadata(self, key: str) -> str | None: ...
...
class DoubleRange(_gi.Fundamental): ...
...
class Element(Object):
    ...
    def object(self) -> Object: ...
    @property
    def state_lock(self) -> GLib.RecMutex: ...
    @property
    def state_cond(self) -> GLib.Cond: ...
    @property
    ...
    def add_property_deep_notify_watch(
        self, property_name: str | None, include_value: bool
    ) -> int: ...
    ...
    def add_static_pad_template_with_gtype(
        self, static_templ: StaticPadTemplate, pad_type: type[Any]
    ) -> None: ...
    ...
    def do_request_new_pad(
        self, templ: PadTemplate, name: str | None = None, caps: Caps | None = None
    ) -> Pad | None: ...
    def do_send_event(self, event: Event) -> bool: ...
    def do_set_bus(self, bus: Bus | None = None) -> None: ...
    def do_set_clock(self, clock: Clock | None = None) -> bool: ...
    ...
    def link_pads(
        self, srcpadname: str | None, dest: Element, destpadname: str | None = None
    ) -> bool: ...
    def link_pads_filtered(
        self,
        srcpadname: str | None,
        dest: Element,
        destpadname: str | None = None,
...
class ElementClass(GObject.GPointer):
    ...
    def metadata(self) -> None: ...
    @property
    def elementfactory(self) -> ElementFactory: ...
    @property
    ...
    @property
    def pad_added(self) -> Callable[[Element, Pad], None]: ...
    @property
    def pad_removed(self) -> Callable[[Element, Pad], None]: ...
    @property
    def no_more_pads(self) -> Callable[[Element], None]: ...
    @property
    def request_new_pad(
        self,
    ) -> Callable[[Element, PadTemplate, str | None, Caps | None], Pad | None]: ...
    @property
    def release_pad(self) -> Callable[[Element, Pad], None]: ...
    @property
    def get_state(
        self,
    ...
    @property
    def provide_clock(self) -> Callable[[Element], Clock | None]: ...
    @property
    def set_clock(self) -> Callable[[Element, Clock | None], bool]: ...
    @property
    def send_event(self) -> Callable[[Element, Event], bool]: ...
    @property
    def query(self) -> Callable[[Element, Query], bool]: ...
    @property
    def post_message(self) -> Callable[[Element, Message], bool]: ...
    @property
    def set_context(self) -> Callable[[Element, Context], None]: ...
    def add_metadata(self, key: str, value: str) -> None: ...
    def add_pad_template(self, templ: PadTemplate) -> None: ...
    def add_static_metadata(self, key: str, value: str) -> None: ...
    def add_static_pad_template(self, static_templ: StaticPadTemplate) -> None: ...
...
class ElementFactory(PluginFeature):
    ...
    def create_with_properties(
        self, names: Sequence[str] | None = None, values: Sequence[Any] | None = None
    ) -> Element | None: ...
    @staticmethod
    def find(name: str) -> ElementFactory | None: ...
    def get_element_type(self) -> type[Any]: ...
    def get_metadata(self, key: str) -> str | None: ...
    def get_metadata_keys(self) -> list[str] | None: ...
...
class GhostPadClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> ProxyPadClass: ...
...
class Int64Range(_gi.Fundamental): ...
class IntRange(_gi.Fundamental): ...
...
class Iterator(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    @classmethod
    def new_single(cls, type: type[Any], object: Any) -> Iterator: ...
...
class Message(GObject.GBoxed):
    ...
    def get_seqnum(self) -> int: ...
    def get_stream_status_object(self) -> Any | None: ...
    def get_structure(self) -> Structure | None: ...
    def has_name(self, name: str) -> bool: ...
    @classmethod
    ...
    def new_clock_provide(
        cls, src: Object | None, clock: Clock, ready: bool
    ) -> Message: ...
    @classmethod
    def new_custom(
        cls,
    ...
    def new_device_changed(
        cls, src: Object | None, device: Device, changed_device: Device
    ) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_error(
        cls, src: Object | None, error: GLib.Error, debug: str
    ) -> Message: ...
    @classmethod
    ...
    def new_instant_rate_request(
        cls, src: Object | None, rate_multiplier: float
    ) -> Message: ...
    @classmethod
    ...
    def new_property_notify(
        cls, src: Object, property_name: str, val: Any | None = None
    ) -> Message: ...
    @classmethod
    def new_qos(
        cls,
    ...
    def new_stream_collection(
        cls, src: Object | None, collection: StreamCollection
    ) -> Message: ...
    @classmethod
    ...
    @staticmethod
    def take(new_message: Message | None = None) -> tuple[bool, Message]: ...
...
class Meta(GObject.GPointer):
    ...
    @staticmethod
    def api_type_get_tags(api: type[Any]) -> list[str]: ...
    @staticmethod
    def api_type_has_tag(api: type[Any], tag: int) -> bool: ...
    @staticmethod
    def api_type_register(api: str, tags: Sequence[str]) -> type[Any]: ...
    @staticmethod
    ...
    def serialize_simple(self, data: Sequence[int]) -> bool: ...
...
class MiniObject(GObject.GBoxed):
    ...
    @staticmethod
    def replace(newdata: MiniObject | None = None) -> tuple[bool, MiniObject]: ...
    def set_qdata(
...
class Object(GObject.InitiallyUnowned):
    ...
    def props(self) -> Props: ...
    @property
    def object(self) -> GObject.InitiallyUnowned: ...
    @property
    def lock(self) -> GLib.Mutex: ...
    @property
    def name(self) -> str: ...
    ...
    def default_deep_notify(
        ...
        excluded_props: Sequence[str] | None = None,
    ) -> None: ...
    ...
    def get_value(self, property_name: str, timestamp: int) -> Any | None: ...
    ...
    @staticmethod
    def replace(newobj: Object | None = None) -> tuple[bool, Object]: ...
...
class ObjectClass(GObject.GPointer):
    ...
    @property
    def deep_notify(self) -> Callable[[Object, Object, GObject.ParamSpec], None]: ...
...
class Pad(Object):
    ...
    def object(self) -> Object: ...
    @property
    def element_private(self) -> None: ...
    @property
    def padtemplate(self) -> PadTemplate: ...
    @property
    def direction(self) -> PadDirection: ...
    @property
    def stream_rec_lock(self) -> GLib.RecMutex: ...
    @property
    def task(self) -> Task: ...
    @property
    def block_cond(self) -> GLib.Cond: ...
    @property
    def probes(self) -> GLib.HookList: ...
    @property
    def mode(self) -> PadMode: ...
    @property
    def activatefunc(self) -> Callable[[Pad, Object], bool]: ...
    @property
    def activatedata(self) -> None: ...
    @property
    def activatenotify(self) -> Callable[[None], None]: ...
    @property
    def activatemodefunc(self) -> Callable[[Pad, Object, PadMode, bool], bool]: ...
    @property
    def activatemodedata(self) -> None: ...
    @property
    def activatemodenotify(self) -> Callable[[None], None]: ...
    @property
    def peer(self) -> Pad: ...
    @property
    def linkfunc(self) -> Callable[[Pad, Object | None, Pad], PadLinkReturn]: ...
    @property
    def linkdata(self) -> None: ...
    @property
    def linknotify(self) -> Callable[[None], None]: ...
    @property
    def unlinkfunc(self) -> Callable[[Pad, Object | None], None]: ...
    @property
    def unlinkdata(self) -> None: ...
    @property
    def unlinknotify(self) -> Callable[[None], None]: ...
    @property
    def chainfunc(self) -> Callable[[Pad, Object | None, Buffer], FlowReturn]: ...
    @property
    def chaindata(self) -> None: ...
    @property
    def chainnotify(self) -> Callable[[None], None]: ...
    @property
    def chainlistfunc(
        self,
    ) -> Callable[[Pad, Object | None, BufferList], FlowReturn]: ...
    @property
    def chainlistdata(self) -> None: ...
    @property
    def chainlistnotify(self) -> Callable[[None], None]: ...
    @property
    def getrangefunc(
        self,
    ) -> Callable[[Pad, Object | None, int, int, Buffer], FlowReturn]: ...
    @property
    def getrangedata(self) -> None: ...
    @property
    def getrangenotify(self) -> Callable[[None], None]: ...
    @property
    def eventfunc(self) -> Callable[[Pad, Object | None, Event], bool]: ...
    @property
    def eventdata(self) -> None: ...
    @property
    def eventnotify(self) -> Callable[[None], None]: ...
    @property
    def offset(self) -> int: ...
    @property
    def queryfunc(self) -> Callable[[Pad, Object | None, Query], bool]: ...
    @property
    def querydata(self) -> None: ...
    @property
    def querynotify(self) -> Callable[[None], None]: ...
    @property
    def iterintlinkfunc(self) -> Callable[[Pad, Object | None], Iterator]: ...
    @property
    def iterintlinkdata(self) -> None: ...
    @property
    def iterintlinknotify(self) -> Callable[[None], None]: ...
    @property
    ...
    def create_stream_id(
        self, parent: Element, stream_id: str | None = None
    ) -> str: ...
...
class PadClass(GObject.GPointer):
    ...
    def parent_class(self) -> ObjectClass: ...
    @property
    def linked(self) -> Callable[[Pad, Pad], None]: ...
    @property
    def unlinked(self) -> Callable[[Pad, Pad], None]: ...
...
class PadTemplate(Object):
    ...
    def new_from_static_pad_template_with_gtype(
        cls, pad_template: StaticPadTemplate, pad_type: type[Any]
    ) -> PadTemplate | None: ...
    @classmethod
    def new_with_gtype(
        cls,
...
class PipelineClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> BinClass: ...
...
class PresetInterface(GObject.GPointer):
    ...
    def parent(self) -> GObject.TypeInterface: ...
    @property
    def get_preset_names(self) -> Callable[[Preset], list[str]]: ...
    @property
    def get_property_names(self) -> Callable[[Preset], list[str]]: ...
    @property
    def load_preset(self) -> Callable[[Preset, str], bool]: ...
    @property
    def save_preset(self) -> Callable[[Preset, str], bool]: ...
    @property
    def rename_preset(self) -> Callable[[Preset, str, str], bool]: ...
    @property
    def delete_preset(self) -> Callable[[Preset, str], bool]: ...
    @property
    def set_meta(self) -> Callable[[Preset, str, str, str | None], bool]: ...
    @property
    def get_meta(self) -> Callable[[Preset, str, str], tuple[bool, str]]: ...
...
class ProxyPad(Pad):
    ...
    @staticmethod
    def chain_default(
        pad: Pad, parent: Object | None, buffer: Buffer
    ) -> FlowReturn: ...
    @staticmethod
    def chain_list_default(
        pad: Pad, parent: Object | None, list: BufferList
    ) -> FlowReturn: ...
    ...
    @staticmethod
    def iterate_internal_links_default(
        pad: Pad, parent: Object | None = None
    ) -> Iterator | None: ...
...
class ProxyPadClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> PadClass: ...
...
class Query(GObject.GBoxed):
    ...
    def parse_nth_allocation_meta(self, index: int) -> tuple[type[Any], Structure]: ...
    ...
    @staticmethod
    def take(new_query: Query | None = None) -> tuple[bool, Query]: ...
    def writable_structure(self) -> Structure: ...
...
class Registry(Object):
    ...
    def find_feature(self, name: str, type: type[Any]) -> PluginFeature | None: ...
    ...
    @staticmethod
    def get() -> Registry: ...
    def get_feature_list(self, type: type[Any]) -> list[PluginFeature]: ...
...
class SharedTaskPoolClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> TaskPoolClass: ...
...
class StreamCollectionClass(GObject.GPointer):
    ...
    def stream_notify(
        self,
    ) -> Callable[[StreamCollection, Stream, GObject.ParamSpec], None]: ...
...
class Structure(GObject.GBoxed):
    ...
    def foreach(self, func: Callable[..., bool], *user_data: Any) -> bool: ...
    def foreach_id_str(self, func: Callable[..., bool], *user_data: Any) -> bool: ...
    def free(self) -> None: ...
    @classmethod
    ...
    def get_enum(self, fieldname: str, enumtype: type[Any]) -> tuple[bool, int]: ...
    def get_field_type(self, fieldname: str) -> type[Any]: ...
    def get_flags(self, fieldname: str, flags_type: type[Any]) -> tuple[bool, int]: ...
    ...
    def get_value(self, fieldname: str) -> Any | None: ...
    def has_field(self, fieldname: str) -> bool: ...
    def has_field_typed(self, fieldname: str, type: type[Any]) -> bool: ...
    def has_name(self, name: str) -> bool: ...
    def id_get_value(self, field: int) -> Any | None: ...
    def id_has_field(self, field: int) -> bool: ...
    def id_has_field_typed(self, field: int, type: type[Any]) -> bool: ...
    def id_set_value(self, field: int, value: Any) -> None: ...
    def id_str_get_field_type(self, fieldname: IdStr) -> type[Any]: ...
    def id_str_get_value(self, fieldname: IdStr) -> Any | None: ...
    def id_str_has_field(self, fieldname: IdStr) -> bool: ...
    def id_str_has_field_typed(self, fieldname: IdStr, type: type[Any]) -> bool: ...
    def id_str_nth_field_name(self, index: int) -> IdStr: ...
    def id_str_remove_field(self, fieldname: IdStr) -> None: ...
    def id_str_set_value(self, fieldname: IdStr, value: Any) -> None: ...
    def id_str_take_value(self, fieldname: IdStr, value: Any) -> None: ...
    ...
    def set_value_static_str(self, fieldname: str, value: Any) -> None: ...
    @staticmethod
    def take(newstr: Structure | None = None) -> tuple[bool, Structure]: ...
    def take_value(self, fieldname: str, value: Any) -> None: ...
    def take_value_static_str(self, fieldname: str, value: Any) -> None: ...
    def to_string(self) -> str: ...
...
class SystemClockClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> ClockClass: ...
...
class TagList(GObject.GBoxed):
    ...
    @staticmethod
    def replace(new_taglist: TagList | None = None) -> tuple[bool, TagList]: ...
    def set_scope(self, scope: TagScope) -> None: ...
    @staticmethod
    def take(new_taglist: TagList | None = None) -> tuple[bool, TagList]: ...
    def to_string(self) -> str: ...
...
class TaskPoolClass(GObject.GPointer):
    ...
    def parent_class(self) -> ObjectClass: ...
    @property
    def prepare(self) -> Callable[[TaskPool], None]: ...
    @property
    def cleanup(self) -> Callable[[TaskPool], None]: ...
    @property
    def push(self) -> Callable[..., None]: ...
    @property
    def join(self) -> Callable[[TaskPool, None], None]: ...
    @property
    def dispose_handle(self) -> Callable[[TaskPool, None], None]: ...
...
class TracerFactory(PluginFeature):
    ...
    def get_tracer_type(self) -> type[Any]: ...
...
class URIHandlerInterface(GObject.GPointer):
    ...
    def parent(self) -> GObject.TypeInterface: ...
    @property
    def get_type(self) -> Callable[[type[Any]], URIType]: ...
    @property
    def get_protocols(self) -> Callable[[type[Any]], list[str]]: ...
    @property
    def get_uri(self) -> Callable[[URIHandler], str | None]: ...
    @property
    def set_uri(self) -> Callable[[URIHandler, str], bool]: ...
...
class Uri(GObject.GBoxed):
    ...
    def get_query_string_ordered(self, keys: list[str] | None = None) -> str | None: ...
    ...
    def set_path_segments(self, path_segments: list[str] | None = None) -> bool: ...
    def set_path_string(self, path: str) -> bool: ...
    def set_port(self, port: int) -> bool: ...
    def set_query_string(self, query: str | None = None) -> bool: ...
    def set_query_table(self, query_table: dict[str, str] | None = None) -> bool: ...
    def set_query_value(
        self, query_key: str, query_value: str | None = None
    ) -> bool: ...
    def set_scheme(self, scheme: str) -> bool: ...
    def set_userinfo(self, userinfo: str) -> bool: ...
    def to_string(self) -> str: ...
    def to_string_with_keys(self, keys: list[str] | None = None) -> str: ...
    def unref(self) -> None: ...

class ValueArray(_gi.Fundamental):
    """
    :Constructors:
...
class ValueList(_gi.Fundamental):
    """
    :Constructors:
