...
def codec_utils_aac_get_level(audio_config: Sequence[int]) -> str | None: ...
def codec_utils_aac_get_profile(audio_config: Sequence[int]) -> str | None: ...
...
def codec_utils_av1_create_av1c_from_caps(caps: Gst.Caps) -> Gst.Buffer | None: ...
def codec_utils_av1_create_caps_from_av1c(av1c: Gst.Buffer) -> Gst.Caps | None: ...
def codec_utils_av1_get_level(seq_level_idx: int) -> str | None: ...
def codec_utils_av1_get_seq_level_idx(level: str) -> int: ...
def codec_utils_caps_from_mime_codec(codecs_field: str) -> Gst.Caps | None: ...
def codec_utils_caps_get_mime_codec(caps: Gst.Caps) -> str | None: ...
def codec_utils_h264_caps_set_level_and_profile(
    caps: Gst.Caps, sps: Sequence[int]
) -> bool: ...
def codec_utils_h264_get_level(sps: Sequence[int]) -> str | None: ...
def codec_utils_h264_get_level_idc(level: str) -> int: ...
def codec_utils_h264_get_profile(sps: Sequence[int]) -> str | None: ...
...
def codec_utils_h265_get_level(profile_tier_level: Sequence[int]) -> str | None: ...
def codec_utils_h265_get_level_idc(level: str) -> int: ...
def codec_utils_h265_get_profile(profile_tier_level: Sequence[int]) -> str | None: ...
def codec_utils_h265_get_tier(profile_tier_level: Sequence[int]) -> str | None: ...
def codec_utils_h266_caps_set_level_tier_and_profile(
    caps: Gst.Caps, decoder_configuration: Sequence[int]
) -> bool: ...
def codec_utils_h266_get_level(ptl_record: Sequence[int]) -> str | None: ...
def codec_utils_h266_get_level_idc(level: str) -> int: ...
def codec_utils_h266_get_profile(ptl_record: Sequence[int]) -> str | None: ...
def codec_utils_h266_get_tier(ptl_record: Sequence[int]) -> str | None: ...
def codec_utils_mpeg4video_caps_set_level_and_profile(
    caps: Gst.Caps, vis_obj_seq: Sequence[int]
) -> bool: ...
def codec_utils_mpeg4video_get_level(vis_obj_seq: Sequence[int]) -> str | None: ...
def codec_utils_mpeg4video_get_profile(vis_obj_seq: Sequence[int]) -> str | None: ...
...
def codec_utils_opus_create_caps_from_header(
    header: Gst.Buffer, comments: Gst.Buffer | None = None
) -> Gst.Caps | None: ...
def codec_utils_opus_create_header(
    ...
    stream_count: int,
    coupled_count: int,
    channel_mapping: Sequence[int] | None,
    pre_skip: int,
    output_gain: int,
) -> Gst.Buffer | None: ...
...
def missing_plugin_message_get_installer_detail(msg: Gst.Message) -> str | None: ...
def missing_plugin_message_get_stream_id(msg: Gst.Message) -> str | None: ...
...
def pb_utils_add_codec_description_to_tag_list(
    taglist: Gst.TagList, codec_tag: str | None, caps: Gst.Caps
) -> bool: ...
def pb_utils_get_caps_description_flags(
    caps: Gst.Caps,
) -> PbUtilsCapsDescriptionFlags: ...
def pb_utils_get_codec_description(caps: Gst.Caps) -> str | None: ...
...
def pb_utils_get_file_extension_from_caps(caps: Gst.Caps) -> str | None: ...
...
class AudioVisualizer(Gst.Element):
    ...
    @property
    def vinfo(self) -> GstVideo.VideoInfo: ...
    @property
    def ainfo(self) -> GstAudio.AudioInfo: ...
    @property
...
class AudioVisualizerClass(GObject.GPointer):
    ...
    @property
    def setup(self) -> Callable[[AudioVisualizer], bool]: ...
    @property
    def render(
        self,
    ) -> Callable[[AudioVisualizer, Gst.Buffer, GstVideo.VideoFrame], bool]: ...
    @property
    def decide_allocation(self) -> Callable[[AudioVisualizer, Gst.Query], bool]: ...
...
class DiscovererClass(GObject.GPointer):
    ...
    """
    @property
    def parentclass(self) -> GObject.ObjectClass: ...
    @property
    def finished(self) -> Callable[[Discoverer], None]: ...
    @property
    def starting(self) -> Callable[[Discoverer], None]: ...
    @property
    def discovered(
        self,
    ) -> Callable[[Discoverer, DiscovererInfo, GLib.Error], None]: ...
    @property
    def source_setup(self) -> Callable[[Discoverer, Gst.Element], None]: ...
    @property
    def load_serialize_info(self) -> Callable[[Discoverer, str], DiscovererInfo]: ...
...
class DiscovererInfo(GObject.Object):
    ...
    def get_streams(self, streamtype: type[Any]) -> list[DiscovererStreamInfo]: ...
