...
def rtp_payload_info_for_pt(payload_type: int) -> RTPPayloadInfo | None: ...
...
class RTPBaseAudioPayload(RTPBasePayload):
    ...
    Properties from GstRTPBasePayload:
      ...
      extensions -> GstValueArray: RTP header extensions
    ...
    @property
    def payload(self) -> RTPBasePayload: ...
    @property
...
class RTPBaseDepayloadClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> Gst.ElementClass: ...
    @property
    def set_caps(self) -> Callable[[RTPBaseDepayload, Gst.Caps], bool]: ...
    @property
    def process(self) -> Callable[[RTPBaseDepayload, Gst.Buffer], Gst.Buffer]: ...
    @property
    def packet_lost(self) -> Callable[[RTPBaseDepayload, Gst.Event], bool]: ...
    @property
    def handle_event(self) -> Callable[[RTPBaseDepayload, Gst.Event], bool]: ...
    @property
...
class RTPBasePayload(Gst.Element):
    ...
    def do_query(self, pad: Gst.Pad, query: Gst.Query) -> bool: ...
    def do_set_caps(self, caps: Gst.Caps) -> bool: ...
...
class RTPBasePayloadClass(GObject.GPointer):
    ...
    def parent_class(self) -> Gst.ElementClass: ...
    @property
    def get_caps(self) -> Callable[[RTPBasePayload, Gst.Pad, Gst.Caps], Gst.Caps]: ...
    @property
    def set_caps(self) -> Callable[[RTPBasePayload, Gst.Caps], bool]: ...
    @property
    def handle_buffer(
        self,
    ) -> Callable[[RTPBasePayload, Gst.Buffer], Gst.FlowReturn]: ...
    @property
    def sink_event(self) -> Callable[[RTPBasePayload, Gst.Event], bool]: ...
    @property
    def src_event(self) -> Callable[[RTPBasePayload, Gst.Event], bool]: ...
    @property
...
class RTPHeaderExtensionClass(GObject.GPointer):
    ...
    def get_supported_flags(
        self,
    ) -> Callable[[RTPHeaderExtension], RTPHeaderExtensionFlags]: ...
    @property
    def get_max_size(self) -> Callable[[RTPHeaderExtension, Gst.Buffer], int]: ...
    @property
    def write(
        self,
    ) -> Callable[
    ...
    @property
    def set_non_rtp_sink_caps(
        self,
    ) -> Callable[[RTPHeaderExtension, Gst.Caps], bool]: ...
    @property
    def update_non_rtp_src_caps(
        self,
    ) -> Callable[[RTPHeaderExtension, Gst.Caps], bool]: ...
    @property
    def set_attributes(
