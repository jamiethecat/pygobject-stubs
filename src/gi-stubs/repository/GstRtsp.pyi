...
def rtsp_header_as_text(field: RTSPHeaderField) -> str | None: ...
...
class RTSPExtensionInterface(GObject.GPointer):
    ...
    def get_transports(
        self,
    ) -> Callable[[RTSPExtension, RTSPLowerTrans, str], RTSPResult]: ...
    @property
...
class RTSPWatchFuncs(GObject.GPointer):
    ...
    """
    @property
    def message_received(self) -> Callable[..., RTSPResult]: ...
    @property
    def message_sent(self) -> Callable[..., RTSPResult]: ...
    @property
    def closed(self) -> Callable[..., RTSPResult]: ...
    @property
    def error(self) -> Callable[..., RTSPResult]: ...
    @property
    def tunnel_start(self) -> Callable[..., RTSPStatusCode]: ...
    @property
    def tunnel_complete(self) -> Callable[..., RTSPResult]: ...
    @property
    def error_full(self) -> Callable[..., RTSPResult]: ...
    @property
    def tunnel_lost(self) -> Callable[..., RTSPResult]: ...
    @property
    def tunnel_http_response(self) -> Callable[..., RTSPResult]: ...
...
class RTSPMethod(GObject.GFlags):
    ...
    TEARDOWN = 1024
    @staticmethod
    def as_text(method: RTSPMethod) -> str | None: ...
