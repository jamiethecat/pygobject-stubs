...
def chassis_kind_from_string(kind_str: str) -> ChassisKind: ...
def chassis_kind_to_string(kind: ChassisKind) -> str: ...
...
def content_rating_system_to_string(
    system: ContentRatingSystem,
) -> typing.Optional[str]: ...
...
def get_license_name(license: str) -> typing.Optional[str]: ...
def get_license_url(license: str) -> typing.Optional[str]: ...
def gstring_replace(
...
def markup_convert(markup: str, to_kind: MarkupKind) -> str: ...
...
def reference_kind_from_string(str: str) -> ReferenceKind: ...
def reference_kind_to_string(kind: ReferenceKind) -> str: ...
...
def release_list_kind_from_string(kind_str: str) -> ReleaseListKind: ...
def release_list_kind_to_string(kind: ReleaseListKind) -> str: ...
...
def spdx_license_detokenize(license_tokens: str) -> typing.Optional[str]: ...
def spdx_license_tokenize(license: str) -> typing.Optional[list[str]]: ...
...
def utils_get_desktop_environment_name(de_id: str) -> str: ...
def utils_get_gui_environment_style_name(env_style: str) -> str: ...
def utils_get_tag_search_weight(tag_name: str) -> int: ...
...
def utils_is_desktop_environment(de_id: str) -> bool: ...
def utils_is_gui_environment_style(env_style: str) -> bool: ...
def utils_is_platform_triplet(triplet: str) -> bool: ...
def utils_is_tld(tld: str) -> bool: ...
def utils_locale_is_compatible(
    locale1: typing.Optional[str] = None, locale2: typing.Optional[str] = None
) -> bool: ...
def utils_posix_locale_to_bcp47(locale: str) -> str: ...
def utils_sort_components_into_categories(
    cpts: typing.Sequence[Component],
    categories: typing.Sequence[Category],
...
class Agreement(GObject.Object):
    ...
    def get_section_default(self) -> typing.Optional[AgreementSection]: ...
...
class AgreementSection(GObject.Object):
    ...
    parent_instance: GObject.Object = ...
    def get_context(self) -> typing.Optional[Context]: ...
    ...
    def set_description(
        self, desc: str, locale: typing.Optional[str] = None
    ) -> None: ...
    def set_kind(self, kind: str) -> None: ...
    def set_name(self, name: str, locale: typing.Optional[str] = None) -> None: ...
...
class Artifact(GObject.Object):
    ...
    def get_checksum(self, kind: ChecksumKind) -> typing.Optional[Checksum]: ...
...
class BrandingColorIter(GObject.GPointer):
    ...
    def next(self) -> typing.Tuple[bool, ColorKind, ColorSchemeKind, str]: ...
...
class Category(GObject.Object):
    ...
    props: Props = ...
    parent_instance: GObject.Object = ...
    def __init__(self, icon: str = ..., id: str = ..., name: str = ...) -> None: ...
...
class Checksum(GObject.Object):
    ...
    ::
        ...
        new_with_value(kind:AppStream.ChecksumKind, value:str) -> AppStream.Checksum
    ...
    @classmethod
    def new_with_value(cls, kind: ChecksumKind, value: str) -> Checksum: ...
...
class Component(GObject.Object):
    ...
    def add_keyword(
        self, keyword: str, locale: typing.Optional[str] = None
    ) -> None: ...
    def add_language(self, locale: typing.Optional[str], percentage: int) -> None: ...
    ...
    def check_relations(
        self,
        sysinfo: typing.Optional[SystemInfo],
        pool: typing.Optional[Pool],
        rel_kind: RelationKind,
    ) -> list[RelationCheckResult]: ...
    def clear_keywords(self, locale: typing.Optional[str] = None) -> None: ...
    def clear_languages(self) -> None: ...
    def clear_tags(self) -> None: ...
    def get_addons(self) -> list[Component]: ...
    def get_agreement_by_kind(
        self, kind: AgreementKind
    ) -> typing.Optional[Agreement]: ...
    def get_agreements(self) -> list[Agreement]: ...
    def get_branch(self) -> str: ...
    def get_branding(self) -> typing.Optional[Branding]: ...
    def get_bundle(self, bundle_kind: BundleKind) -> typing.Optional[Bundle]: ...
    def get_bundles(self) -> list[Bundle]: ...
    def get_categories(self) -> list[str]: ...
    def get_compulsory_for_desktops(self) -> list[str]: ...
    def get_content_rating(self, kind: str) -> typing.Optional[ContentRating]: ...
    ...
    def get_extends(self) -> typing.Optional[list[str]]: ...
    def get_icon_by_size(self, width: int, height: int) -> typing.Optional[Icon]: ...
    def get_icon_stock(self) -> typing.Optional[Icon]: ...
    ...
    def get_launchable(self, kind: LaunchableKind) -> typing.Optional[Launchable]: ...
    ...
    def get_provided_for_kind(
        self, kind: ProvidedKind
    ) -> typing.Optional[Provided]: ...
    def get_recommends(self) -> list[Relation]: ...
    def get_references(self) -> list[Reference]: ...
    def get_releases_plain(self) -> ReleaseList: ...
    def get_replaces(self) -> list[str]: ...
    def get_requires(self) -> list[Relation]: ...
    def get_reviews(self) -> list[Review]: ...
    def get_scope(self) -> ComponentScope: ...
    def get_screenshots_all(self) -> list[Screenshot]: ...
    ...
    def get_system_compatibility_score(
        self, sysinfo: SystemInfo, is_template: bool
    ) -> typing.Tuple[int, list[RelationCheckResult]]: ...
    def get_timestamp_eol(self) -> int: ...
    def get_translations(self) -> list[Translation]: ...
    def get_url(self, url_kind: UrlKind) -> typing.Optional[str]: ...
    ...
    def load_releases(self, allow_net: bool) -> typing.Optional[ReleaseList]: ...
    @classmethod
    ...
    def set_name(self, value: str, locale: typing.Optional[str] = None) -> None: ...
    def set_name_variant_suffix(
        self, value: str, locale: typing.Optional[str] = None
    ) -> None: ...
    def set_origin(self, origin: str) -> None: ...
    def set_pkgname(self, pkgname: str) -> None: ...
    def set_pkgnames(self, packages: typing.Sequence[str]) -> None: ...
    def set_priority(self, priority: int) -> None: ...
    def set_project_group(self, value: str) -> None: ...
    def set_project_license(self, value: str) -> None: ...
    def set_releases(self, releases: ReleaseList) -> None: ...
    ...
    def set_summary(self, value: str, locale: typing.Optional[str] = None) -> None: ...
...
class ComponentBox(GObject.Object):
    """
    :Constructors:

    ::

        ComponentBox(**properties)
        new(flags:AppStream.ComponentBoxFlags) -> AppStream.ComponentBox
        new_simple() -> AppStream.ComponentBox

    Object AsComponentBox

    Properties from AsComponentBox:
      flags -> guint: Flags
        Component box flags
    ...
    def add(self, cpt: Component) -> bool: ...
    def as_array(self) -> list[Component]: ...
    def clear(self) -> None: ...
    def get_flags(self) -> ComponentBoxFlags: ...
    def get_size(self) -> int: ...
    def index_safe(self, index: int) -> Component: ...
    def is_empty(self) -> bool: ...
    @classmethod
    def new(cls, flags: ComponentBoxFlags) -> ComponentBox: ...
    @classmethod
    def new_simple(cls) -> ComponentBox: ...
    def remove_at(self, index: int) -> None: ...
    def sort(self) -> None: ...
    def sort_by_score(self) -> None: ...

class ComponentBoxClass(GObject.GPointer):
    """
    :Constructors:
...
class Context(GObject.Object):
    ...
    def get_locale_use_all(self) -> bool: ...
    ...
    def set_locale(self, locale: typing.Optional[str] = None) -> None: ...
...
class Developer(GObject.Object):
    """
    :Constructors:
    ...
    def get_name(self) -> str: ...
    @classmethod
    def new(cls) -> Developer: ...
    def set_id(self, id: str) -> None: ...
    def set_name(self, value: str, locale: typing.Optional[str] = None) -> None: ...

class DeveloperClass(GObject.GPointer):
    """
    :Constructors:
...
class Metadata(GObject.Object):
    ...
    def get_components(self) -> ComponentBox: ...
    ...
    def get_release_list(self) -> typing.Optional[ReleaseList]: ...
    def get_release_lists(self) -> list[ReleaseList]: ...
    ...
    def parse_data(self, data: str, data_len: int, format: FormatKind) -> bool: ...
    def parse_desktop_data(self, cid: str, data: str, data_len: int) -> bool: ...
    def parse_file(self, file: Gio.File, format: FormatKind) -> bool: ...
    def parse_releases_bytes(self, bytes: GLib.Bytes) -> bool: ...
    def parse_releases_file(self, file: Gio.File) -> bool: ...
    def releases_to_data(self, releases: ReleaseList) -> str: ...
...
class Pool(GObject.Object):
    ...
    parent_instance: GObject.Object = ...
    def add_components(self, cbox: ComponentBox) -> bool: ...
    ...
    def get_components_by_categories(
        self, categories: typing.Sequence[str]
    ) -> ComponentBox: ...
    def get_components_by_extends(self, extended_id: str) -> ComponentBox: ...
    def get_components_by_id(self, cid: str) -> ComponentBox: ...
    def get_components_by_kind(self, kind: ComponentKind) -> ComponentBox: ...
    ...
    def search(self, search: str) -> ComponentBox: ...
...
class PoolClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    changed: typing.Callable[[Pool], None] = ...
...
class Reference(GObject.Object):
    ...
    parent_instance: GObject.Object = ...
    def get_kind(self) -> ReferenceKind: ...
    def get_registry_name(self) -> typing.Optional[str]: ...
    def get_value(self) -> str: ...
    @classmethod
    def new(cls) -> Reference: ...
    def set_kind(self, kind: ReferenceKind) -> None: ...
    def set_registry_name(self, name: str) -> None: ...
    def set_value(self, value: str) -> None: ...

class ReferenceClass(GObject.GPointer):
    """
    :Constructors:
...
class Relation(GObject.Object):
    ...
    parent_instance: GObject.Object = ...
    @staticmethod
    def check_results_get_compatibility_score(
        rc_results: typing.Sequence[RelationCheckResult],
    ) -> int: ...
    ...
    def is_satisfied(
        self,
        system_info: typing.Optional[SystemInfo] = None,
        pool: typing.Optional[Pool] = None,
    ) -> typing.Optional[RelationCheckResult]: ...
    @classmethod
...
class RelationCheckResult(GObject.Object):
    """
    :Constructors:

    ::

        RelationCheckResult(**properties)
        new() -> AppStream.RelationCheckResult

    Object AsRelationCheckResult
    ...
    parent_instance: GObject.Object = ...
    def get_error_code(self) -> RelationError: ...
    def get_message(self) -> typing.Optional[str]: ...
    def get_relation(self) -> typing.Optional[Relation]: ...
    def get_status(self) -> RelationStatus: ...
    @classmethod
    def new(cls) -> RelationCheckResult: ...
    def set_error_code(self, ecode: RelationError) -> None: ...
    def set_relation(self, relation: Relation) -> None: ...
    def set_status(self, status: RelationStatus) -> None: ...

class RelationCheckResultClass(GObject.GPointer):
    """
    :Constructors:

    ::

        RelationCheckResultClass()
    """
...
class Release(GObject.Object):
    ...
    def get_context(self) -> typing.Optional[Context]: ...
    def get_date(self) -> typing.Optional[str]: ...
    def get_date_eol(self) -> typing.Optional[str]: ...
    ...
    def get_url(self, url_kind: ReleaseUrlKind) -> typing.Optional[str]: ...
    ...
    def set_date_eol(self, date: str) -> None: ...
    def set_description(
        self, description: str, locale: typing.Optional[str] = None
    ) -> None: ...
...
class ReleaseList(GObject.Object):
    """
    :Constructors:

    ::

        ReleaseList(**properties)
        new() -> AppStream.ReleaseList

    Object AsReleaseList
    ...
    def clear(self) -> None: ...
    def get_context(self) -> typing.Optional[Context]: ...
    def get_entries(self) -> list[Release]: ...
    def get_kind(self) -> ReleaseListKind: ...
    def get_size(self) -> int: ...
    def get_url(self) -> typing.Optional[str]: ...
    def index_safe(self, index: int) -> Release: ...
    def is_empty(self) -> bool: ...
    def load_from_bytes(
        self, context: typing.Optional[Context], bytes: GLib.Bytes
    ) -> bool: ...
    @classmethod
    def new(cls) -> ReleaseList: ...
    def set_context(self, context: Context) -> None: ...
    def set_kind(self, kind: ReleaseListKind) -> None: ...
    def set_size(self, size: int) -> None: ...
    def set_url(self, url: str) -> None: ...
    def sort(self) -> None: ...

class ReleaseListClass(GObject.GPointer):
    """
    :Constructors:
...
class Screenshot(GObject.Object):
    ...
    def get_context(self) -> typing.Optional[Context]: ...
    def get_environment(self) -> typing.Optional[str]: ...
    def get_image(
    ...
    def set_context(self, context: Context) -> None: ...
    def set_environment(self, env_id: typing.Optional[str] = None) -> None: ...
...
class SystemInfo(GObject.Object):
    ...
    ::
        ...
        new_template_for_chassis(chassis:AppStream.ChassisKind) -> AppStream.SystemInfo
    ...
    def get_gui_available(self) -> bool: ...
    ...
    @classmethod
    def new_template_for_chassis(cls, chassis: ChassisKind) -> SystemInfo: ...
...
class Translation(GObject.Object):
    ...
    def set_source_locale(self, locale: typing.Optional[str] = None) -> None: ...
...
class Validator(GObject.Object):
    ...
    def get_allow_net(self) -> bool: ...
    def get_issue_files_count(self) -> int: ...
    def get_issues(self) -> list[ValidatorIssue]: ...
    def get_issues_per_file(self) -> dict[str, typing.Sequence[ValidatorIssue]]: ...
    def get_report_yaml(self) -> str: ...
    ...
    def set_allow_net(self, value: bool) -> None: ...
...
class ComponentBoxFlags(GObject.GFlags):
    NONE = 0
    NO_CHECKS = 1
...
class ChassisKind(GObject.GEnum):
    DESKTOP = 1
    HANDSET = 5
    LAPTOP = 2
    SERVER = 3
    ...
    UNKNOWN = 0
    @staticmethod
    def from_string(kind_str: str) -> ChassisKind: ...
    @staticmethod
    def to_string(kind: ChassisKind) -> str: ...
...
class ContentRatingSystem(GObject.GEnum):
    ...
    USK = 7
    @staticmethod
    def format_age(system: ContentRatingSystem, age: int) -> typing.Optional[str]: ...
    @staticmethod
    ...
    @staticmethod
    def to_string(system: ContentRatingSystem) -> typing.Optional[str]: ...
...
class ReferenceKind(GObject.GEnum):
    CITATION_CFF = 2
    DOI = 1
    REGISTRY = 3
    UNKNOWN = 0
    @staticmethod
    def from_string(str: str) -> ReferenceKind: ...
    @staticmethod
    def to_string(kind: ReferenceKind) -> str: ...
...
class RelationStatus(GObject.GEnum):
    ERROR = 1
    NOT_SATISFIED = 2
    SATISFIED = 3
    UNKNOWN = 0
...
class ReleaseListKind(GObject.GEnum):
    EMBEDDED = 1
    EXTERNAL = 2
    UNKNOWN = 0
    @staticmethod
    def from_string(kind_str: str) -> ReleaseListKind: ...
    @staticmethod
    def to_string(kind: ReleaseListKind) -> str: ...
