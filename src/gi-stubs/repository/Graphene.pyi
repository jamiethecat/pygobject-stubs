...
class Box(GObject.GBoxed):
    ...
    def infinite() -> Box: ...
    def init(
        self, min: typing.Optional[Point3D] = None, max: typing.Optional[Point3D] = None
    ) -> Box: ...
    def init_from_box(self, src: Box) -> Box: ...
    def init_from_points(self, points: typing.Sequence[Point3D]) -> Box: ...
    def init_from_vec3(
        self, min: typing.Optional[Vec3] = None, max: typing.Optional[Vec3] = None
    ) -> Box: ...
    def init_from_vectors(self, vectors: typing.Sequence[Vec3]) -> Box: ...
    def intersection(self, b: Box) -> typing.Tuple[bool, Box]: ...
    @staticmethod
    def minus_one() -> Box: ...
    @staticmethod
    def one() -> Box: ...
...
class Euler(GObject.GBoxed):
    ...
    def init_from_euler(self, src: typing.Optional[Euler] = None) -> Euler: ...
    def init_from_matrix(
        self, m: typing.Optional[Matrix], order: EulerOrder
    ) -> Euler: ...
    def init_from_quaternion(
        self, q: typing.Optional[Quaternion], order: EulerOrder
    ) -> Euler: ...
    def init_from_radians(
        self, x: float, y: float, z: float, order: EulerOrder
    ) -> Euler: ...
    def init_from_vec3(self, v: typing.Optional[Vec3], order: EulerOrder) -> Euler: ...
    def init_with_order(
        self, x: float, y: float, z: float, order: EulerOrder
    ) -> Euler: ...
...
class Matrix(GObject.GBoxed):
    ...
    def decompose(self) -> typing.Tuple[bool, Vec3, Vec3, Quaternion, Vec3, Vec4]: ...
    ...
    def init_from_float(self, v: typing.Sequence[float]) -> Matrix: ...
    ...
    def inverse(self) -> typing.Tuple[bool, Matrix]: ...
    def is_2d(self) -> bool: ...
    ...
    def to_2d(self) -> typing.Tuple[bool, float, float, float, float, float, float]: ...
    ...
    def untransform_point(
        self, p: Point, bounds: Rect
    ) -> typing.Tuple[bool, Point]: ...
...
class Plane(GObject.GBoxed):
    ...
    def init(self, normal: typing.Optional[Vec3], constant: float) -> Plane: ...
    ...
    def transform(
        self, matrix: Matrix, normal_matrix: typing.Optional[Matrix] = None
    ) -> Plane: ...
...
class Point(GObject.GBoxed):
    ...
    @classmethod
    def alloc(cls) -> Point: ...
    def distance(self, b: Point) -> typing.Tuple[float, float, float]: ...
...
class Point3D(GObject.GBoxed):
    ...
    def distance(self, b: Point3D) -> typing.Tuple[float, Vec3]: ...
...
class Quad(GObject.GBoxed):
    ...
    def init_from_points(self, points: typing.Sequence[Point]) -> Quad: ...
...
class Quaternion(GObject.GBoxed):
    ...
    def to_angle_vec3(self) -> typing.Tuple[float, Vec3]: ...
    def to_angles(self) -> typing.Tuple[float, float, float]: ...
    def to_matrix(self) -> Matrix: ...
    def to_radians(self) -> typing.Tuple[float, float, float]: ...
...
class Ray(GObject.GBoxed):
    ...
    def init(
        self,
        origin: typing.Optional[Point3D] = None,
        direction: typing.Optional[Vec3] = None,
    ) -> Ray: ...
    def init_from_ray(self, src: Ray) -> Ray: ...
    def init_from_vec3(
        self,
        origin: typing.Optional[Vec3] = None,
        direction: typing.Optional[Vec3] = None,
    ) -> Ray: ...
    def intersect_box(self, b: Box) -> typing.Tuple[RayIntersectionKind, float]: ...
    def intersect_sphere(
        self, s: Sphere
    ) -> typing.Tuple[RayIntersectionKind, float]: ...
...
class Rect(GObject.GBoxed):
    ...
    def intersection(self, b: Rect) -> typing.Tuple[bool, Rect]: ...
...
class Sphere(GObject.GBoxed):
    ...
    def init(self, center: typing.Optional[Point3D], radius: float) -> Sphere: ...
    def init_from_points(
        self, points: typing.Sequence[Point3D], center: typing.Optional[Point3D] = None
    ) -> Sphere: ...
    def init_from_vectors(
        self, vectors: typing.Sequence[Vec3], center: typing.Optional[Point3D] = None
    ) -> Sphere: ...
...
class Triangle(GObject.GBoxed):
    ...
    def get_area(self) -> float: ...
    def get_barycoords(
        self, p: typing.Optional[Point3D] = None
    ) -> typing.Tuple[bool, Vec2]: ...
    def get_bounding_box(self) -> Box: ...
    def get_midpoint(self) -> Point3D: ...
    def get_normal(self) -> Vec3: ...
    def get_plane(self) -> Plane: ...
    def get_points(self) -> typing.Tuple[Point3D, Point3D, Point3D]: ...
    def get_uv(
        self, p: typing.Optional[Point3D], uv_a: Vec2, uv_b: Vec2, uv_c: Vec2
    ) -> typing.Tuple[bool, Vec2]: ...
    def get_vertices(self) -> typing.Tuple[Vec3, Vec3, Vec3]: ...
    def init_from_float(
        self,
    ...
    def init_from_point3d(
        self,
        a: typing.Optional[Point3D] = None,
        b: typing.Optional[Point3D] = None,
        c: typing.Optional[Point3D] = None,
    ) -> Triangle: ...
    def init_from_vec3(
        self,
        a: typing.Optional[Vec3] = None,
        b: typing.Optional[Vec3] = None,
        c: typing.Optional[Vec3] = None,
    ) -> Triangle: ...
...
class Vec2(GObject.GBoxed):
    ...
    def init_from_float(self, src: typing.Sequence[float]) -> Vec2: ...
...
class Vec3(GObject.GBoxed):
    ...
    def init_from_float(self, src: typing.Sequence[float]) -> Vec3: ...
...
class Vec4(GObject.GBoxed):
    ...
    def init_from_float(self, src: typing.Sequence[float]) -> Vec4: ...
