...
BINARY_AGE: int = 26000
INTERFACE_AGE: int = 1
MAJOR_VERSION: int = 2
MICRO_VERSION: int = 90
MINOR_VERSION: int = 59
...
class Action(GObject.GInterface):
    ...
    def get_description(self, i: int) -> typing.Optional[str]: ...
    def get_keybinding(self, i: int) -> typing.Optional[str]: ...
    def get_localized_name(self, i: int) -> typing.Optional[str]: ...
    def get_n_actions(self) -> int: ...
    def get_name(self, i: int) -> typing.Optional[str]: ...
...
class ActionIface(GObject.GPointer):
    ...
    do_action: typing.Callable[[Action, int], bool] = ...
    get_n_actions: typing.Callable[[Action], int] = ...
    get_description: typing.Callable[[Action, int], typing.Optional[str]] = ...
    get_name: typing.Callable[[Action, int], typing.Optional[str]] = ...
    get_keybinding: typing.Callable[[Action, int], typing.Optional[str]] = ...
    set_description: typing.Callable[[Action, int, str], bool] = ...
    get_localized_name: typing.Callable[[Action, int], typing.Optional[str]] = ...
...
class Component(GObject.GInterface):
    ...
    def get_extents(
        self, coord_type: CoordType
    ) -> typing.Tuple[int, int, int, int]: ...
    def get_layer(self) -> Layer: ...
    def get_mdi_zorder(self) -> int: ...
    def get_position(self, coord_type: CoordType) -> typing.Tuple[int, int]: ...
...
class ComponentIface(GObject.GPointer):
    ...
    contains: typing.Callable[[Component, int, int, CoordType], bool] = ...
    ref_accessible_at_point: typing.Callable[
        [Component, int, int, CoordType], typing.Optional[Object]
    ] = ...
    get_extents: typing.Callable[
        [Component, CoordType], typing.Tuple[int, int, int, int]
    ] = ...
    get_position: typing.Callable[[Component, CoordType], typing.Tuple[int, int]] = ...
    get_size: typing.Callable[[Component], typing.Tuple[int, int]] = ...
    grab_focus: typing.Callable[[Component], bool] = ...
    remove_focus_handler: typing.Callable[[Component, int], None] = ...
    set_extents: typing.Callable[[Component, int, int, int, int, CoordType], bool] = ...
    set_position: typing.Callable[[Component, int, int, CoordType], bool] = ...
    set_size: typing.Callable[[Component, int, int], bool] = ...
    get_layer: typing.Callable[[Component], Layer] = ...
    get_mdi_zorder: typing.Callable[[Component], int] = ...
    bounds_changed: typing.Callable[[Component, Rectangle], None] = ...
    get_alpha: typing.Callable[[Component], float] = ...
    scroll_to: typing.Callable[[Component, ScrollType], bool] = ...
    scroll_to_point: typing.Callable[[Component, CoordType, int, int], bool] = ...

class Document(GObject.GInterface):
    """
    Interface AtkDocument
    """
    def get_attribute_value(self, attribute_name: str) -> typing.Optional[str]: ...
...
class DocumentIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    get_document_type: typing.Callable[[Document], str] = ...
    get_document: typing.Callable[[Document], None] = ...
    get_document_locale: typing.Callable[[Document], str] = ...
    get_document_attributes: typing.Callable[[Document], list[None]] = ...
    get_document_attribute_value: typing.Callable[
        [Document, str], typing.Optional[str]
    ] = ...
    set_document_attribute: typing.Callable[[Document, str, str], bool] = ...
    get_current_page_number: typing.Callable[[Document], int] = ...
    get_page_count: typing.Callable[[Document], int] = ...
    get_text_selections: typing.Callable[[Document], list[TextSelection]] = ...
    set_text_selections: typing.Callable[
        [Document, typing.Sequence[TextSelection]], bool
    ] = ...
...
class EditableTextIface(GObject.GPointer):
    ...
    set_run_attributes: typing.Callable[
        [EditableText, list[None], int, int], bool
    ] = ...
    set_text_contents: typing.Callable[[EditableText, str], None] = ...
    insert_text: typing.Callable[[EditableText, str, int, int], None] = ...
    copy_text: typing.Callable[[EditableText, int, int], None] = ...
    cut_text: typing.Callable[[EditableText, int, int], None] = ...
    delete_text: typing.Callable[[EditableText, int, int], None] = ...
    paste_text: typing.Callable[[EditableText, int], None] = ...
...
class GObjectAccessibleClass(GObject.GPointer):
    ...
    pad1: typing.Callable[..., bool] = ...
    pad2: typing.Callable[..., bool] = ...
...
class HyperlinkClass(GObject.GPointer):
    ...
    get_uri: typing.Callable[[Hyperlink, int], str] = ...
    get_object: typing.Callable[[Hyperlink, int], Object] = ...
    get_end_index: typing.Callable[[Hyperlink], int] = ...
    get_start_index: typing.Callable[[Hyperlink], int] = ...
    is_valid: typing.Callable[[Hyperlink], bool] = ...
    get_n_anchors: typing.Callable[[Hyperlink], int] = ...
    link_state: typing.Callable[[Hyperlink], int] = ...
    is_selected_link: typing.Callable[[Hyperlink], bool] = ...
    link_activated: typing.Callable[[Hyperlink], None] = ...
    pad1: typing.Callable[..., bool] = ...
...
class HyperlinkImplIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    get_hyperlink: typing.Callable[[HyperlinkImpl], Hyperlink] = ...
...
class HypertextIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    get_link: typing.Callable[[Hypertext, int], Hyperlink] = ...
    get_n_links: typing.Callable[[Hypertext], int] = ...
    get_link_index: typing.Callable[[Hypertext, int], int] = ...
    link_selected: typing.Callable[[Hypertext, int], None] = ...
...
class Image(GObject.GInterface):
    ...
    def get_image_locale(self) -> typing.Optional[str]: ...
    def get_image_position(self, coord_type: CoordType) -> typing.Tuple[int, int]: ...
    def get_image_size(self) -> typing.Tuple[int, int]: ...
...
class ImageIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    get_image_position: typing.Callable[
        [Image, CoordType], typing.Tuple[int, int]
    ] = ...
    get_image_description: typing.Callable[[Image], str] = ...
    get_image_size: typing.Callable[[Image], typing.Tuple[int, int]] = ...
    set_image_description: typing.Callable[[Image, str], bool] = ...
    get_image_locale: typing.Callable[[Image], typing.Optional[str]] = ...
...
class MiscClass(GObject.GPointer):
    ...
    parent: GObject.ObjectClass = ...
    threads_enter: typing.Callable[[Misc], None] = ...
    threads_leave: typing.Callable[[Misc], None] = ...
    vfuncs: list[None] = ...
...
class ObjectClass(GObject.GPointer):
    ...
    parent: GObject.ObjectClass = ...
    get_name: typing.Callable[[Object], str] = ...
    get_description: typing.Callable[[Object], str] = ...
    get_parent: typing.Callable[[Object], Object] = ...
    get_n_children: typing.Callable[[Object], int] = ...
    ref_child: None = ...
    get_index_in_parent: typing.Callable[[Object], int] = ...
    ref_relation_set: typing.Callable[[Object], RelationSet] = ...
    get_role: typing.Callable[[Object], Role] = ...
    get_layer: typing.Callable[[Object], Layer] = ...
    get_mdi_zorder: typing.Callable[[Object], int] = ...
    ref_state_set: typing.Callable[[Object], StateSet] = ...
    set_name: typing.Callable[[Object, str], None] = ...
    set_description: typing.Callable[[Object, str], None] = ...
    set_parent: typing.Callable[[Object, Object], None] = ...
    set_role: typing.Callable[[Object, Role], None] = ...
    connect_property_change_handler: None = ...
    remove_property_change_handler: typing.Callable[[Object, int], None] = ...
    initialize: typing.Callable[[Object, None], None] = ...
    children_changed: typing.Callable[[Object, int, None], None] = ...
    focus_event: typing.Callable[[Object, bool], None] = ...
    property_change: typing.Callable[[Object, PropertyValues], None] = ...
    state_change: typing.Callable[[Object, str, bool], None] = ...
    visible_data_changed: typing.Callable[[Object], None] = ...
    active_descendant_changed: typing.Callable[[Object, None], None] = ...
    get_attributes: typing.Callable[[Object], list[None]] = ...
    get_object_locale: typing.Callable[[Object], str] = ...
    pad1: typing.Callable[..., bool] = ...
...
class ObjectFactory(GObject.Object):
    ...
    def get_accessible_type(self) -> typing.Type[typing.Any]: ...
...
class ObjectFactoryClass(GObject.GPointer):
    ...
    invalidate: typing.Callable[[ObjectFactory], None] = ...
    get_accessible_type: typing.Callable[[], typing.Type[typing.Any]] = ...
    pad1: typing.Callable[..., bool] = ...
    pad2: typing.Callable[..., bool] = ...
...
class PlugClass(GObject.GPointer):
    ...
    parent_class: ObjectClass = ...
    get_object_id: typing.Callable[[Plug], str] = ...
...
class Registry(GObject.Object):
    ...
    def get_factory(self, type: typing.Type[typing.Any]) -> ObjectFactory: ...
    def get_factory_type(
        self, type: typing.Type[typing.Any]
    ) -> typing.Type[typing.Any]: ...
    def set_factory_type(
        self, type: typing.Type[typing.Any], factory_type: typing.Type[typing.Any]
    ) -> None: ...
...
class Relation(GObject.Object):
    ...
    @classmethod
    def new(
        cls, targets: typing.Sequence[Object], relationship: RelationType
    ) -> Relation: ...
...
class Selection(GObject.GInterface):
    ...
    def ref_selection(self, i: int) -> typing.Optional[Object]: ...
...
class SelectionIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    add_selection: typing.Callable[[Selection, int], bool] = ...
    clear_selection: typing.Callable[[Selection], bool] = ...
    ref_selection: typing.Callable[[Selection, int], typing.Optional[Object]] = ...
    get_selection_count: typing.Callable[[Selection], int] = ...
    is_child_selected: typing.Callable[[Selection, int], bool] = ...
    remove_selection: typing.Callable[[Selection, int], bool] = ...
    select_all_selection: typing.Callable[[Selection], bool] = ...
    selection_changed: typing.Callable[[Selection], None] = ...
...
class SocketClass(GObject.GPointer):
    ...
    parent_class: ObjectClass = ...
    embed: typing.Callable[[Socket, str], None] = ...
...
class StateSet(GObject.Object):
    ...
    def contains_states(self, types: typing.Sequence[StateType]) -> bool: ...
...
class StreamableContent(GObject.GInterface):
    ...
    def get_uri(self, mime_type: str) -> typing.Optional[str]: ...
...
class StreamableContentIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    get_n_mime_types: typing.Callable[[StreamableContent], int] = ...
    get_mime_type: typing.Callable[[StreamableContent, int], str] = ...
    get_stream: typing.Callable[[StreamableContent, str], GLib.IOChannel] = ...
    get_uri: typing.Callable[[StreamableContent, str], typing.Optional[str]] = ...
    pad1: typing.Callable[..., bool] = ...
    pad2: typing.Callable[..., bool] = ...
    pad3: typing.Callable[..., bool] = ...
...
class Table(GObject.GInterface):
    ...
    def get_column_header(self, column: int) -> typing.Optional[Object]: ...
    def get_index_at(self, row: int, column: int) -> int: ...
    def get_n_columns(self) -> int: ...
    def get_n_rows(self) -> int: ...
    def get_row_at_index(self, index_: int) -> int: ...
    def get_row_description(self, row: int) -> typing.Optional[str]: ...
    def get_row_extent_at(self, row: int, column: int) -> int: ...
    def get_row_header(self, row: int) -> typing.Optional[Object]: ...
...
class TableCell(GObject.GInterface):
    ...
    def get_position(self) -> typing.Tuple[bool, int, int]: ...
    def get_row_column_span(self) -> typing.Tuple[bool, int, int, int, int]: ...
...
class TableCellIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    get_column_span: typing.Callable[[TableCell], int] = ...
    get_column_header_cells: typing.Callable[[TableCell], list[Object]] = ...
    get_position: typing.Callable[[TableCell], typing.Tuple[bool, int, int]] = ...
    get_row_span: typing.Callable[[TableCell], int] = ...
    get_row_header_cells: typing.Callable[[TableCell], list[Object]] = ...
    get_row_column_span: typing.Callable[
        [TableCell], typing.Tuple[bool, int, int, int, int]
    ] = ...
    get_table: typing.Callable[[TableCell], Object] = ...
...
class TableIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    ref_at: typing.Callable[[Table, int, int], Object] = ...
    get_index_at: typing.Callable[[Table, int, int], int] = ...
    get_column_at_index: typing.Callable[[Table, int], int] = ...
    get_row_at_index: typing.Callable[[Table, int], int] = ...
    get_n_columns: typing.Callable[[Table], int] = ...
    get_n_rows: typing.Callable[[Table], int] = ...
    get_column_extent_at: typing.Callable[[Table, int, int], int] = ...
    get_row_extent_at: typing.Callable[[Table, int, int], int] = ...
    get_caption: typing.Callable[[Table], typing.Optional[Object]] = ...
    get_column_description: typing.Callable[[Table, int], str] = ...
    get_column_header: typing.Callable[[Table, int], typing.Optional[Object]] = ...
    get_row_description: typing.Callable[[Table, int], typing.Optional[str]] = ...
    get_row_header: typing.Callable[[Table, int], typing.Optional[Object]] = ...
    get_summary: typing.Callable[[Table], Object] = ...
    set_caption: typing.Callable[[Table, Object], None] = ...
    set_column_description: typing.Callable[[Table, int, str], None] = ...
    set_column_header: typing.Callable[[Table, int, Object], None] = ...
    set_row_description: typing.Callable[[Table, int, str], None] = ...
    set_row_header: typing.Callable[[Table, int, Object], None] = ...
    set_summary: typing.Callable[[Table, Object], None] = ...
    get_selected_columns: typing.Callable[[Table, int], int] = ...
    get_selected_rows: typing.Callable[[Table, int], int] = ...
    is_column_selected: typing.Callable[[Table, int], bool] = ...
    is_row_selected: typing.Callable[[Table, int], bool] = ...
    is_selected: typing.Callable[[Table, int, int], bool] = ...
    add_row_selection: typing.Callable[[Table, int], bool] = ...
    remove_row_selection: typing.Callable[[Table, int], bool] = ...
    add_column_selection: typing.Callable[[Table, int], bool] = ...
    remove_column_selection: typing.Callable[[Table, int], bool] = ...
    row_inserted: typing.Callable[[Table, int, int], None] = ...
    column_inserted: typing.Callable[[Table, int, int], None] = ...
    row_deleted: typing.Callable[[Table, int, int], None] = ...
    column_deleted: typing.Callable[[Table, int, int], None] = ...
    row_reordered: typing.Callable[[Table], None] = ...
    column_reordered: typing.Callable[[Table], None] = ...
    model_changed: typing.Callable[[Table], None] = ...
...
class Text(GObject.GInterface):
    ...
    def get_run_attributes(self, offset: int) -> typing.Tuple[list[None], int, int]: ...
    def get_selection(self, selection_num: int) -> typing.Tuple[str, int, int]: ...
...
class TextIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    get_text: typing.Callable[[Text, int, int], str] = ...
    get_text_after_offset: typing.Callable[
        [Text, int, TextBoundary], typing.Tuple[str, int, int]
    ] = ...
    get_text_at_offset: typing.Callable[
        [Text, int, TextBoundary], typing.Tuple[str, int, int]
    ] = ...
    get_character_at_offset: typing.Callable[[Text, int], str] = ...
    get_text_before_offset: typing.Callable[
        [Text, int, TextBoundary], typing.Tuple[str, int, int]
    ] = ...
    get_caret_offset: typing.Callable[[Text], int] = ...
    get_run_attributes: typing.Callable[
        [Text, int], typing.Tuple[list[None], int, int]
    ] = ...
    get_default_attributes: typing.Callable[[Text], list[None]] = ...
    get_character_extents: typing.Callable[
        [Text, int, CoordType], typing.Tuple[int, int, int, int]
    ] = ...
    get_character_count: typing.Callable[[Text], int] = ...
    get_offset_at_point: typing.Callable[[Text, int, int, CoordType], int] = ...
    get_n_selections: typing.Callable[[Text], int] = ...
    get_selection: typing.Callable[[Text, int], typing.Tuple[str, int, int]] = ...
    add_selection: typing.Callable[[Text, int, int], bool] = ...
    remove_selection: typing.Callable[[Text, int], bool] = ...
    set_selection: typing.Callable[[Text, int, int, int], bool] = ...
    set_caret_offset: typing.Callable[[Text, int], bool] = ...
    text_changed: typing.Callable[[Text, int, int], None] = ...
    text_caret_moved: typing.Callable[[Text, int], None] = ...
    text_selection_changed: typing.Callable[[Text], None] = ...
    text_attributes_changed: typing.Callable[[Text], None] = ...
    get_range_extents: typing.Callable[[Text, int, int, CoordType], TextRectangle] = ...
    get_bounded_ranges: typing.Callable[
        [Text, TextRectangle, CoordType, TextClipType, TextClipType], list[TextRange]
    ] = ...
    get_string_at_offset: typing.Callable[
        [Text, int, TextGranularity], typing.Tuple[typing.Optional[str], int, int]
    ] = ...
    scroll_substring_to: typing.Callable[[Text, int, int, ScrollType], bool] = ...
    scroll_substring_to_point: typing.Callable[
...
class UtilClass(GObject.GPointer):
    ...
    remove_global_event_listener: typing.Callable[[int], None] = ...
    add_key_event_listener: None = ...
    remove_key_event_listener: typing.Callable[[int], None] = ...
    get_root: None = ...
    get_toolkit_name: typing.Callable[[], str] = ...
    get_toolkit_version: typing.Callable[[], str] = ...

class Value(GObject.GInterface):
    """
    Interface AtkValue
    """
    def get_current_value(self) -> typing.Any: ...
    def get_increment(self) -> float: ...
    def get_maximum_value(self) -> typing.Any: ...
    def get_minimum_increment(self) -> typing.Any: ...
    def get_minimum_value(self) -> typing.Any: ...
    def get_range(self) -> typing.Optional[Range]: ...
    def get_sub_ranges(self) -> list[Range]: ...
    def get_value_and_text(self) -> typing.Tuple[float, str]: ...
    def set_current_value(self, value: typing.Any) -> bool: ...
...
class ValueIface(GObject.GPointer):
    ...
    parent: GObject.TypeInterface = ...
    get_current_value: typing.Callable[[Value], typing.Any] = ...
    get_maximum_value: typing.Callable[[Value], typing.Any] = ...
    get_minimum_value: typing.Callable[[Value], typing.Any] = ...
    set_current_value: typing.Callable[[Value, typing.Any], bool] = ...
    get_minimum_increment: typing.Callable[[Value], typing.Any] = ...
    get_value_and_text: typing.Callable[[Value], typing.Tuple[float, str]] = ...
    get_range: typing.Callable[[Value], typing.Optional[Range]] = ...
    get_increment: typing.Callable[[Value], float] = ...
    get_sub_ranges: typing.Callable[[Value], list[Range]] = ...
    set_value: typing.Callable[[Value, float], None] = ...
...
class TextAttribute(GObject.GEnum):
    ...
    @staticmethod
    def get_value(attr: TextAttribute, index_: int) -> typing.Optional[str]: ...
    @staticmethod
