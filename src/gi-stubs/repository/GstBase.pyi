...
BASE_PARSE_FLAG_DRAINING: Final[int]
BASE_PARSE_FLAG_LOST_SYNC: Final[int]
BASE_TRANSFORM_SINK_NAME: Final = "sink"
BASE_TRANSFORM_SRC_NAME: Final = "src"
...
class Aggregator(Gst.Element):
    ...
    @property
    def priv(self) -> AggregatorPrivate: ...
    def __init__(
        self,
        *,
        emit_signals: bool = ...,
...
class AggregatorClass(GObject.GPointer):
    ...
    @property
    def sink_event(self) -> Callable[[Aggregator, AggregatorPad, Gst.Event], bool]: ...
    @property
    def sink_query(self) -> Callable[[Aggregator, AggregatorPad, Gst.Query], bool]: ...
    @property
    def src_event(self) -> Callable[[Aggregator, Gst.Event], bool]: ...
    @property
    def src_query(self) -> Callable[[Aggregator, Gst.Query], bool]: ...
    @property
    def src_activate(self) -> Callable[[Aggregator, Gst.PadMode, bool], bool]: ...
    @property
    def aggregate(self) -> Callable[[Aggregator, bool], Gst.FlowReturn]: ...
    @property
    def stop(self) -> Callable[[Aggregator], bool]: ...
    @property
    def start(self) -> Callable[[Aggregator], bool]: ...
    @property
    ...
    def update_src_caps(
        self,
    ) -> Callable[[Aggregator, Gst.Caps], tuple[Gst.FlowReturn, Gst.Caps]]: ...
    @property
    def fixate_src_caps(self) -> Callable[[Aggregator, Gst.Caps], Gst.Caps]: ...
    @property
    def negotiated_src_caps(self) -> Callable[[Aggregator, Gst.Caps], bool]: ...
    @property
    def decide_allocation(self) -> Callable[[Aggregator, Gst.Query], bool]: ...
    @property
    def propose_allocation(
        self,
    ) -> Callable[[Aggregator, AggregatorPad, Gst.Query, Gst.Query], bool]: ...
    @property
    def negotiate(self) -> Callable[[Aggregator], bool]: ...
    @property
    def sink_event_pre_queue(
        self,
    ) -> Callable[[Aggregator, AggregatorPad, Gst.Event], Gst.FlowReturn]: ...
    @property
    def sink_query_pre_queue(
        self,
    ) -> Callable[[Aggregator, AggregatorPad, Gst.Query], bool]: ...
    @property
    def finish_buffer_list(
        self,
    ) -> Callable[[Aggregator, Gst.BufferList], Gst.FlowReturn]: ...
    @property
    def peek_next_sample(
        self,
    ) -> Callable[[Aggregator, AggregatorPad], Gst.Sample | None]: ...
...
class AggregatorPad(Gst.Pad):
    ...
    def props(self) -> Props: ...
    @property
    def parent(self) -> Gst.Pad: ...
    @property
    def segment(self) -> Gst.Segment: ...
    @property
    def priv(self) -> AggregatorPadPrivate: ...
    def __init__(
        self,
        *,
        emit_signals: bool = ...,
...
class AggregatorPadClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> Gst.PadClass: ...
    @property
    def flush(self) -> Callable[[AggregatorPad, Aggregator], Gst.FlowReturn]: ...
    @property
    def skip_buffer(
        self,
...
class BaseParse(Gst.Element):
    ...
    def segment(self) -> Gst.Segment: ...
    @property
    def priv(self) -> BaseParsePrivate: ...
    def __init__(
        self,
        *,
        disable_passthrough: bool = ...,
...
class BaseParseClass(GObject.GPointer):
    ...
    def parent_class(self) -> Gst.ElementClass: ...
    @property
    def start(self) -> Callable[[BaseParse], bool]: ...
    @property
    def stop(self) -> Callable[[BaseParse], bool]: ...
    @property
    def set_sink_caps(self) -> Callable[[BaseParse, Gst.Caps], bool]: ...
    @property
    def handle_frame(
        self,
    ) -> Callable[[BaseParse, BaseParseFrame], tuple[Gst.FlowReturn, int]]: ...
    @property
    def pre_push_frame(
        self,
    ) -> Callable[[BaseParse, BaseParseFrame], Gst.FlowReturn]: ...
    @property
    def convert(
        self,
    ) -> Callable[[BaseParse, Gst.Format, int, Gst.Format, int], bool]: ...
    @property
    def sink_event(self) -> Callable[[BaseParse, Gst.Event], bool]: ...
    @property
    def src_event(self) -> Callable[[BaseParse, Gst.Event], bool]: ...
    @property
    def get_sink_caps(self) -> Callable[[BaseParse, Gst.Caps], Gst.Caps]: ...
    @property
    def detect(self) -> Callable[[BaseParse, Gst.Buffer], Gst.FlowReturn]: ...
    @property
    def sink_query(self) -> Callable[[BaseParse, Gst.Query], bool]: ...
    @property
    def src_query(self) -> Callable[[BaseParse, Gst.Query], bool]: ...
...
class BaseSink(Gst.Element):
    ...
    @property
    def preroll_lock(self) -> GLib.Mutex: ...
    @property
    def preroll_cond(self) -> GLib.Cond: ...
    @property
    def eos(self) -> bool: ...
    @property
...
class BaseSinkClass(GObject.GPointer):
    ...
    def parent_class(self) -> Gst.ElementClass: ...
    @property
    def get_caps(self) -> Callable[[BaseSink, Gst.Caps | None], Gst.Caps]: ...
    @property
    def set_caps(self) -> Callable[[BaseSink, Gst.Caps], bool]: ...
    @property
    def fixate(self) -> Callable[[BaseSink, Gst.Caps], Gst.Caps]: ...
    @property
    def activate_pull(self) -> Callable[[BaseSink, bool], bool]: ...
    @property
    def get_times(self) -> Callable[[BaseSink, Gst.Buffer], tuple[int, int]]: ...
    @property
    def propose_allocation(self) -> Callable[[BaseSink, Gst.Query], bool]: ...
    @property
    def start(self) -> Callable[[BaseSink], bool]: ...
    @property
    def stop(self) -> Callable[[BaseSink], bool]: ...
    @property
    def unlock(self) -> Callable[[BaseSink], bool]: ...
    @property
    def unlock_stop(self) -> Callable[[BaseSink], bool]: ...
    @property
    def query(self) -> Callable[[BaseSink, Gst.Query], bool]: ...
    @property
    def event(self) -> Callable[[BaseSink, Gst.Event], bool]: ...
    @property
    def wait_event(self) -> Callable[[BaseSink, Gst.Event], Gst.FlowReturn]: ...
    @property
    def prepare(self) -> Callable[[BaseSink, Gst.Buffer], Gst.FlowReturn]: ...
    @property
    def prepare_list(self) -> Callable[[BaseSink, Gst.BufferList], Gst.FlowReturn]: ...
    @property
    def preroll(self) -> Callable[[BaseSink, Gst.Buffer], Gst.FlowReturn]: ...
    @property
    def render(self) -> Callable[[BaseSink, Gst.Buffer], Gst.FlowReturn]: ...
    @property
...
class BaseSrc(Gst.Element):
    ...
    def srcpad(self) -> Gst.Pad: ...
    @property
    def live_lock(self) -> GLib.Mutex: ...
    @property
    def live_cond(self) -> GLib.Cond: ...
    @property
    ...
    def running(self) -> bool: ...
    @property
    def pending_seek(self) -> Gst.Event: ...
    @property
    def priv(self) -> BaseSrcPrivate: ...
    def __init__(
        self,
        *,
        automatic_eos: bool = ...,
...
class BaseSrcClass(GObject.GPointer):
    ...
    def parent_class(self) -> Gst.ElementClass: ...
    @property
    def get_caps(self) -> Callable[[BaseSrc, Gst.Caps | None], Gst.Caps]: ...
    @property
    def negotiate(self) -> Callable[[BaseSrc], bool]: ...
    @property
    def fixate(self) -> Callable[[BaseSrc, Gst.Caps], Gst.Caps]: ...
    @property
    def set_caps(self) -> Callable[[BaseSrc, Gst.Caps], bool]: ...
    @property
    def decide_allocation(self) -> Callable[[BaseSrc, Gst.Query], bool]: ...
    @property
    def start(self) -> Callable[[BaseSrc], bool]: ...
    @property
    def stop(self) -> Callable[[BaseSrc], bool]: ...
    @property
    def get_times(self) -> Callable[[BaseSrc, Gst.Buffer], tuple[int, int]]: ...
    @property
    def get_size(self) -> Callable[[BaseSrc], tuple[bool, int]]: ...
    @property
    def is_seekable(self) -> Callable[[BaseSrc], bool]: ...
    @property
    def prepare_seek_segment(
        self,
    ) -> Callable[[BaseSrc, Gst.Event, Gst.Segment], bool]: ...
    @property
    def do_seek(self) -> Callable[[BaseSrc, Gst.Segment], bool]: ...
    @property
    def unlock(self) -> Callable[[BaseSrc], bool]: ...
    @property
    def unlock_stop(self) -> Callable[[BaseSrc], bool]: ...
    @property
    def query(self) -> Callable[[BaseSrc, Gst.Query], bool]: ...
    @property
    def event(self) -> Callable[[BaseSrc, Gst.Event], bool]: ...
    @property
    def create(
        self,
    ) -> Callable[[BaseSrc, int, int], tuple[Gst.FlowReturn, Gst.Buffer]]: ...
    @property
    def alloc(
        self,
    ) -> Callable[[BaseSrc, int, int], tuple[Gst.FlowReturn, Gst.Buffer]]: ...
...
class BaseTransform(Gst.Element):
    ...
    def segment(self) -> Gst.Segment: ...
    @property
    def queued_buf(self) -> Gst.Buffer: ...
    @property
...
class BaseTransformClass(GObject.GPointer):
    ...
    def transform_caps(
        self,
    ) -> Callable[[BaseTransform, Gst.PadDirection, Gst.Caps, Gst.Caps], Gst.Caps]: ...
    @property
    def fixate_caps(
        self,
    ) -> Callable[[BaseTransform, Gst.PadDirection, Gst.Caps, Gst.Caps], Gst.Caps]: ...
    ...
    def accept_caps(
        self,
    ) -> Callable[[BaseTransform, Gst.PadDirection, Gst.Caps], bool]: ...
    @property
    def set_caps(self) -> Callable[[BaseTransform, Gst.Caps, Gst.Caps], bool]: ...
    @property
    def query(self) -> Callable[[BaseTransform, Gst.PadDirection, Gst.Query], bool]: ...
    @property
    def decide_allocation(self) -> Callable[[BaseTransform, Gst.Query], bool]: ...
    @property
    def filter_meta(
        self,
    ) -> Callable[[BaseTransform, Gst.Query, type[Any], Gst.Structure], bool]: ...
    @property
    def propose_allocation(
        self,
    ) -> Callable[[BaseTransform, Gst.Query, Gst.Query], bool]: ...
    @property
    def transform_size(
        self,
    ) -> Callable[
        [BaseTransform, Gst.PadDirection, Gst.Caps, int, Gst.Caps], tuple[bool, int]
    ]: ...
    @property
    def get_unit_size(
        self,
    ) -> Callable[[BaseTransform, Gst.Caps], tuple[bool, int]]: ...
    @property
    def start(self) -> Callable[[BaseTransform], bool]: ...
    @property
    def stop(self) -> Callable[[BaseTransform], bool]: ...
    @property
    def sink_event(self) -> Callable[[BaseTransform, Gst.Event], bool]: ...
    @property
    def src_event(self) -> Callable[[BaseTransform, Gst.Event], bool]: ...
    @property
    def prepare_output_buffer(
        self,
    ) -> Callable[[BaseTransform, Gst.Buffer], tuple[Gst.FlowReturn, Gst.Buffer]]: ...
    @property
    def copy_metadata(
        self,
    ) -> Callable[[BaseTransform, Gst.Buffer, Gst.Buffer], bool]: ...
    @property
    def transform_meta(
        self,
    ) -> Callable[[BaseTransform, Gst.Buffer, Gst.Meta, Gst.Buffer], bool]: ...
    @property
    def before_transform(self) -> Callable[[BaseTransform, Gst.Buffer], None]: ...
    @property
    def transform(
        self,
    ) -> Callable[[BaseTransform, Gst.Buffer, Gst.Buffer], Gst.FlowReturn]: ...
    @property
    def transform_ip(self) -> Callable[[BaseTransform, Gst.Buffer], Gst.FlowReturn]: ...
    @property
    def submit_input_buffer(
        self,
    ) -> Callable[[BaseTransform, bool, Gst.Buffer], Gst.FlowReturn]: ...
    @property
    def generate_output(
        self,
...
class CollectPads(Gst.Object):
    ...
    @property
    def data(self) -> list[CollectData]: ...
    @property
    def stream_lock(self) -> GLib.RecMutex: ...
    @property
    def priv(self) -> CollectPadsPrivate: ...
...
class DataQueue(GObject.Object):
    ...
    @property
    def priv(self) -> DataQueuePrivate: ...
...
class DataQueueClass(GObject.GPointer):
    ...
    @property
    def empty(self) -> Callable[[DataQueue], None]: ...
    @property
...
class PushSrcClass(GObject.GPointer):
    ...
    """
    @property
    def parent_class(self) -> BaseSrcClass: ...
    @property
    def create(self) -> Callable[[PushSrc], tuple[Gst.FlowReturn, Gst.Buffer]]: ...
    @property
    def alloc(self) -> Callable[[PushSrc], tuple[Gst.FlowReturn, Gst.Buffer]]: ...
    @property
