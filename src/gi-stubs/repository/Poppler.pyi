...
ANNOT_TEXT_ICON_RIGHT_ARROW: str = "RightArrow"
ANNOT_TEXT_ICON_RIGHT_POINTER: str = "RightPointer"
ANNOT_TEXT_ICON_STAR: str = "Star"
ANNOT_TEXT_ICON_UP_ARROW: str = "UpArrow"
ANNOT_TEXT_ICON_UP_LEFT_ARROW: str = "UpLeftArrow"
HAS_CAIRO: int = 1
MAJOR_VERSION: int = 26
MICRO_VERSION: int = 0
MINOR_VERSION: int = 3
...
def get_nss_dir() -> str: ...
def get_version() -> str: ...
def named_dest_from_bytestring(data: typing.Sequence[int]) -> str: ...
def named_dest_to_bytestring(name: str) -> typing.Optional[bytes]: ...
def set_nss_dir(path: str) -> None: ...
def set_nss_password_callback(func: typing.Callable[[str], str]) -> None: ...
...
class Annot(GObject.Object):
    ...
    def set_color(self, poppler_color: typing.Optional[Color] = None) -> None: ...
...
class AnnotCircle(AnnotMarkup):
    ...
    def set_interior_color(
        self, poppler_color: typing.Optional[Color] = None
    ) -> None: ...
...
class AnnotFreeText(AnnotMarkup):
    ...
    def get_font_desc(self) -> typing.Optional[FontDescription]: ...
...
class AnnotInk(AnnotMarkup):
    ...
    def set_ink_list(self, ink_list: typing.Sequence[Path]) -> None: ...
...
class AnnotMarkup(Annot):
    ...
    def get_popup_rectangle(self) -> typing.Tuple[bool, Rectangle]: ...
...
class AnnotTextMarkup(AnnotMarkup):
    ...
    def new_highlight(
        ...
        doc: Document,
        rect: Rectangle,
        quadrilaterals: typing.Sequence[Quadrilateral],
    ) -> AnnotTextMarkup: ...
    @classmethod
    def new_squiggly(
        cls,
    ...
    def set_quadrilaterals(
        self, quadrilaterals: typing.Sequence[Quadrilateral]
    ) -> None: ...
...
class Attachment(GObject.Object):
    ...
    def get_ctime(self) -> typing.Optional[GLib.DateTime]: ...
    def get_description(self) -> str: ...
    def get_mtime(self) -> typing.Optional[GLib.DateTime]: ...
    def get_name(self) -> str: ...
    def get_size(self) -> int: ...
    def save(self, filename: str) -> bool: ...
    def save_to_callback(
        self, save_func: typing.Callable[..., bool], *user_data: typing.Any
    ) -> bool: ...
...
class Document(GObject.Object):
    ...
    def create_dests_tree(self) -> typing.Optional[GLib.Tree]: ...
    ...
    def get_id(self) -> typing.Tuple[bool, str, str]: ...
    ...
    def get_pdf_subtype_string(self) -> typing.Optional[str]: ...
    def get_pdf_version(self) -> typing.Tuple[int, int]: ...
    ...
    @classmethod
    def new_from_bytes(
        cls, bytes: GLib.Bytes, password: typing.Optional[str] = None
    ) -> Document: ...
    @classmethod
    def new_from_data(
    ...
    @classmethod
    def new_from_fd(
        cls, fd: int, password: typing.Optional[str] = None
    ) -> Document: ...
    @classmethod
    def new_from_file(
        cls, uri: str, password: typing.Optional[str] = None
    ) -> Document: ...
    @classmethod
    def new_from_gfile(
        cls,
    ...
    def reset_form(
        self, fields: typing.Optional[list[str]], exclude_fields: bool
    ) -> None: ...
    ...
    def set_creation_date_time(
        self, creation_datetime: typing.Optional[GLib.DateTime] = None
    ) -> None: ...
    ...
    def set_modification_date_time(
        self, modification_datetime: typing.Optional[GLib.DateTime] = None
    ) -> None: ...
...
class FontInfo(GObject.Object):
    ...
    def scan(self, n_pages: int) -> typing.Tuple[bool, FontsIter]: ...
...
class Page(GObject.Object):
    ...
    def get_text_layout(self) -> typing.Tuple[bool, list[Rectangle]]: ...
    def get_text_layout_for_area(
        self, area: Rectangle
    ) -> typing.Tuple[bool, list[Rectangle]]: ...
    def get_thumbnail(self) -> cairo.Surface: ...
    def get_thumbnail_size(self) -> typing.Tuple[bool, int, int]: ...
...
class StructureElement(GObject.Object):
    ...
    def get_background_color(self) -> typing.Tuple[bool, Color]: ...
    def get_baseline_shift(self) -> float: ...
    def get_block_align(self) -> StructureBlockAlign: ...
    def get_border_color(self) -> typing.Tuple[bool, list[Color]]: ...
    def get_border_style(self) -> list[StructureBorderStyle]: ...
    def get_border_thickness(self) -> typing.Tuple[bool, list[float]]: ...
    def get_bounding_box(self) -> typing.Tuple[bool, Rectangle]: ...
    def get_color(self) -> typing.Tuple[bool, Color]: ...
    ...
    def get_text_decoration_color(self) -> typing.Tuple[bool, Color]: ...
...
class StructureElementIter(GObject.GBoxed):
    ...
    @classmethod
    def new(
        cls, poppler_document: Document
    ) -> typing.Optional[StructureElementIter]: ...
    def next(self) -> bool: ...
