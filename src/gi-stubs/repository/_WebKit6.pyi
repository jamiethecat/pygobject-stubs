...
def uri_for_display(uri: str) -> typing.Optional[str]: ...
...
class ApplicationInfo(GObject.GBoxed):
    ...
    def get_version(self) -> typing.Tuple[int, int, int]: ...
    @classmethod
...
class AuthenticationRequest(GObject.Object):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def authenticate(self, credential: typing.Optional[Credential] = None) -> None: ...
...
class BackForwardList(GObject.Object):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_back_item(self) -> typing.Optional[BackForwardListItem]: ...
    def get_back_list(self) -> list[BackForwardListItem]: ...
    def get_back_list_with_limit(self, limit: int) -> list[BackForwardListItem]: ...
    def get_current_item(self) -> typing.Optional[BackForwardListItem]: ...
    def get_forward_item(self) -> typing.Optional[BackForwardListItem]: ...
    ...
    def get_nth_item(self, index: int) -> typing.Optional[BackForwardListItem]: ...
...
class ColorChooserRequest(GObject.Object):
    ...
    props: Props = ...
    def __init__(self, rgba: Gdk.RGBA = ...) -> None: ...
    def cancel(self) -> None: ...
...
class ContextMenuItem(GObject.InitiallyUnowned):
    ...
    def get_gaction_target(self) -> typing.Optional[GLib.Variant]: ...
    ...
    def new_from_gaction(
        ...
        action: Gio.Action,
        label: str,
        target: typing.Optional[GLib.Variant] = None,
    ) -> ContextMenuItem: ...
    @classmethod
    ...
    def set_submenu(self, submenu: typing.Optional[ContextMenu] = None) -> None: ...
...
class Credential(GObject.GBoxed):
    ...
    def new_for_certificate(
        cls,
        certificate: typing.Optional[Gio.TlsCertificate],
...
class Feature(GObject.GBoxed):
    ...
    def get_details(self) -> typing.Optional[str]: ...
...
class FileChooserRequest(GObject.Object):
    ...
    def select_files(self, files: typing.Sequence[str]) -> None: ...
...
class FormSubmissionRequest(GObject.Object):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def list_text_fields(self) -> typing.Tuple[bool, list[str], list[str]]: ...
...
class Image(GObject.Object, Gio.Icon, Gio.LoadableIcon):
    """
    :Constructors:
    ...
    props: Props = ...
    def __init__(
        self, height: int = ..., stride: int = ..., width: int = ...
    ) -> None: ...
    def as_bytes(self) -> GLib.Bytes: ...
...
class InputMethodContext(GObject.Object):
    ...
    def do_get_preedit(self) -> typing.Tuple[str, list[InputMethodUnderline], int]: ...
    ...
    def get_preedit(self) -> typing.Tuple[str, list[InputMethodUnderline], int]: ...
...
class InputMethodContextClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    preedit_started: typing.Callable[[InputMethodContext], None] = ...
    preedit_changed: typing.Callable[[InputMethodContext], None] = ...
    preedit_finished: typing.Callable[[InputMethodContext], None] = ...
    committed: typing.Callable[[InputMethodContext, str], None] = ...
    delete_surrounding: typing.Callable[[InputMethodContext, int, int], None] = ...
    set_enable_preedit: typing.Callable[[InputMethodContext, bool], None] = ...
    get_preedit: typing.Callable[
        [InputMethodContext], typing.Tuple[str, list[InputMethodUnderline], int]
    ] = ...
    filter_key_event: typing.Callable[[InputMethodContext, Gdk.Event], bool] = ...
    notify_focus_in: typing.Callable[[InputMethodContext], None] = ...
    notify_focus_out: typing.Callable[[InputMethodContext], None] = ...
    notify_cursor_area: typing.Callable[
        [InputMethodContext, int, int, int, int], None
    ] = ...
    notify_surrounding: typing.Callable[
        [InputMethodContext, str, int, int, int], None
    ] = ...
    reset: typing.Callable[[InputMethodContext], None] = ...
...
class InputMethodUnderline(GObject.GBoxed):
    ...
    def set_color(self, rgba: typing.Optional[Gdk.RGBA] = None) -> None: ...
...
class NavigationAction(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    def get_frame_name(self) -> typing.Optional[str]: ...
...
class NetworkProxySettings(GObject.GBoxed):
    ...
    def new(
        cls,
        default_proxy_uri: typing.Optional[str] = None,
...
class NetworkSession(GObject.Object):
    ...
    def new(
        cls,
        data_directory: typing.Optional[str] = None,
        cache_directory: typing.Optional[str] = None,
    ) -> NetworkSession: ...
    @classmethod
    ...
    def set_proxy_settings(
        ...
        proxy_settings: typing.Optional[NetworkProxySettings] = None,
    ) -> None: ...
...
class PermissionRequestInterface(GObject.GPointer):
    ...
    allow: typing.Callable[[PermissionRequest], None] = ...
    deny: typing.Callable[[PermissionRequest], None] = ...
...
class PrintOperation(GObject.Object):
    ...
    def run_dialog(
        self, parent: typing.Optional[Gtk.Window] = None
...
class Settings(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ...
        math_font_family: typing.Optional[str]
    ...
    def __init__(
        ...
        load_icons_ignoring_image_load_setting: bool = ...,
        math_font_family: typing.Optional[str] = ...,
        media_content_types_requiring_hardware_support: typing.Optional[str] = ...,
        media_playback_allows_inline: bool = ...,
        media_playback_requires_user_gesture: bool = ...,
        minimum_font_size: int = ...,
        monospace_font_family: str = ...,
    ...
    def get_math_font_family(self) -> typing.Optional[str]: ...
    ...
    def set_math_font_family(
        self, math_font_family: typing.Optional[str] = None
    ) -> None: ...
    def set_media_content_types_requiring_hardware_support(
        self, content_types: typing.Optional[str] = None
    ) -> None: ...
...
class UserContentManager(GObject.Object):
    ...
    def register_script_message_handler(
        self, name: str, world_name: typing.Optional[str] = None
    ) -> bool: ...
...
class UserMessage(GObject.InitiallyUnowned):
    ...
    class Props(GObject.InitiallyUnowned.Props):
        fd_list: typing.Optional[Gio.UnixFDList]
        name: str
    ...
    def get_fd_list(self) -> typing.Optional[Gio.UnixFDList]: ...
    def get_name(self) -> str: ...
    def get_parameters(self) -> typing.Optional[GLib.Variant]: ...
    @classmethod
    def new(
        cls, name: str, parameters: typing.Optional[GLib.Variant] = None
    ) -> UserMessage: ...
    @classmethod
    def new_with_fd_list(
        ...
        fd_list: typing.Optional[Gio.UnixFDList] = None,
    ) -> UserMessage: ...
...
class UserScript(GObject.GBoxed):
    ...
    def new(
        ...
        allow_list: typing.Optional[typing.Sequence[str]] = None,
        block_list: typing.Optional[typing.Sequence[str]] = None,
    ) -> UserScript: ...
    @classmethod
    def new_for_world(
        cls,
...
class WebContext(GObject.Object):
    ...
    def get_network_session_for_automation(self) -> typing.Optional[NetworkSession]: ...
    ...
    def register_uri_scheme(
        self, scheme: str, callback: typing.Callable[..., None], *user_data: typing.Any
    ) -> None: ...
    ...
    def set_preferred_languages(
        self, languages: typing.Optional[typing.Sequence[str]] = None
    ) -> None: ...
    def set_spell_checking_enabled(self, enabled: bool) -> None: ...
    def set_spell_checking_languages(self, languages: typing.Sequence[str]) -> None: ...
...
class WebExtension(GObject.Object, Gio.Initable):
    ...
    """
    class Props(GObject.Object.Props):
        default_locale: typing.Optional[str]
        display_action_label: typing.Optional[str]
        display_description: typing.Optional[str]
        display_name: typing.Optional[str]
        display_short_name: typing.Optional[str]
        display_version: typing.Optional[str]
        ...
        optional_permissions: typing.Optional[list[str]]
        path: str
        requested_permissions: typing.Optional[list[str]]
    ...
    def get_default_locale(self) -> typing.Optional[str]: ...
    def get_display_action_label(self) -> typing.Optional[str]: ...
    def get_display_description(self) -> typing.Optional[str]: ...
    def get_display_name(self) -> typing.Optional[str]: ...
    def get_display_short_name(self) -> typing.Optional[str]: ...
    def get_display_version(self) -> typing.Optional[str]: ...
    ...
    def get_icon(self, width: float, height: float) -> typing.Optional[Gio.Icon]: ...
    def get_manifest_version(self) -> float: ...
    def get_optional_permission_match_patterns(
        self,
    ) -> list[WebExtensionMatchPattern]: ...
    def get_optional_permissions(self) -> typing.Optional[list[str]]: ...
    def get_path(self) -> str: ...
    def get_requested_permission_match_patterns(
        self,
    ) -> list[WebExtensionMatchPattern]: ...
    def get_requested_permissions(self) -> typing.Optional[list[str]]: ...
    def get_version(self) -> typing.Optional[str]: ...
    @classmethod
    def new(cls, extension_path: str) -> typing.Optional[WebExtension]: ...
...
class WebExtensionMatchPattern(GObject.GBoxed):
    ...
    ) -> typing.Optional[WebExtensionMatchPattern]: ...
    @classmethod
    def new_with_string(
        cls, string: str
    ) -> typing.Optional[WebExtensionMatchPattern]: ...
...
class WebView(WebViewBase, Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget):
    ...
    class Props(WebViewBase.Props):
        ...
        default_content_security_policy: typing.Optional[str]
    ...
    def call_async_javascript_function(
        ...
        body: str,
        length: int,
        arguments: typing.Optional[GLib.Variant] = None,
    ...
    def get_default_content_security_policy(self) -> typing.Optional[str]: ...
    ...
    def get_input_method_context(self) -> typing.Optional[InputMethodContext]: ...
    ...
    def get_theme_color(self) -> typing.Tuple[bool, Gdk.RGBA]: ...
    def get_title(self) -> str: ...
    def get_tls_info(
        self,
    ) -> typing.Tuple[bool, Gio.TlsCertificate, Gio.TlsCertificateFlags]: ...
    def get_uri(self) -> str: ...
    ...
    def load_alternate_html(
        self, content: str, content_uri: str, base_uri: typing.Optional[str] = None
    ) -> None: ...
    def load_bytes(
        self,
        bytes: GLib.Bytes,
    ...
    def load_html(
        self, content: str, base_uri: typing.Optional[str] = None
    ) -> None: ...
    ...
    def set_cors_allowlist(
        self, allowlist: typing.Optional[typing.Sequence[str]] = None
    ) -> None: ...
    def set_custom_charset(self, charset: typing.Optional[str] = None) -> None: ...
    def set_display_capture_state(self, state: MediaCaptureState) -> None: ...
    def set_editable(self, editable: bool) -> None: ...
    def set_input_method_context(
        self, context: typing.Optional[InputMethodContext] = None
    ) -> None: ...
...
class WebViewClass(GObject.GPointer):
    ...
    load_changed: typing.Callable[[WebView, LoadEvent], None] = ...
    load_failed: typing.Callable[[WebView, LoadEvent, str, GLib.Error], bool] = ...
    create: None = ...
    ready_to_show: typing.Callable[[WebView], None] = ...
    run_as_modal: typing.Callable[[WebView], None] = ...
    close: typing.Callable[[WebView], None] = ...
    script_dialog: typing.Callable[[WebView, ScriptDialog], bool] = ...
    decide_policy: typing.Callable[
        [WebView, PolicyDecision, PolicyDecisionType], bool
    ] = ...
    permission_request: typing.Callable[[WebView, PermissionRequest], bool] = ...
    mouse_target_changed: typing.Callable[[WebView, HitTestResult, int], None] = ...
    print_: typing.Callable[[WebView, PrintOperation], bool] = ...
    resource_load_started: typing.Callable[
        [WebView, WebResource, URIRequest], None
    ] = ...
    enter_fullscreen: typing.Callable[[WebView], bool] = ...
    leave_fullscreen: typing.Callable[[WebView], bool] = ...
    run_file_chooser: typing.Callable[[WebView, FileChooserRequest], bool] = ...
    context_menu: typing.Callable[[WebView, ContextMenu, HitTestResult], bool] = ...
    context_menu_dismissed: typing.Callable[[WebView], None] = ...
    submit_form: typing.Callable[[WebView, FormSubmissionRequest], None] = ...
    insecure_content_detected: typing.Callable[
        [WebView, InsecureContentEvent], None
    ] = ...
    web_process_crashed: typing.Callable[[WebView], bool] = ...
    authenticate: typing.Callable[[WebView, AuthenticationRequest], bool] = ...
    load_failed_with_tls_errors: typing.Callable[
        [WebView, str, Gio.TlsCertificate, Gio.TlsCertificateFlags], bool
    ] = ...
    show_notification: typing.Callable[[WebView, Notification], bool] = ...
    run_color_chooser: typing.Callable[[WebView, ColorChooserRequest], bool] = ...
    show_option_menu: typing.Callable[[WebView, OptionMenu, Gdk.Rectangle], bool] = ...
    web_process_terminated: typing.Callable[
        [WebView, WebProcessTerminationReason], None
    ] = ...
    user_message_received: typing.Callable[[WebView, UserMessage], bool] = ...
    query_permission_state: typing.Callable[[WebView, PermissionStateQuery], bool] = ...
...
class WebsiteDataManager(GObject.Object):
    ...
    """
    class Props(GObject.Object.Props):
        base_cache_directory: typing.Optional[str]
        base_data_directory: typing.Optional[str]
        is_ephemeral: bool
    ...
    def get_base_cache_directory(self) -> typing.Optional[str]: ...
    def get_base_data_directory(self) -> typing.Optional[str]: ...
    def get_favicon_database(self) -> typing.Optional[FaviconDatabase]: ...
